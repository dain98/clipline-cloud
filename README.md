...
- **Current release:** [`v1.2.13`](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.13)
- **Image:** `ghcr.io/dain98/clipline-cloud:1.2.13`
...
CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.2.13 docker compose up -d
```
...
`https://` URL. Pin `CLIPLINE_IMAGE` to a released tag such as `ghcr.io/dain98/clipline-cloud:1.2.13`
rather than `latest`.
...
- [Release notes](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.13) — v1.2.13.
