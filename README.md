...
- [v1.2.34](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.34)
- `ghcr.io/dain98/clipline-cloud:1.2.34`
...
released tag such as `1.2.34` when you want explicit upgrade and rollback control.
