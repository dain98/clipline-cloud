...
- **Current release:** [`v1.2.24`](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.24)
- **Image:** `ghcr.io/dain98/clipline-cloud:1.2.24`
...
`https://` URL. Pin `CLIPLINE_IMAGE` to a released tag such as `ghcr.io/dain98/clipline-cloud:1.2.24`
rather than `latest`.
...
- [Release notes](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.24) — v1.2.24.
