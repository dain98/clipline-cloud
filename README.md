...
- [v1.2.35](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.35)
- `ghcr.io/dain98/clipline-cloud:1.2.35`
...
released tag such as `1.2.35` when you want explicit upgrade and rollback control.
