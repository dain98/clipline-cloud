...
- **Current release:** [`v1.2.15`](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.15)
- **Image:** `ghcr.io/dain98/clipline-cloud:1.2.15`
...
`https://` URL. Pin `CLIPLINE_IMAGE` to a released tag such as `ghcr.io/dain98/clipline-cloud:1.2.15`
rather than `latest`.
...
- [Release notes](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.15) — v1.2.15.
