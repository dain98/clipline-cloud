...
- **Current release:** [`v1.2.0`](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.0)
- **Image:** `ghcr.io/dain98/clipline-cloud:1.2.0`
...
CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.2.0 docker compose up -d
```
...
`https://` URL. Pin `CLIPLINE_IMAGE` to a released tag such as `ghcr.io/dain98/clipline-cloud:1.2.0`
rather than `latest`.
...
- [Release notes](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.0) — v1.2.0.
