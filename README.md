...
- [v1.2.26](https://github.com/dain98/clipline-cloud/releases/tag/v1.2.26)
- `ghcr.io/dain98/clipline-cloud:1.2.26`
...
released tag such as `1.2.26` when you want explicit upgrade and rollback control.
