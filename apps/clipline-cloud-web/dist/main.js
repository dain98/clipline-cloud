...
`||n==="\r"?(l(),o=2):i+=n),o===3&&i==="!--"&&(o=4,d=d[0])}return l(),d})(e)),t),arguments,[])).length>1?t:t[0]}var r=Ta.bind(wt);le();function Ma(e){let t=e,a=new Set;return{get:()=>t,set(n){t=n,a.forEach(s=>s(t))},update(n){this.set(n(t))},subscribe(n){return a.add(n),()=>a.delete(n)}}}function j(e){let[t,a]=g(e.get());return E(()=>e.subscribe(a),[e]),t}var N=Ma({user:null,csrfToken:null,ready:!1}),tt=Ma([]),Qn=0;function v(e,{actionLabel:t,onAction:a,timeoutMs:n=5e3}={}){let s=++Qn;return tt.update(o=>[...o,{id:s,message:e,actionLabel:t,onAction:a}]),n&&setTimeout(()=>at(s),n),s}function at(e){tt.update(t=>t.filter(a=>a.id!==e))}function Le(e){try{return decodeURIComponent(e)}catch{return e}}function Ra(e){let t=Number(e.get("page")||1);return{sort:e.get("sort")||"uploaded_at_desc",game:e.get("game")||"",q:e.get("q")||"",page:Number.isFinite(t)?Math.max(1,t):1}}var Yn=["login","resetPassword","public","publicLibrary","publicGame","publicUser","about","games"];function Rt(e){return Yn.includes(e)}function Ea(e,t){return!t&&!Rt(e)}var Xn={publicLibrary:"feed",publicGame:"feed",games:"games",library:"library",clip:"library",admin:"admin",profile:"profile"};function Et(e){return Xn[e?.name]||""}function Ua(e){return e?.name==="publicLibrary"&&e.surface==="search"?"search":Et(e)}function Ne(e,t){let a=new URLSearchParams(t||""),n=e;return n.startsWith("/c/")?{name:"public",shareId:Le(n.slice(3))}:n==="/"||n==="/public"||n==="/search"?{name:"publicLibrary",query:Ra(a),surface:n==="/search"?"search":"feed"}:n.startsWith("/game/")?{name:"publicGame",game:Le(n.slice(6)),query:Ra(a)}:n==="/about"?{name:"about"}:n==="/games"?{name:"games"}:n.startsWith("/u/")?{name:"publicUser",username:Le(n.slice(3))}:n==="/library"?{name:"library"}:n.startsWith("/clip/")?{name:"clip",clipId:Le(n.slice(6))}:n==="/admin/game-categories"?{name:"admin",tab:"categories"}:n.startsWith("/admin/game-categories/")?{name:"admin",tab:"categories",categoryId:Le(n.slice(23))}:n==="/admin"?{name:"admin",tab:a.get("tab")||"overview"}:n==="/account"?{name:"account"}:n==="/profile"?{name:"profile"}:n==="/login"?{name:"login"}:n==="/reset-password"?{name:"resetPassword",token:a.get("token")||"",invite:a.get("invite")==="1"}:{name:"publicLibrary"}}var Ut=new Set;function W(e){window.history.pushState({},"",e),Da()}function Da(){let{pathname:e,search:t}=window.location,a=Ne(e,t);Ut.forEach(n=>n(a))}typeof window<"u"&&window.addEventListener("popstate",Da);function Ia(){let[e,t]=g(()=>Ne(window.location.pathname,window.location.search));return E(()=>(Ut.add(t),()=>Ut.delete(t)),[]),e}function Aa(e){let t=e.target.closest("a[href^='/']");!t||t.target||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),W(t.getAttribute("href")))}var La={alert:'<path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>',arrowLeft:'<path d="m15 18-6-6 6-6"/><path d="M9 12h12"/>',clipboard:'<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>',copy:'<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',external:'<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',edit:'<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/>',fastForward:'<path d="m13 19 9-7-9-7v14Z"/><path d="m2 19 9-7-9-7v14Z"/>',film:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M17 3v18"/><path d="M3 8h4"/><path d="M3 16h4"/><path d="M17 8h4"/><path d="M17 16h4"/>',fullscreen:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/>',home:'<path d="m3 10 9-7 9 7"/><path d="M5 8.5V20a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.5"/><path d="M9 22V12h6v10"/>',info:'<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',logOut:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/>',menu:'<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h16"/>',message:'<path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"/>',notepad:'<path d="M8 2v4"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M6 4h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><path d="M8 14h8"/><path d="M8 18h5"/>',pause:'<path d="M8 5v14"/><path d="M16 5v14"/>',play:'<path d="m8 5 11 7-11 7V5Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',refresh:'<path d="M21 12a9 9 0 0 1-15.5 6.3L3 16"/><path d="M3 21v-5h5"/><path d="M3 12A9 9 0 0 1 18.5 5.7L21 8"/><path d="M21 3v5h-5"/>',rewind:'<path d="m11 19-9-7 9-7v14Z"/><path d="m22 19-9-7 9-7v14Z"/>',save:'<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2Z"/><path d="M17 21v-8H7v8"/><path d="M7 3v5h8"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',server:'<rect width="20" height="8" x="2" y="2" rx="2"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 6h.01"/><path d="M6 18h.01"/>',skipBack:'<path d="M19 20 9 12l10-8v16Z"/><path d="M5 19V5"/>',skipForward:'<path d="m5 4 10 8-10 8V4Z"/><path d="M19 5v14"/>',shield:'<path d="M20 13c0 5-3.5 7.5-7.7 8.8a1 1 0 0 1-.6 0C7.5 20.5 4 18 4 13V5l8-3 8 3v8Z"/>',sliders:'<path d="M4 21v-7"/><path d="M4 10V3"/><path d="M12 21v-9"/><path d="M12 8V3"/><path d="M20 21v-5"/><path d="M20 12V3"/><path d="M2 14h4"/><path d="M10 8h4"/><path d="M18 16h4"/>',theater:'<rect width="20" height="14" x="2" y="5" rx="2"/><path d="M6 9h12"/><path d="M6 15h12"/>',trash:'<path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m17 8-5-5-5 5"/><path d="M12 3v12"/>',user:'<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.9"/><path d="M16 3.1a4 4 0 0 1 0 7.8"/>',volume2:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9 9 0 0 1 0 14"/>',volumeX:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>'};function C(e,{size:t=18}={}){return r`<svg viewBox="0 0 24 24" width=${t} height=${t} fill="none"
    ...
    ${a?r`<div class="avatar-wrap" ref=${o}>
          <button class="avatar-btn" aria-haspopup="menu" aria-expanded=${n}
            onClick=${()=>s(!n)}>
            <${Se} user=${a} size=${28} />
          </button>
          ${n&&r`<div class="menu" role="menu" onClick=${()=>s(!1)}>
            <a role="menuitem" href="/profile">Profile</a>
            <a role="menuitem" href="/account">Account</a>
            ${l&&r`<a role="menuitem" href="/admin">Admin</a>`}
            <button role="menuitem" class="menu-danger" onClick=${ss}>Sign out</button>
          </div>`}
        </div>`:r`<a class="btn" href="/login">${C("lock",{size:14})} Sign in</a>`}
  </header>`}async function ss(){let{api:e,setCsrfToken:t}=await Promise.resolve().then(()=>(le(),Pa));try{await e("/api/v1/auth/logout",{method:"POST"})}catch{}t(null),N.set({user:null,csrfToken:null,ready:!0}),W("/login")}var os=[["feed","/","home","Feed",!0],["games","/games","globe","Games",!0],["library","/library","library","Library","auth"],["search","/search","search","Search",!0],["profile","/profile","user","Profile","auth"]];function rs(e){return os.filter(([,,,,t])=>t!=="auth"||!!e)}function Ba({active:e}){let{user:t}=j(N),a=rs(t);return r`<nav class="tabbar" aria-label="Primary">
    ${a.map(([n,s,o,i])=>r`
      <a class=${n===e?"tab-on":""} href=${s}>${C(o)}<span>${i}</span></a>`)}
  ...
  </div>`}le();function Be(e,t,a=null){let n=e!=null,[s,o]=g(()=>({key:e,data:a,error:null,loading:n}));E(()=>{if(!n){o({key:e,data:a,error:null,loading:!1});return}let c=new AbortController;return o({key:e,data:a,error:null,loading:!0}),Promise.resolve().then(()=>t(c.signal)).then(d=>{o(l=>l.key===e?{key:e,data:d,error:null,loading:!1}:l)}).catch(d=>{d?.name!=="AbortError"&&o(l=>l.key===e?{key:e,data:a,error:d,loading:!1}:l)}),()=>c.abort()},[e,t]);let i=Pt(c=>{o(d=>{if(d.key!==e)return d;let l=typeof c=="function"?c(d.data):c;return{...d,data:l}})},[e]);return s.key!==e?{data:a,error:null,loading:n,setData:i}:{data:s.data,error:s.error,loading:s.loading,setData:i}}function ie(e,t=0,a=null){let n=Pt(s=>k(e,{signal:s}),[e]);return Be(`${e}\0${t}`,n,a)}function J(e){if(!e)return"Unknown";let t=new Date(e);return Number.isNaN(t.getTime())?"Unknown":new Intl.DateTimeFormat(void 0,{dateStyle:"medium",timeStyle:"short"}).format(t)}function ve(e){if(e==null)return"Unknown";let t=Math.max(0,Math.round(Number(e)/1e3)),a=Math.floor(t/60),n=t%60;return`${a}:${String(n).padStart(2,"0")}`}function nt(e){if(!e)return"Unknown";let t=new Date(e);if(Number.isNaN(t.getTime()))return"Unknown";let a=Math.min(0,t.getTime()-Date.now()),n=[["year",365*24*60*60*1e3],["month",720*60*60*1e3],["week",10080*60*1e3],["day",1440*60*1e3],["hour",3600*1e3],["minute",60*1e3],["second",1e3]],[s,o]=n.find(([,c])=>Math.abs(a)>=c)||n[n.length-1],i=Math.round(a/o);return new Intl.RelativeTimeFormat(void 0,{numeric:"always"}).format(i,s)}function F(e){if(e==null)return"Unknown";let t=Number(e);if(!Number.isFinite(t))return"Unknown";let a=["B","KiB","MiB","GiB","TiB"],n=t,s=0;for(;n>=1024&&s<a.length-1;)n/=1024,s+=1;return`${n.toFixed(s===0?0:1)} ${a[s]}`}function Pe(e){let t=Number(e||0),a=Number.isFinite(t)&&t>0?Math.floor(t):0;return`${new Intl.NumberFormat(void 0,{notation:a>=1e4?"compact":"standard"}).format(a)} view${a===1?"":"s"}`}function ye(e){return`/api/v1/public/clips/${encodeURIComponent(e.share_id)}/thumbnail`}function It(e){return`/api/v1/clips/${encodeURIComponent(e.id)}/thumbnail`}function st(e){return`/api/v1/clips/${encodeURIComponent(e.id)}/media`}function Fa(e){return`/api/v1/clips/${encodeURIComponent(e.id)}/poster`}function ot(e){return`/api/v1/public/clips/${encodeURIComponent(e.share_id)}/poster`}function Re(e){return`/api/v1/public/clips/${encodeURIComponent(e.share_id)}/media`}function ze(e,t,a){if(e)try{return`${t}${new URL(e).pathname}`}catch{}return a?`${t}/c/${encodeURIComponent(a)}`:null}var rt=null;function Oa(e){rt?.(),rt=e}function Va(e){rt===e&&(rt=null)}var is=()=>window.matchMedia("(pointer: fine)").matches&&!window.matchMedia("(prefers-reduced-motion: reduce)").matches&&!navigator.connection?.saveData;function Ha({src:e,poster:t,alt:a=""}){let[n,s]=g(!1),[o,i]=g(0),c=z(null),d=z(null),l=z(!0),m=z(),h=()=>{l.current&&(clearTimeout(c.current),s(!1),i(0))};m.current=h;let u=()=>{!e||!is()||(c.current=setTimeout(()=>{l.current&&(Oa(m.current),s(!0))},300))},f=b=>{let w=b.target;w.duration&&i(w.currentTime/w.duration)};return E(()=>()=>{l.current=!1,clearTimeout(c.current),Va(m.current)},[]),r`<span class="hover-preview" onPointerEnter=${u} onPointerLeave=${h}>
    ${n?r`<video ref=${d} src=${e} poster=${t} muted loop autoplay
          playsinline preload="none" onTimeUpdate=${f} />`:r`<img src=${t} alt=${a} loading="lazy" />`}
    ${n&&r`<span class="preview-scrub"><span style=${`width:${o*100}%`} /></span>`}
  </span>`}function At(e){return e.owner?.display_name||e.owner?.username||e.owner_username||e.author_name||e.author_username||null}function Ee({clip:e,href:t,selectable:a=!1,selected:n=!1,onToggleSelect:s,showVisibility:o=!1,showAuthor:i=!1}){let c=At(e),d=[e.game_name&&r`<em>${e.game_display_name||e.game_name}</em>`,i&&c,e.view_count!=null&&Pe(e.view_count),e.uploaded_at&&nt(e.uploaded_at)].filter(Boolean);return r`<article class=${`clip-card ${n?"is-selected":""} ${a?"is-selectable":""}`}>
    ...
    ${a&&r`<p>${a}</p>`}
    ${n}
  </div>`}var ls=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],cs=6,us=60,ds=/^[0-9A-HJKMNP-TV-Z]{26}$/i;function ps(e){return ds.test(String(e||"").trim())}function ms(e){let t=new URLSearchParams;return t.set("page_size",String(us)),e.sort!=="uploaded_at_desc"&&t.set("sort",e.sort),e.game&&t.set(ps(e.game)?"game_category_id":"game",e.game),e.q&&t.set("q",e.q),Number(e.page)>1&&t.set("page",String(e.page)),t}function qa(e){return e?.game_display_name||e?.game_name||"No game"}function fs(e,t,a=cs){let n=[...e||[]].sort((h,u)=>(u.clip_count||0)-(h.clip_count||0)),s=n.slice(0,a),o=String(t||"").trim(),i=o&&s.some(h=>h.category_id===o),c=o&&!i?n.find(h=>h.category_id===o)||{category_id:o,clip_count:0}:null,d=c?[c,...s]:s,l=new Set(d.map(h=>h.category_id)),m=n.filter(h=>!l.has(h.category_id)).length;return{chips:d,extraGameCount:m}}function Nt({route:e}){let t={sort:"uploaded_at_desc",page:1,q:"",...e.query,game:e.name==="publicGame"?e.game:e.query?.game||""},a=`/api/v1/public/clips?${ms(t)}`,{data:n,error:s}=ie(a),{data:o}=ie("/api/v1/public/games",0,{games:[]}),i=o?.games||[],c=f=>W(bs({...t,page:1,...f}));if(s)return r`<main class="page">
      <${Q} name="alert" title="Couldn't load the feed" body=${s.message} />
    </main>`;let d=n?.clips,l=!!(t.game||t.q)||Number(t.page)>1,m=!l,{chips:h,extraGameCount:u}=fs(i,t.game);return r`<main class="page">
    ${d==null?r`<${hs} />`:d.length===0?r`<${Q} name="film"
        ...
        <div class="feed-toolbar">
          ...
          <select class="input" value=${t.sort} onChange=${f=>c({sort:f.target.value})}>
            ${ls.map(([f,b])=>r`<option value=${f}>${b}</option>`)}
          </select>
          <div class="chips">
        ...
        ${gs(n,t,c)}
      `}
  </main>`}function _s(e){let[t,...a]=e,n=a.slice(0,3);return r`<p class="kicker">Now playing on this server</p>
    <section class="hero">
      ...
      <div class="hero-side">
        ${n.map(s=>r`<a class="hero-row" href=${Lt(s)}>
            <span class="hero-thumb">
              <img src=${ye(s)} alt="" loading="lazy" />
              <span class="dur-pill">${ve(s.duration_ms)}</span>
            </span>
            <span class="hero-copy"><b>${s.title}</b>
              <small>${At(s)} · ${qa(s)} · ${Pe(s.view_count)}</small></span>
          </a>`)}
      </div>
    </section>`}function hs({count:e=8}){return r`<div class="card-grid">
    ${Array.from({length:e},(t,a)=>r`<div class="clip-card" key=${a}>
      <div class="skeleton-thumb"></div>
      <div class="skeleton-line"></div>
      <div class="skeleton-line is-short"></div>
    </div>`)}
  </div>`}function Lt(e){return`/c/${encodeURIComponent(e.share_id)}`}function bs({sort:e="uploaded_at_desc",game:t="",q:a="",page:n=1}={}){let s=new URLSearchParams,o=e||"uploaded_at_desc",i=String(t||"").trim(),c=String(a||"").trim(),d=Math.max(1,Number(n||1));if(o!=="uploaded_at_desc"&&s.set("sort",o),d>1&&s.set("page",String(d)),c)return s.set("q",c),i&&s.set("game",i),`/search?${s.toString()}`;if(i){let m=s.toString();return`/game/${encodeURIComponent(i)}${m?`?${m}`:""}`}let l=s.toString();return l?`/search?${l}`:"/"}function gs(e,t,a){let n=Math.max(1,Number(t.page||1)),s=!!e?.has_more;return n<=1&&!s?"":r`<nav class="pager" aria-label="Public clip pages">
    ...
    ${a==null?r`<div class="game-grid">
          ${Array.from({length:6},(n,s)=>r`<div class="game-tile is-loading" key=${s}>
            <div class="skeleton-thumb"></div>
          </div>`)}
  ...
  </main>`}le();function Ka({trigger:e,content:t,onClose:a,label:n,panelClass:s=""}){let[o,i]=g(!1),c=z(null),d=z(null),l=z(null),m=()=>{i(!1),a?.()},h=()=>{if(o){m();return}l.current=document.activeElement,i(!0)};return E(()=>{if(!o)return;let u=w=>{c.current?.contains(w.target)||m()},f=w=>{w.key==="Escape"&&m()};return document.addEventListener("pointerdown",u),document.addEventListener("keydown",f),d.current?.querySelector("input, select, textarea, button, a[href], [tabindex]")?.focus(),()=>{document.removeEventListener("pointerdown",u),document.removeEventListener("keydown",f),l.current?.focus?.()}},[o]),r`<div class="popover-wrap" ref=${c}>
    ${e({open:o,toggle:h})}
    ${o&&r`<div class=${`popover ${s}`} ref=${d} role="dialog" aria-label=${n||"Filters"}>
      ${t}
    </div>`}
  </div>`}function Wa({count:e,busy:t=!1,onPublic:a,onPrivate:n,onCopyLinks:s,onDelete:o,onClear:i}){return e?r`<div class="bulkbar" role="toolbar" aria-label="Bulk actions" aria-busy=${t?"true":"false"}>
    <b>${e} selected</b>
  ...
  </div>`:null}function pe({open:e,title:t,body:a,confirmLabel:n="Confirm",onConfirm:s,onCancel:o,danger:i=!1,confirmDisabled:c=!1}){let d=z(null),l=z(null);return E(()=>{let m=d.current;m&&(e&&!m.open?(m.showModal(),l.current?.focus()):!e&&m.open&&m.close())},[e]),r`<dialog ref=${d} class="confirm-dialog" aria-labelledby="confirm-dialog-title"
    ...
    ${e&&r`<div class="confirm-dialog-body">
      ...
      <div class="confirm-dialog-actions">
        ...
        <button type="button" ref=${l} class=${`btn ${i?"btn-danger":"btn-primary"}`}
          disabled=${c} onClick=${s}>${n}</button>
      </div>
    </div>`}
  </dialog>`}var Ja="clipline.libraryView",$s=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["updated_at_desc","Updated newest"],["updated_at_asc","Updated oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["size_desc","Size largest"],["size_asc","Size smallest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],it={title:["title_asc","title_desc"],size:["size_asc","size_desc"],duration:["duration_asc","duration_desc"],uploaded:["uploaded_at_asc","uploaded_at_desc"]},vs=["visibility","status","source_type","from","to","min_duration_seconds","max_duration_seconds","min_size_mib","max_size_mib"],ut={sort:"uploaded_at_desc",page:1,game:"",source_type:"",visibility:"",status:"",q:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""};function lt(e){if(e===""||e==null)return null;let t=Number(e);return Number.isFinite(t)?t:null}function ys(e){let t=new URLSearchParams;t.set("sort",e.sort||ut.sort),t.set("page_size","100"),t.set("page",String(Math.max(1,Number(e.page||1)))),e.game&&t.set("game_category_id",e.game);for(let i of["source_type","visibility","status","q"])e[i]&&t.set(i,e[i]);e.from&&t.set("from",`${e.from}T00:00:00Z`),e.to&&t.set("to",`${e.to}T23:59:59Z`);let a=lt(e.min_duration_seconds);a!=null&&t.set("min_duration_ms",String(Math.round(a*1e3)));let n=lt(e.max_duration_seconds);n!=null&&t.set("max_duration_ms",String(Math.round(n*1e3)));let s=lt(e.min_size_mib);s!=null&&t.set("min_size_bytes",String(Math.round(s*1024*1024)));let o=lt(e.max_size_mib);return o!=null&&t.set("max_size_bytes",String(Math.round(o*1024*1024))),t}function ws(e){return vs.reduce((t,a)=>t+(e[a]?1:0),0)}function ks(e,t=6){let a=new Map;for(let n of e){let s=n.game_category_id||n.game_name;if(!s)continue;let o=a.get(s)||{count:0,label:n.game_display_name||s,iconUrl:n.game_icon_url||null};o.count+=1,!o.iconUrl&&n.game_icon_url&&(o.iconUrl=n.game_icon_url),a.set(s,o)}return Array.from(a,([n,s])=>({game:n,count:s.count,label:s.label,...s.iconUrl?{icon_url:s.iconUrl}:{}})).sort((n,s)=>s.count-n.count||n.label.localeCompare(s.label)).slice(0,t)}function Za(e,t,{verb:a,allFailedMessage:n}){let s=e.filter(i=>!t.some(c=>c.id===i));if(!t.length)return{succeeded:s,message:null};let o=t.length===e.length?t[0]?.message||n:`Couldn't ${a} ${t.length} of ${e.length} clips.`;return{succeeded:s,message:o}}function Cs(e,t){return(e||[]).map(a=>ze(a.public_url,t,a.public_share_id)).filter(Boolean)}async function ja(e,t,a){let n=0;async function s(){let o=n++;if(!(o>=e.length))return await a(e[o]),s()}await Promise.all(Array.from({length:Math.min(t,e.length)},s))}function Ss(){try{return localStorage.getItem(Ja)==="rows"?"rows":"grid"}catch{return"grid"}}function Qa(){let[e,t]=g(Ss),[a,n]=g(ut),[s,o]=g(ut.q),[i,c]=g(new Set),[d,l]=g(!1),[m,h]=g(!1),[u,f]=g(0),b=`/api/v1/clips?${ys(a)}`,{data:w,error:P,setData:R}=ie(b,u),S=z(!1),D=z(null);E(()=>()=>clearTimeout(D.current),[]),E(()=>c(new Set),[b,u]);let O=p=>{t(p);try{localStorage.setItem(Ja,p)}catch{}},I=()=>f(p=>p+1),U=p=>{S.current=p,l(p)},q=p=>{let $=p.target.value;o($),clearTimeout(D.current),D.current=setTimeout(()=>{n(M=>({...M,q:$,page:1}))},300)},V=p=>$=>{let M=$.target.value;n(L=>({...L,[p]:M,page:1}))},Y=()=>{n(p=>({...p,page:1,visibility:"",status:"",source_type:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""}))},A=p=>n($=>({...$,game:$.game===p?"":p,page:1})),G=p=>n($=>({...$,sort:p,page:1})),_e=p=>n($=>({...$,page:Math.max(1,p)})),me=p=>{c($=>{let M=new Set($);return M.has(p)?M.delete(p):M.add(p),M})};function se(p,$){R(M=>M&&{...M,clips:M.clips.map(L=>L.id===p?{...L,...$}:L)})}function we(p,$){let M=new Set(p);R(L=>L&&{...L,clips:L.clips.map(_=>M.has(_.id)?{..._,...$}:_)})}async function ee(p){if(S.current)return;let $=Array.from(i);if(!$.length)return;let M=w?.clips||[],L=new Map($.map(T=>[T,M.find(re=>re.id===T)]));U(!0),we($,{visibility:p});let _=[],x=new Map;try{await ja($,4,async he=>{try{let de=await k(`/api/v1/clips/${encodeURIComponent(he)}/visibility`,{method:"POST",body:{visibility:p}}),Ue={visibility:de.visibility,public_url:de.public_url,public_share_id:de.public_share_id};se(he,Ue),x.set(he,Ue)}catch(de){_.push({id:he,message:de.message})}});let{succeeded:T,message:re}=Za($,_,{verb:"update",allFailedMessage:"Couldn't update visibility."});if(re){for(let{id:he}of _){let de=L.get(he);de&&se(he,{visibility:de.visibility,public_url:de.public_url,public_share_id:de.public_share_id})}v(re)}T.length&&(c(new Set),v(`Made ${T.length} clip${T.length===1?"":"s"} ${p}`,{actionLabel:"Undo",onAction:()=>X(T,L,x)}))}finally{U(!1)}}async function X(p,$,M){if(S.current){v("Wait for visibility changes to finish.");return}U(!0);try{for(let x of p){let T=$.get(x);T&&se(x,{visibility:T.visibility,public_url:T.public_url,public_share_id:T.public_share_id})}let L=[];await ja(p,4,async x=>{let T=$.get(x);if(T)try{let re=await k(`/api/v1/clips/${encodeURIComponent(x)}/visibility`,{method:"POST",body:{visibility:T.visibility}});se(x,{visibility:re.visibility,public_url:re.public_url,public_share_id:re.public_share_id})}catch(re){L.push({id:x,message:re.message})}});let{message:_}=Za(p,L,{verb:"undo",allFailedMessage:"Couldn't undo visibility change."});if(_){for(let{id:x}of L){let T=M.get(x);T&&se(x,T)}v(_)}}finally{U(!1)}}async function ce(){if(S.current){v("Wait for visibility changes to finish.");return}let p=Array.from(i),$=w?.clips||[],M=p.map(x=>$.find(T=>T.id===x)).filter(Boolean),L=Cs(M,window.location.origin),_=M.length-L.length;if(!L.length){v("No links to copy \u2014 selected clips are private.");return}try{await navigator.clipboard.writeText(L.join(`
`)),v(`Copied ${L.length} link${L.length===1?"":"s"}`+(_?` (${_} skipped, private)`:""))}catch{v("Couldn't copy links to clipboard.")}}async function ue(){let p=Array.from(i);h(!1);try{let $=await k("/api/v1/clips/bulk-delete",{method:"POST",body:{ids:p}});c(new Set),I(),v(`Deleted ${$.affected} clip${$.affected===1?"":"s"}.`)}catch($){v($.message)}}if(P)return r`<main class="page">
    ...
    </main>`;let te=w?.clips,ae=ws(a),ke=!!(a.q||a.game)||ae>0,oe=ks(te||[]),be=Number(w?.total??(te||[]).length),xe=Number(w?.total_size_bytes??(te||[]).reduce((p,$)=>p+($.file_size_bytes||0),0)),fe=Number(w?.page||a.page||1),y=fe>1||!!w?.has_more,H=r`<div class="popover-fields">
    ...
    <div class="lib-toolbar">
      ...
      <select class="input" aria-label="Sort" value=${a.sort} onChange=${p=>G(p.target.value)}>
        ${$s.map(([p,$])=>r`<option value=${p}>${$}</option>`)}
      </select>
      <${Ka}
        label="Filters"
    ...
    ${oe.length>0&&r`<div class="lib-chips">
      ...
      ${oe.map(p=>r`<button type="button" class=${`chip game-filter-chip ${p.icon_url?"has-icon":""} ${a.game===p.game?"chip-on":""}`}
    ...
    ${te==null?r`<${Ts} />`:te.length===0?ke?r`<${Q} name="film" title="No clips match this view"
            body="Try a different search, game, or clear your filters."
            action=${r`<button type="button" class="btn" onClick=${()=>{n(ut),o("")}}>Clear filters</button>`} />`:r`<${Q} name="upload" title="Connect the Clipline desktop app to start uploading"
    ...
    <${pe} open=${m}
      ...
      onConfirm=${ue}
      onCancel=${()=>h(!1)} />
  </main>`}function ct(e,[t,a]){let n=e.sort===t?"ascending":e.sort===a?"descending":"none",s=e.sort===a?t:a;return{ariaSort:n,next:s}}function xs({clips:e,query:t,onSort:a,selected:n,onToggleSelect:s}){let o=ct(t,it.title),i=ct(t,it.size),c=ct(t,it.duration),d=ct(t,it.uploaded);return r`<table class="lib-table">
    <thead>
      <tr>
  ...
  </div>`}le();function Xa(e){let t=Number(e);return Number.isFinite(t)&&t>0?t/1e3:0}function en(e,t){let a=Number.isFinite(e)?e:0,n=t>0?t:Number.MAX_SAFE_INTEGER;return Math.max(0,Math.min(n,a))}function dt(e,t){return t>0?Math.max(0,Math.min(100,e/t*100)):0}function Bt(e){if(!Number.isFinite(e))return"0:00";let t=Math.max(0,Math.round(e)),a=Math.floor(t/60),n=t-a*60;return`${a}:${String(n).padStart(2,"0")}`}function Ya(e){if(!Number.isFinite(e))return"0:00.0";let t=Math.max(0,Math.round(e*10)),a=Math.floor(t/600),n=t-a*600,s=Math.floor(n/10);return`${a}:${String(s).padStart(2,"0")}.${n%10}`}function tn(e,t){return`${Ya(e)} / ${t>0?Ya(t):"0:00.0"}`}function an(e,t){return(e||[]).map((a,n)=>{let s=Number(a.timestamp_ms);if(!Number.isFinite(s))return null;let o=s/1e3;return o<0||t>0&&o>t?null:{index:n,time:o,label:String(a.label||a.kind||"Marker")}}).filter(Boolean).sort((a,n)=>a.time-n.time)}function nn(e,t){if(!e.length)return null;for(let a of e)if(a.time>t+.05)return a;return e[0]}function sn(e,t){if(!e.length)return null;for(let a=e.length-1;a>=0;a-=1)if(e[a].time<t-.05)return e[a];return e[e.length-1]}var rn="clipline.playerVolume",ln="clipline.clipTheaterMode",Ps=2e3,Ms=[.25,.5,.75,1,1.25,1.5,2];function Rs(e,t){switch(e){case"Space":case"KeyK":return{kind:"toggle-play"};case"ArrowLeft":return{kind:"seek-by",seconds:t?-1:-5};case"ArrowRight":return{kind:"seek-by",seconds:t?1:5};case"KeyJ":return{kind:"seek-by",seconds:-10};case"KeyL":return{kind:"seek-by",seconds:10};case"Comma":return{kind:"seek-by",seconds:-.1};case"Period":return{kind:"seek-by",seconds:.1};case"KeyM":return{kind:"toggle-mute"};case"Home":return{kind:"seek-to",seconds:0};case"End":return{kind:"seek-to-end"};case"KeyF":case"KeyT":return{kind:"theater"};case"Escape":return{kind:"exit-theater"};default:return null}}function Es(e){return e instanceof Element?!!e.closest("input, textarea, select, button, a, [contenteditable='true'], [contenteditable='']"):!1}function Us(){try{let e=window.localStorage.getItem(rn);if(e==null)return 1;let t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(1,t)):1}catch{return 1}}function on(e){try{window.localStorage.setItem(rn,String(Math.max(0,Math.min(1,e))))}catch{}}function Ds(){try{return window.localStorage.getItem(ln)==="true"}catch{return!1}}function Is(e){try{window.localStorage.setItem(ln,String(e))}catch{}}function cn({src:e,poster:t,durationMs:a,markers:n}){let s=z(null),o=z(null),i=z(null),c=z(!1),d=z(!1),l=Xa(a),[m,h]=g(!1),[u,f]=g(0),[b,w]=g(l),[P,R]=g(0),[S,D]=g(Us),[O,I]=g(!1),[U,q]=g(1),[V,Y]=g(!1),[A,G]=g(Ds),[_e,me]=g(!0),[se,we]=g(null),[ee,X]=g(""),ce=an(n,b);function ue(){me(!0),window.clearTimeout(i.current),i.current=window.setTimeout(()=>{let _=s.current;_&&!_.paused&&!_.ended&&me(!1)},Ps)}E(()=>{m||(window.clearTimeout(i.current),me(!0))},[m]),E(()=>{let _=s.current;if(!_)return;let x=()=>Number.isFinite(_.duration)&&_.duration>0?_.duration:l,T=()=>w(x()),re=()=>w(x()),he=()=>{c.current||f(_.currentTime||0)},de=()=>{let Zt=x();if(!(Zt>0)||!_.buffered?.length){R(0);return}let jt=_.currentTime||0,Oe=0;for(let Ve=0;Ve<_.buffered.length;Ve+=1){let An=_.buffered.start(Ve),ht=_.buffered.end(Ve);if(jt>=An&&jt<=ht){Oe=ht;break}Oe=Math.max(Oe,ht)}R(dt(Oe,Zt))},Ue=()=>{h(!0),X(""),ue()},qt=()=>h(!1),Gt=()=>h(!1),Kt=()=>{D(_.volume),I(_.muted||_.volume===0)},Wt=()=>X("Playback unavailable");return _.addEventListener("loadedmetadata",T),_.addEventListener("durationchange",re),_.addEventListener("timeupdate",he),_.addEventListener("progress",de),_.addEventListener("play",Ue),_.addEventListener("pause",qt),_.addEventListener("ended",Gt),_.addEventListener("volumechange",Kt),_.addEventListener("error",Wt),()=>{_.removeEventListener("loadedmetadata",T),_.removeEventListener("durationchange",re),_.removeEventListener("timeupdate",he),_.removeEventListener("progress",de),_.removeEventListener("play",Ue),_.removeEventListener("pause",qt),_.removeEventListener("ended",Gt),_.removeEventListener("volumechange",Kt),_.removeEventListener("error",Wt)}},[e,l]),E(()=>{s.current&&(s.current.volume=S)},[S]),E(()=>{s.current&&(s.current.muted=O)},[O]),E(()=>{s.current&&(s.current.playbackRate=U)},[U]),E(()=>{let _=s.current;if(!_)return;let x=!1;async function T(){if(!x)try{await _.play();return}catch{if(x||!_.paused)return;_.muted=!0,I(!0);try{await _.play()}catch(re){X(re?.message||"Playback unavailable")}}}return _.readyState>=HTMLMediaElement.HAVE_FUTURE_DATA?T():_.addEventListener("canplay",T,{once:!0}),()=>{x=!0,_.removeEventListener("canplay",T)}},[e]),E(()=>{let _=document.documentElement;return _.classList.toggle("clipline-theater",A),()=>_.classList.remove("clipline-theater")},[A]);function te(_){G(_),Is(_)}function ae(_){let x=s.current;if(!x)return;let T=b>0?en(_,b):Math.max(0,_);x.currentTime=T,f(T)}function ke(_){ae((s.current?.currentTime||0)+_)}async function oe(){let _=s.current;if(_)if(_.paused||_.ended)try{await _.play()}catch(x){X(x?.message||"Playback failed")}else _.pause()}function be(){let _=s.current;_&&(_.muted||_.volume===0?(_.muted=!1,_.volume===0&&(_.volume=1,D(1),on(1)),I(!1)):(_.muted=!0,I(!0)))}function xe(_){let x=Number(_.target.value);D(x),I(x===0),on(x);let T=s.current;T&&(T.volume=x,T.muted=x===0)}async function fe(){try{document.fullscreenElement?await document.exitFullscreen():await o.current?.requestFullscreen?.()}catch(_){X(_?.message||"Fullscreen unavailable")}}function y(_){let x=s.current?.currentTime||0,T=_>0?nn(ce,x):sn(ce,x);T&&ae(T.time)}function H(){c.current=!0,d.current=m,m&&s.current?.pause()}function p(_){let x=Number(_.target.value);f(x),ae(x)}function $(){c.current&&(c.current=!1,d.current&&(d.current=!1,s.current?.play().catch(()=>{})))}function M(_){let x=_.currentTarget.getBoundingClientRect();if(!(x.width>0))return;let T=Math.max(0,Math.min(1,(_.clientX-x.left)/x.width));we({pct:T*100,time:T*(b||0)})}function L(){we(null)}return E(()=>{function _(x){if(x.defaultPrevented||Es(x.target))return;let T=Rs(x.code,x.shiftKey);if(T&&!(T.kind==="exit-theater"&&!A))switch(x.preventDefault(),ue(),T.kind){case"toggle-play":oe();break;case"seek-by":ke(T.seconds);break;case"seek-to":ae(T.seconds);break;case"seek-to-end":ae(b);break;case"next-marker":y(1);break;case"previous-marker":y(-1);break;case"toggle-mute":be();break;case"theater":te(!A);break;case"exit-theater":te(!1);break;case"fullscreen":fe();break;default:break}}return document.addEventListener("keydown",_),()=>document.removeEventListener("keydown",_)},[b,A,m]),r`<div class=${`player ${_e?"":"chrome-hidden"}`} ref=${o}
      onPointerMove=${ue} onPointerEnter=${ue}
      onPointerLeave=${()=>{let _=s.current;_&&!_.paused&&me(!1)}}
      onFocusIn=${()=>me(!0)}>
    ...
    <div class="player-overlay">
      <div class="player-timeline" onPointerMove=${M} onPointerLeave=${L}>
        ...
        ${se&&r`<div class="player-hover-time" style=${`left:${se.pct}%`}>${Bt(se.time)}</div>`}
      </div>
  ...
  </div>`}le();function As(e){let t=new Map(e.map(o=>[o.id,o])),a=new Map,n=[],s=0;return e.forEach(o=>{let i=o.parent_comment_id||"";i&&t.has(i)?(a.has(i)||a.set(i,[]),a.get(i).push(o),s+=1):i||(n.push(o),s+=1)}),{roots:n,repliesByParent:a,count:s}}async function Ls({apiClient:e=k,shareId:t,body:a,parentCommentId:n,onReload:s=()=>{},onError:o=v}){let i=a.trim();if(!i)return!1;try{return await e(`/api/v1/public/clips/${encodeURIComponent(t)}/comments`,{method:"POST",body:n?{body:i,parent_comment_id:n}:{body:i}}),s(),!0}catch(c){return o(c.message),!1}}function Ns(e){return(e||"?").trim().slice(0,1).toUpperCase()||"?"}function Bs(e){let t=Dt(e.author_avatar_url);return t?r`<img class="comment-avatar" src=${t} alt="" />`:r`<div class="comment-avatar">${Ns(e.author_name)}</div>`}function un({shareId:e}){let{user:t}=j(N),[a,n]=g(0),[s,o]=g(""),[i,c]=g(null),[d,l]=g(""),[m,h]=g(null),u=`/api/v1/public/clips/${encodeURIComponent(e)}/comments`,{data:f,error:b}=ie(u,a),w=b?[]:f?.comments??null;function P(){n(U=>U+1)}async function R(U,q){return Ls({shareId:e,body:U,parentCommentId:q,onReload:P,onError:v})}async function S(U){U.preventDefault(),await R(s)&&o("")}async function D(U,q){U.preventDefault(),await R(d,q)&&(l(""),c(null))}async function O(){let U=m;h(null);try{await k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments/${encodeURIComponent(U)}`,{method:"DELETE"}),P()}catch(q){v(q.message)}}let I=As(w||[]);return r`<section class="comments">
  ...
  </section>`}function dn(e,t){let{depth:a,repliesByParent:n,user:s,replyOpenId:o,setReplyOpenId:i,replyDraft:c,setReplyDraft:d,submitReply:l,onDelete:m}=t,h=n.get(e.id)||[];return r`<article class="comment" key=${e.id}>
    ${Bs(e)}
    <div class="comment-body">
      <div class="comment-head">
        ...
        <div class="comment-actions">
          ${s&&a===0&&r`<button type="button" class="comment-action"
      ...
      ${s&&a===0&&o===e.id&&r`<form class="comment-reply-form"
        onSubmit=${u=>l(u,e.id)}>
  ...
  </article>`}var zs=["private","public","unlisted"];function Fs(e,t){return e==="clip"?!0:!!t?.viewer_can_edit}function Os(e,t,a){return e==="public"?t.shareId:a?.public_share_id||null}function Vs(e,t,a){return e==="clip"?t.clipId:a?.viewer_clip_id||null}function Hs(e){let t=e?.height!=null?e.height:"",a=Math.round(e?.fps||0)||"";return`${t}p${a}`}function qs(e,t=8){let a=new URLSearchParams;return e&&a.set("share_id",e),a.set("limit",String(t)),`/api/v1/public/recommendations?${a}`}function Gs(e,t,a=8){return(e||[]).filter(n=>n.share_id!==t).slice(0,a)}function Ks(e,t,a){let n=e==="clip"?a||{}:{display_name:t?.author_name||null,username:t?.author_username||null,avatar_url:t?.author_avatar_url||null},s=n.username||null;return{label:n.display_name||s||"Unknown creator",username:s,href:s?`/u/${encodeURIComponent(s)}`:null,avatarUser:n}}function Ws({author:e}){let t=r`
    <${Se} user=${e.avatarUser} size=${36} />
    <span class="watch-author-name">${e.label}</span>
  `,a=e.href?r`<a class="watch-author-link" href=${e.href}>${t}</a>`:r`<span class="watch-author-link watch-author-static">${t}</span>`;return r`<div class="watch-author-row">${a}</div>`}function zt({route:e}){let{user:t}=j(N),[a,n]=g(null),[s,o]=g(null),[i,c]=g([]),[d,l]=g(!1),[m,h]=g(""),[u,f]=g(!1),[b,w]=g(""),[P,R]=g(!1),[S,D]=g(!1),[O,I]=g(!1),U=e.name==="clip"?`clip:${e.clipId}`:`public:${e.shareId}`,q=Os(e.name,e,a),V=e.name==="public"||!!a;if(E(()=>{let y=new AbortController;n(null),o(null),l(!1),f(!1),I(!1),R(!1);let H=e.name==="clip"?`/api/v1/clips/${encodeURIComponent(e.clipId)}`:`/api/v1/public/clips/${encodeURIComponent(e.shareId)}`;return k(H,{signal:y.signal}).then(p=>{n(p),e.name==="public"&&k(`/api/v1/public/clips/${encodeURIComponent(e.shareId)}/view`,{method:"POST",body:{},signal:y.signal}).then($=>n(M=>M&&{...M,view_count:$.view_count})).catch(()=>{})}).catch(p=>{p?.name!=="AbortError"&&o(p)}),()=>y.abort()},[U]),E(()=>{if(!V){c([]);return}let y=new AbortController;return c([]),k(qs(q,8),{signal:y.signal}).then(H=>c(H.clips||[])).catch(()=>{}),()=>y.abort()},[U,q,V]),s)return r`<main class="page"><${Q} name="alert" title="Couldn't load this clip" body=${s.message} /></main>`;if(!a)return r`<main class="page watch"><div><div class="skeleton-thumb"></div></div><aside class="upnext"></aside></main>`;let Y=Fs(e.name,a),A=q,G=Vs(e.name,e,a),_e=e.name==="clip"?st({id:a.id}):Re({share_id:e.shareId}),me=e.name==="clip"?Fa({id:a.id}):ot({share_id:e.shareId}),se=Ks(e.name,a,t),we=a.public_url??a.share_url??null,ee=ze(we,window.location.origin,A),X=e.name==="clip";function ce(){h(a.title),l(!0)}async function ue(y){y?.preventDefault?.();let H=m.trim();if(!H||H===a.title){l(!1);return}try{await k(`/api/v1/clips/${encodeURIComponent(G)}`,{method:"PATCH",body:{title:H}}),n(p=>({...p,title:H})),l(!1),v("Title saved.")}catch(p){v(p.message)}}function te(){w(a.description||""),f(!0)}async function ae(){let y=b.trim();try{await k(`/api/v1/clips/${encodeURIComponent(G)}`,{method:"PATCH",body:{description:y||null}}),n(H=>({...H,description:y||null})),f(!1),v("Description saved.")}catch(H){v(H.message)}}async function ke(y,{force:H=!1}={}){let p=a.visibility;if(!(p===y&&!H)){n($=>({...$,visibility:y}));try{let $=await k(`/api/v1/clips/${encodeURIComponent(G)}/visibility`,{method:"POST",body:{visibility:y}});n(M=>({...M,visibility:$.visibility,public_url:$.public_url,public_share_id:$.public_share_id})),v(`Visibility set to ${y}.`,{actionLabel:"Undo",onAction:()=>ke(p,{force:!0})})}catch($){n(M=>({...M,visibility:p})),v($.message)}}}async function oe(){if(ee)try{await navigator.clipboard.writeText(ee),v("Link copied.")}catch{v("Couldn't copy the link.")}}async function be(){D(!1);try{await k(`/api/v1/clips/${encodeURIComponent(G)}`,{method:"DELETE"}),v("Clip deleted."),W("/library")}catch(y){v(y.message)}}let xe=[a.game_name&&r`<a class="chip chip-on" href=${`/game/${encodeURIComponent(a.game_category_id||a.game_name)}`}>${a.game_display_name||a.game_name}</a>`,Pe(a.view_count),`Recorded ${J(a.recorded_at)}`].filter(Boolean),fe=Gs(i,A,8);return r`<main class="page watch">
    <div>
      ...
      ${Y&&r`<div class="watch-actions">
        <div class="seg" role="radiogroup" aria-label="Visibility">
          ${zs.map(y=>r`<button type="button" role="radio" key=${y} aria-checked=${a.visibility===y}
  ...
  </main>`}le();var Ft=[{top:"4%",left:"4%",width:"34%",rotate:-7},{top:"0%",left:"44%",width:"30%",rotate:5},{top:"34%",left:"68%",width:"28%",rotate:-4},{top:"50%",left:"8%",width:"30%",rotate:6},{top:"62%",left:"42%",width:"26%",rotate:-5},{top:"26%",left:"-4%",width:"22%",rotate:9}];function Zs(e){return Array.isArray(e)?e.slice(0,Ft.length).map((t,a)=>({clip:t,...Ft[a]})):[]}function js(e){let t=e?.clips;if(!Array.isArray(t)||t.length===0)return null;let a=t.length,n=e.has_more?"+":"";return`${a}${n} clip${a===1?"":"s"} on this instance`}function Js({top:e,left:t,width:a,rotate:n}){return`top:${e};left:${t};width:${a};transform:rotate(${n}deg);`}function pn(e){let t=String(e||"").trim();return t||null}function Qs(){let{data:e}=ie(`/api/v1/public/clips?page_size=${Ft.length}`),t=Zs(e?.clips),a=js(e);return r`<aside class="login-montage" aria-hidden="true">
    ${t.length>0&&r`<div class="login-montage-tiles">
      ${t.map((n,s)=>r`<img key=${s} class="login-montage-tile" style=${Js(n)}
    ...
    <form class="login-form" onSubmit=${l}>
      ...
      <label class="login-field">
        ...
        <input class="input" name="password" type="password" autocomplete="current-password" required
          value=${n} onInput=${m=>s(m.target.value)} />
      </label>
  ...
  </${pt}>`}function fn({route:e}){let t=!!e.invite,a=e.token?"form":"missing-token",[n,s]=g(""),[o,i]=g(!1),c=t;async function d(h){if(h.preventDefault(),o)return;i(!0),s("");let u=new FormData(h.currentTarget),f={reset_token:e.token,new_password:String(u.get("new_password")||"")};c&&(f.username=String(u.get("username")||""),f.display_name=pn(u.get("display_name")),f.email=pn(u.get("email")));try{await k("/api/v1/auth/reset-password",{method:"POST",body:f}),v(c?"Account created. Sign in with your new password.":"Password set. Sign in with your new password."),W("/login")}catch(b){s(b instanceof Te?b.message:"Request failed"),i(!1)}}return r`<${pt} titleId="reset-title">
  ...
  </${pt}>`}le();function Fe({label:e,value:t,sub:a,meter:n,tone:s}){let o=s?` stat-${s}`:"";return r`<div class="stat-card">
    <p class="stat-label">${e}</p>
    <p class=${`stat-value${o}`}>${t}</p>
    ${a!=null&&r`<p class="stat-sub">${a}</p>`}
    ${n!=null&&r`<div class="stat-meter${o}">
      <span style=${`width:${Math.max(0,Math.min(1,n))*100}%`}></span>
    </div>`}
  </div>`}function Ys(e){let t=Number(e?.global_storage_warning_threshold_bytes||0);if(!t)return null;let a=Number(e?.total_storage_bytes||0);return Math.max(0,Math.min(1,a/t))}function Xs(e){if(!e?.global_storage_warning_threshold_bytes)return"Disabled";let t=F(e.global_storage_warning_threshold_bytes);return e.global_storage_warning?`At or above ${t}`:`Below ${t}`}function eo({deadJobs:e=[],failedUploads:t=[]}={}){let a=e.length+t.length;return{failedCount:a,healthy:a===0}}function ne(e,t){return r`<div><dt>${e}</dt><dd>${t??"Unknown"}</dd></div>`}function _n({overview:e,deadJobs:t,failedUploads:a}){let n=Ys(e),{failedCount:s,healthy:o}=eo({deadJobs:t,failedUploads:a}),i=e.global_storage_warning_threshold_bytes;return r`<div>
    <div class="stat-grid">
      ...
      <${Fe} label="Jobs" value=${o?"All healthy":String(s)}
    ...
    <label class="field"><span>Role</span>
      <select class="input" name="role">
        ${Ot(e).map(([o,i])=>r`<option value=${o}>${i}</option>`)}
      </select>
    </label>
    <button class="btn btn-primary" type="submit" disabled=${a}>${C("plus",{size:14})} Create user</button>
  </form>`}function ro({isOwner:e,smtpEnabled:t,onCreated:a}){let[n,s]=g(!1);async function o(i){if(i.preventDefault(),n)return;s(!0);let c=new FormData(i.currentTarget),d=i.submitter?.value==="email"?"email":"link";try{let l=await k("/api/v1/invites",{method:"POST",body:{role:String(c.get("role")||"user"),email:mt(c.get("email")),send_email:d==="email"}});v(d==="email"?"Invite sent.":"Invite link created."),a({...l,kind:"invite"})}catch(l){v(l.message)}finally{s(!1)}}return r`<form class="panel section" onSubmit=${o}>
    <h2>Invite link</h2>
    <label class="field"><span>Role</span>
      <select class="input" name="role">
  ...
  </form>`}function io({resetLink:e}){if(!e)return null;let t=e.kind==="invite"?"Invite":"Reset",a=e.username?` for ${e.username}`:"",n=async()=>{try{await navigator.clipboard.writeText(e.reset_url),v("Copied to clipboard.")}catch{v("Copy failed. Select and copy the URL manually.")}};return r`<div class="notice admin-reset-link">
    <div>
    ...
    <div class="admin-users-forms">
      <${oo} isOwner=${d} onCreated=${()=>{s(null),o()}} />
      <${ro} isOwner=${d} smtpEnabled=${l}
        onCreated=${f=>{s(f),o()}} />
    </div>
    <div class="panel admin-users-table">
      ...
      <div class="table-wrap">
        <table class="lib-table">
          ...
          <tbody>
            ${e.map(f=>r`<${po} key=${f.id} user=${f} currentUser=${a} settings=${t}
  ...
  </form>`}function mo(e){return`${(e/100).toFixed(e%100===0?0:1)}%`}function fo(e){switch(e){case"delete_and_retry":return"delete the failed upload and retry from a new session";case"retry":return"retry the current upload request";default:return""}}function _o({upload:e}){let t=Math.max(0,Math.min(1e4,Number(e.progress_basis_points||0))),a=fo(e.recovery_action);return r`<div class="job-item">
    ...
    <${Ht} title="Failed uploads" items=${e} emptyLabel="No failed uploads."
      renderItem=${n=>r`<${_o} key=${n.id} upload=${n} />`} />
    ...
    ${n.length===0?r`<p class="muted">Categories appear automatically when clips report a game name.</p>`:r`<div class="table-wrap"><table class="lib-table admin-category-table">
        ...
        <tbody>${n.map(s=>r`<tr key=${s.id}>
          <td>${s.icon_artwork_url?r`<img class="category-icon-thumb" src=${s.icon_artwork_url} alt="" loading="lazy" />`:r`<span class="category-artwork-empty">—</span>`}</td>
          <td><strong>${s.display_name}</strong></td>
          <td><div class="category-name-chips">${(s.reported_names||[]).map(o=>r`<code>${o.reported_name}</code>`)}</div></td>
          <td>${s.clip_count}</td>
          <td><span class=${`category-status ${s.steamgriddb_game_id?"is-matched":""}`}>${bo(s,e?.steamgriddb_configured)}</span></td>
          <td><a class="btn" href=${kn(s.id)}>${C("edit",{size:14})} Edit</a></td>
        </tr>`)}</tbody>
      </table></div>`}
  </section>`}function $o({slot:e,config:t,steamGameId:a,selected:n,active:s,results:o,busy:i,error:c,onToggle:d,onClear:l,onSelect:m}){return r`<section class=${`category-artwork-slot artwork-slot-${e}`}>
    <div class="category-artwork-slot-heading">
      ...
      <div class="actions">
        ...
        ${!s&&r`<button class="btn btn-small" type="button" aria-expanded="false" onClick=${d}>
          ${n?"Change artwork":"Choose artwork"}
        </button>`}
      </div>
    </div>
    ${n&&r`<img class="category-selected-artwork" src=${n.preview_url||wn(a,t.kind,n.id)} alt="" />`}
    ${s&&r`<div class="category-artwork-browser">
      ${i?r`<small class="muted">Loading artwork…</small>`:""}
      ${c&&r`<small class="field-error">${c}</small>`}
      ${!i&&!c&&o.length===0&&r`<small class="muted">No artwork found for this slot.</small>`}
      ${o.length>0&&r`<small class="muted">Scroll to browse. Click an image to select it.</small>`}
      <div class="category-artwork-grid">
        ${o.map(h=>r`<button type="button"
  ...
  </section>`}function vo({data:e,reload:t,editing:a,categories:n}){let[s,o]=g(a.display_name),[i,c]=g(a.display_name),[d,l]=g(a.steamgriddb_game_id||null),[m,h]=g(!1),[u,f]=g([]),[b,w]=g(!1),[P,R]=g(""),[S,D]=g(null),[O,I]=g([]),[U,q]=g(!1),[V,Y]=g(""),[A,G]=g({grid:a.grid_artwork_id?{id:a.grid_artwork_id,kind:"grid",preview_url:a.grid_artwork_url}:null,video:a.video_artwork_id?{id:a.video_artwork_id,kind:"hero",preview_url:a.video_artwork_url}:null,icon:a.icon_artwork_id?{id:a.icon_artwork_id,kind:"icon",preview_url:a.icon_artwork_url}:null}),[_e,me]=g(""),[se,we]=g(""),[ee,X]=g(!1),[ce,ue]=g(null),[te,ae]=g(!1),ke=Xe(()=>go(n,a.id,_e),[n,a.id,_e]),oe=n.find(p=>p.id===se)||null;E(()=>{if(!e?.steamgriddb_configured||!m||i.trim().length<2){f([]),w(!1),R("");return}let p=!1,$=i.trim();w(!0),R("");let M=setTimeout(async()=>{try{let L=await k(`/api/v1/admin/game-categories/steamgriddb/search?q=${encodeURIComponent($)}`);p||f(L||[])}catch(L){p||(f([]),R(L.message))}finally{p||w(!1)}},300);return()=>{p=!0,clearTimeout(M)}},[e?.steamgriddb_configured,m,i]),E(()=>{if(!d||!e?.steamgriddb_configured||!S){I([]),Y("");return}let p=yn[S].kind,$=!1;return q(!0),Y(""),k(`/api/v1/admin/game-categories/steamgriddb/games/${encodeURIComponent(d)}/artwork?kind=${encodeURIComponent(p)}`).then(M=>{$||I(M||[])}).catch(M=>{$||(I([]),Y(M.message))}).finally(()=>{$||q(!1)}),()=>{$=!0}},[e?.steamgriddb_configured,d,S]);function be(p){l(p.id),c(p.name),o(p.name),h(!1),f([]),D(null),I([]),G({grid:null,video:null,icon:null})}function xe(){l(null),G({grid:null,video:null,icon:null}),D(null),I([]),h(!0)}async function fe(p){if(p.preventDefault(),!(!a||ee)){X(!0);try{await k(`/api/v1/admin/game-categories/${encodeURIComponent(a.id)}`,{method:"PATCH",body:ho({displayName:s,steamGameId:d,selectedArtworks:A})}),v("Game category updated."),await t()}catch($){v($.message)}finally{X(!1)}}}async function y(){let p=ce;if(ue(null),!(!p||ee)){X(!0);try{await k(`/api/v1/admin/game-categories/${encodeURIComponent(p.category.id)}/reported-names/${encodeURIComponent(p.name.id)}/separate`,{method:"POST"}),v(`${p.name.reported_name} separated into its own category.`),await t()}catch($){v($.message),($.status===404||$.status===409)&&await t()}finally{X(!1)}}}async function H(){if(ae(!1),!(!a||!oe||ee)){X(!0);try{await k(`/api/v1/admin/game-categories/${encodeURIComponent(a.id)}/merge`,{method:"POST",body:{destination_category_id:oe.id}}),v(`${a.display_name} merged into ${oe.display_name}.`),await t(),W(kn(oe.id))}catch(p){v(p.message),(p.status===404||p.status===409)&&await t()}finally{X(!1)}}}return r`<div class="admin-categories-page">
    <form class="admin-card admin-category-editor" onSubmit=${fe}>
      ...
      <section class="category-settings-section">
        ...
        <label class="field"><span>Display name</span>
          <input class="input" maxlength="200" required value=${s}
      ...
      <section class="category-settings-section">
        ...
        <label class="field"><span>Destination</span>
          <select class="input" value=${se} onChange=${p=>we(p.target.value)}>
            <option value="">Select a category</option>
            ${ke.map(p=>r`<option value=${p.id}>${p.display_name} · ${(p.reported_names||[]).map($=>$.reported_name).join(", ")}</option>`)}
          </select>
        </label>
        <button class="btn btn-danger" type="button" disabled=${ee||!se}
  ...
  </div>`}var Sn=[["overview","server","Overview"],["users","users","Users"],["categories","film","Game categories"],["settings","sliders","Settings"],["jobs","alert","Jobs"]];function yo(e){return e?.role==="admin"||e?.role==="owner"}async function wo(e){let t={signal:e},[a,n,s,o,i,c,d]=await Promise.all([k("/api/v1/admin/overview",t),k("/api/v1/admin/settings",t),k("/api/v1/users",t),k("/api/v1/admin/game-categories",t),k("/api/v1/admin/uploads/failed?limit=50",t),k("/api/v1/admin/jobs/dead?limit=50",t),k("/api/v1/admin/jobs/recent-errors?limit=50",t)]);return{overview:a,settings:n,users:s,categories:o,failedUploads:i,deadJobs:c,recentErrors:d}}function xn({route:e}){let{user:t}=j(N),a=yo(t),n=!!(t&&!a),s=Sn.some(([u])=>u===e.tab)?e.tab:"overview",[o,i]=g(null),[c,d]=g(0),{data:l,error:m}=Be(a?`admin:${c}`:null,wo),h=()=>d(u=>u+1);return E(()=>{n&&(v("Admin access required."),W("/library"))},[n]),a?r`<main class="page">
    <h1>Admin</h1>
    <p class="page-subtitle">Accounts, instance summary, and processing diagnostics.</p>
    <nav class="ad-tabs" aria-label="Admin views">
      ${Sn.map(([u,f,b])=>r`<a key=${u} class=${`ad-tab ${u===s?"ad-tab-on":""}`}
        href=${u==="categories"?"/admin/game-categories":`/admin?tab=${u}`}
        aria-current=${u===s?"page":void 0}>${C(f,{size:14})} ${b}</a>`)}
    </nav>
    ${m?r`<${Q} name="alert" title="Couldn't load admin data" body=${m.message} />`:l?s==="users"?r`<${hn} users=${l.users} settings=${l.settings} currentUser=${t}
          resetLink=${o} setResetLink=${i} reload=${h} />`:s==="settings"?r`<${gn} settings=${l.settings} isOwner=${t?.role==="owner"} reload=${h} />`:s==="categories"?r`<${Cn} data=${l.categories} reload=${h} categoryId=${e.categoryId} />`:s==="jobs"?r`<${vn} failedUploads=${l.failedUploads} deadJobs=${l.deadJobs} recentErrors=${l.recentErrors} />`:r`<${_n} overview=${l.overview} deadJobs=${l.deadJobs} failedUploads=${l.failedUploads} />`:r`<p class="empty-state">Loading admin data…</p>`}
  </main>`:null}le();function Tn(e){let t=String(e||"").trim();return t||null}async function ko(e){let t=new Headers;t.set("Accept","application/json"),t.set("Content-Type",e.type||"application/octet-stream");let a=Mt();a&&t.set("X-CSRF-Token",a);let n=await fetch("/api/v1/me/avatar",{method:"PUT",credentials:"same-origin",headers:t,body:e}),s=await n.json().catch(()=>({}));if(!n.ok)throw new Error(s.error||n.statusText||"Avatar upload failed");return s}function Pn(e){N.set({...N.get(),user:e})}function Co({user:e}){let[t,a]=g(!1);async function n(s){if(s.preventDefault(),t)return;a(!0);let o=new FormData(s.currentTarget);try{let i=await k("/api/v1/me/profile",{method:"PATCH",body:{display_name:Tn(o.get("display_name")),bio:Tn(o.get("bio"))}});Pn(i),v("Profile saved.")}catch(i){v(i.message)}finally{a(!1)}}return r`<form class="profile-form" onSubmit=${n}>
    <label class="field"><span>Display name</span>
  ...
  </form>`}function So({user:e}){let[t,a]=g(!1);async function n(s){if(s.preventDefault(),t)return;let o=s.currentTarget.elements.avatar?.files?.[0];if(!o){v("Choose an avatar image first.");return}a(!0);try{let i=await ko(o);Pn(i),v("Avatar uploaded.")}catch(i){v(i.message)}finally{a(!1)}}return r`<form class="profile-form" onSubmit=${n}>
  ...
  </main>`:null}le();async function xo(e){let t={signal:e},[a,n]=await Promise.all([k("/api/v1/auth/sessions",t),k("/api/v1/auth/device-tokens",t)]);return{sessions:a,deviceTokens:n}}function To({item:e,onRevoke:t}){return r`<div class="management-item">
    <div>
  ...
  </div>`}function Po({item:e,onRevoke:t}){let a=!!e.revoked_at;return r`<div class="management-item">
    <div>
    ...
    ${a?r`<div class="account-grid">
          <div class="panel">
            ...
            ${a.sessions.length?r`<div class="management-list">${a.sessions.map(d=>r`<${To} key=${d.id} item=${d}
          ...
          <div class="panel">
            ...
            ${a.deviceTokens.length?r`<div class="management-list">${a.deviceTokens.map(d=>r`<${Po} key=${d.id} item=${d}
  ...
  </main>`}function En({route:e}){let{user:t}=j(N),a=`/api/v1/public/users/${encodeURIComponent(e.username)}`,{data:n,error:s}=ie(a);if(s)return r`<main class="page"><${Q} name="alert" title="Profile unavailable" body=${s.message} /></main>`;if(!n)return r`<main class="page"><p class="empty-state">Loading profile…</p></main>`;let o=t&&t.username.toLowerCase()===n.username.toLowerCase(),i=n.clips||[];return r`<main class="page">
    <header class="public-user-header">
      ...
      <div class="public-user-header-body">
        <div class="public-user-title-row">
          ...
          ${o&&r`<a class="btn" href="/profile">${C("edit",{size:14})} Edit profile</a>`}
        </div>
  ...
  </main>`}var Mo={publicLibrary:Nt,publicGame:Nt,games:Ga,library:Qa,clip:zt,public:zt,login:mn,resetPassword:fn,admin:xn,profile:Mn,account:Rn,publicUser:En,about:Dn},In=Ne(window.location.pathname,window.location.search).name;function Ro(){let e=Ia();In=e.name;let{ready:t,user:a}=j(N),n=t&&Ea(e.name,a);if(E(()=>{n&&W("/login")},[n]),!t||n)return r`<div class="boot">Loading…</div>`;let s=Mo[e.name],o=e.name==="login"||e.name==="resetPassword";return r`<div class="ui" onClick=${Aa}>
    ${!o&&r`<${Na} active=${Et(e)} route=${e} />`}
    <${s} route=${e} />
    ${!o&&r`<${Ba} active=${Ua(e)} />`}
    <${za} />
  </div>`}window.addEventListener("clipline:unauthorized",()=>{$e(null),N.set({user:null,csrfToken:null,ready:!0}),Rt(In)||W("/login")});(async()=>{try{let t=await k("/api/v1/auth/me");$e(t.csrf_token),N.set({user:t.user,csrfToken:t.csrf_token,ready:!0})}catch{$e(null),N.set({user:null,csrfToken:null,ready:!0})}let e=document.querySelector("#app");e.textContent="",da(r`<${Ro} />`,e)})();
