var xa=Object.defineProperty;var Ca=(e,t)=>()=>(e&&(t=e(e=0)),t);var Ta=(e,t)=>{for(var n in t)xa(e,n,{get:t[n],enumerable:!0})};var yn={};Ta(yn,{ApiError:()=>_e,api:()=>y,getCsrfToken:()=>kt,setCsrfToken:()=>de});function de(e){Ke=e}function kt(){return Ke}async function y(e,t={}){let n=(t.method||"GET").toUpperCase(),a=new Headers(t.headers||{});a.set("Accept","application/json");let r=t.body;r&&typeof r!="string"&&(a.set("Content-Type","application/json"),r=JSON.stringify(r)),!["GET","HEAD","OPTIONS"].includes(n)&&Ke&&a.set("X-CSRF-Token",Ke);let s=await fetch(e,{...t,body:r,credentials:"same-origin",headers:a,method:n}),c=(s.headers.get("content-type")||"").includes("application/json")?await s.json():await s.text();if(!s.ok){s.status===401&&window.dispatchEvent(new CustomEvent("clipline:unauthorized"));let d=typeof c=="object"&&c?.error?c.error:s.statusText;throw new _e(d||"Request failed",s.status)}return c}var Ke,_e,Q=Ca(()=>{Ke=null;_e=class extends Error{constructor(t,n){super(t),this.status=n}}});var Ve,N,Kt,Ma,fe,Vt,Wt,jt,dt,Ae,Me,Zt,ft,pt,mt,Pa,ze={},Be=[],Ea=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,He=Array.isArray;function ue(e,t){for(var n in t)e[n]=t[n];return e}function _t(e){e&&e.parentNode&&e.parentNode.removeChild(e)}function ht(e,t,n){var a,r,s,i={};for(s in t)s=="key"?a=t[s]:s=="ref"?r=t[s]:i[s]=t[s];if(arguments.length>2&&(i.children=arguments.length>3?Ve.call(arguments,2):n),typeof e=="function"&&e.defaultProps!=null)for(s in e.defaultProps)i[s]===void 0&&(i[s]=e.defaultProps[s]);return Ne(e,i,a,r,null)}function Ne(e,t,n,a,r){var s={type:e,props:t,key:n,ref:a,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:r??++Kt,__i:-1,__u:0};return r==null&&N.vnode!=null&&N.vnode(s),s}function qe(e){return e.children}function Fe(e,t){this.props=e,this.context=t}function Se(e,t){if(t==null)return e.__?Se(e.__,e.__i+1):null;for(var n;t<e.__k.length;t++)if((n=e.__k[t])!=null&&n.__e!=null)return n.__e;return typeof e.type=="function"?Se(e):null}function Ra(e){if(e.__P&&e.__d){var t=e.__v,n=t.__e,a=[],r=[],s=ue({},t);s.__v=t.__v+1,N.vnode&&N.vnode(s),bt(e.__P,s,t,e.__n,e.__P.namespaceURI,32&t.__u?[n]:null,a,n??Se(t),!!(32&t.__u),r),s.__v=t.__v,s.__.__k[s.__i]=s,en(a,s,r),t.__e=t.__=null,s.__e!=n&&Jt(s)}}function Jt(e){if((e=e.__)!=null&&e.__c!=null)return e.__e=e.__c.base=null,e.__k.some(function(t){if(t!=null&&t.__e!=null)return e.__e=e.__c.base=t.__e}),Jt(e)}function Ht(e){(!e.__d&&(e.__d=!0)&&fe.push(e)&&!Oe.__r++||Vt!=N.debounceRendering)&&((Vt=N.debounceRendering)||Wt)(Oe)}function Oe(){try{for(var e,t=1;fe.length;)fe.length>t&&fe.sort(jt),e=fe.shift(),t=fe.length,Ra(e)}finally{fe.length=Oe.__r=0}}function Yt(e,t,n,a,r,s,i,c,d,u,p){var b,l,f,m,w,x,C,g=a&&a.__k||Be,R=t.length;for(d=Da(n,t,g,d,R),b=0;b<R;b++)(f=n.__k[b])!=null&&(l=f.__i!=-1&&g[f.__i]||ze,f.__i=b,x=bt(e,f,l,r,s,i,c,d,u,p),m=f.__e,f.ref&&l.ref!=f.ref&&(l.ref&&vt(l.ref,null,f),p.push(f.ref,f.__c||m,f)),w==null&&m!=null&&(w=m),(C=!!(4&f.__u))||l.__k===f.__k?(d=Xt(f,d,e,C),C&&l.__e&&(l.__e=null)):typeof f.type=="function"&&x!==void 0?d=x:m&&(d=m.nextSibling),f.__u&=-7);return n.__e=w,d}function Da(e,t,n,a,r){var s,i,c,d,u,p=n.length,b=p,l=0;for(e.__k=new Array(r),s=0;s<r;s++)(i=t[s])!=null&&typeof i!="boolean"&&typeof i!="function"?(typeof i=="string"||typeof i=="number"||typeof i=="bigint"||i.constructor==String?i=e.__k[s]=Ne(null,i,null,null,null):He(i)?i=e.__k[s]=Ne(qe,{children:i},null,null,null):i.constructor===void 0&&i.__b>0?i=e.__k[s]=Ne(i.type,i.props,i.key,i.ref?i.ref:null,i.__v):e.__k[s]=i,d=s+l,i.__=e,i.__b=e.__b+1,c=null,(u=i.__i=Ua(i,n,d,b))!=-1&&(b--,(c=n[u])&&(c.__u|=2)),c==null||c.__v==null?(u==-1&&(r>p?l--:r<p&&l++),typeof i.type!="function"&&(i.__u|=4)):u!=d&&(u==d-1?l--:u==d+1?l++:(u>d?l--:l++,i.__u|=4))):e.__k[s]=null;if(b)for(s=0;s<p;s++)(c=n[s])!=null&&(2&c.__u)==0&&(c.__e==a&&(a=Se(c)),nn(c,c));return a}function Xt(e,t,n,a){var r,s;if(typeof e.type=="function"){for(r=e.__k,s=0;r&&s<r.length;s++)r[s]&&(r[s].__=e,t=Xt(r[s],t,n,a));return t}e.__e!=t&&(a&&(t&&e.type&&!t.parentNode&&(t=Se(e)),n.insertBefore(e.__e,t||null)),t=e.__e);do t=t&&t.nextSibling;while(t!=null&&t.nodeType==8);return t}function Ua(e,t,n,a){var r,s,i,c=e.key,d=e.type,u=t[n],p=u!=null&&(2&u.__u)==0;if(u===null&&c==null||p&&c==u.key&&d==u.type)return n;if(a>(p?1:0)){for(r=n-1,s=n+1;r>=0||s<t.length;)if((u=t[i=r>=0?r--:s++])!=null&&(2&u.__u)==0&&c==u.key&&d==u.type)return i}return-1}function qt(e,t,n){t[0]=="-"?e.setProperty(t,n??""):e[t]=n==null?"":typeof n!="number"||Ea.test(t)?n:n+"px"}function Ie(e,t,n,a,r){var s,i;e:if(t=="style")if(typeof n=="string")e.style.cssText=n;else{if(typeof a=="string"&&(e.style.cssText=a=""),a)for(t in a)n&&t in n||qt(e.style,t,"");if(n)for(t in n)a&&n[t]==a[t]||qt(e.style,t,n[t])}else if(t[0]=="o"&&t[1]=="n")s=t!=(t=t.replace(Zt,"$1")),i=t.toLowerCase(),t=i in e||t=="onFocusOut"||t=="onFocusIn"?i.slice(2):t.slice(2),e.l||(e.l={}),e.l[t+s]=n,n?a?n[Me]=a[Me]:(n[Me]=ft,e.addEventListener(t,s?mt:pt,s)):e.removeEventListener(t,s?mt:pt,s);else{if(r=="http://www.w3.org/2000/svg")t=t.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(t!="width"&&t!="height"&&t!="href"&&t!="list"&&t!="form"&&t!="tabIndex"&&t!="download"&&t!="rowSpan"&&t!="colSpan"&&t!="role"&&t!="popover"&&t in e)try{e[t]=n??"";break e}catch{}typeof n=="function"||(n==null||n===!1&&t[4]!="-"?e.removeAttribute(t):e.setAttribute(t,t=="popover"&&n==1?"":n))}}function Gt(e){return function(t){if(this.l){var n=this.l[t.type+e];if(t[Ae]==null)t[Ae]=ft++;else if(t[Ae]<n[Me])return;return n(N.event?N.event(t):t)}}}function bt(e,t,n,a,r,s,i,c,d,u){var p,b,l,f,m,w,x,C,g,R,j,J,Z,re,O,te,L=t.type;if(t.constructor!==void 0)return null;128&n.__u&&(d=!!(32&n.__u),s=[c=t.__e=n.__e]),(p=N.__b)&&p(t);e:if(typeof L=="function"){b=i.length;try{if(g=t.props,R=L.prototype&&L.prototype.render,j=(p=L.contextType)&&a[p.__c],J=p?j?j.props.value:p.__:a,n.__c?C=(l=t.__c=n.__c).__=l.__E:(R?t.__c=l=new L(g,J):(t.__c=l=new Fe(g,J),l.constructor=L,l.render=Ia),j&&j.sub(l),l.state||(l.state={}),l.__n=a,f=l.__d=!0,l.__h=[],l._sb=[]),R&&l.__s==null&&(l.__s=l.state),R&&L.getDerivedStateFromProps!=null&&(l.__s==l.state&&(l.__s=ue({},l.__s)),ue(l.__s,L.getDerivedStateFromProps(g,l.__s))),m=l.props,w=l.state,l.__v=t,f)R&&L.getDerivedStateFromProps==null&&l.componentWillMount!=null&&l.componentWillMount(),R&&l.componentDidMount!=null&&l.__h.push(l.componentDidMount);else{if(R&&L.getDerivedStateFromProps==null&&g!==m&&l.componentWillReceiveProps!=null&&l.componentWillReceiveProps(g,J),t.__v==n.__v||!l.__e&&l.shouldComponentUpdate!=null&&l.shouldComponentUpdate(g,l.__s,J)===!1){t.__v!=n.__v&&(l.props=g,l.state=l.__s,l.__d=!1),t.__e=n.__e,t.__k=n.__k,t.__k.some(function(Y){Y&&(Y.__=t)}),Be.push.apply(l.__h,l._sb),l._sb=[],l.__h.length&&i.push(l);break e}l.componentWillUpdate!=null&&l.componentWillUpdate(g,l.__s,J),R&&l.componentDidUpdate!=null&&l.__h.push(function(){l.componentDidUpdate(m,w,x)})}if(l.context=J,l.props=g,l.__P=e,l.__e=!1,Z=N.__r,re=0,R)l.state=l.__s,l.__d=!1,Z&&Z(t),p=l.render(l.props,l.state,l.context),Be.push.apply(l.__h,l._sb),l._sb=[];else do l.__d=!1,Z&&Z(t),p=l.render(l.props,l.state,l.context),l.state=l.__s;while(l.__d&&++re<25);l.state=l.__s,l.getChildContext!=null&&(a=ue(ue({},a),l.getChildContext())),R&&!f&&l.getSnapshotBeforeUpdate!=null&&(x=l.getSnapshotBeforeUpdate(m,w)),O=p!=null&&p.type===qe&&p.key==null?tn(p.props.children):p,c=Yt(e,He(O)?O:[O],t,n,a,r,s,i,c,d,u),l.base=t.__e,t.__u&=-161,l.__h.length&&i.push(l),C&&(l.__E=l.__=null)}catch(Y){if(i.length=b,t.__v=null,d||s!=null){if(Y.then){for(t.__u|=d?160:128;c&&c.nodeType==8&&c.nextSibling;)c=c.nextSibling;s!=null&&(s[s.indexOf(c)]=null),t.__e=c}else if(s!=null)for(te=s.length;te--;)_t(s[te])}else t.__e=n.__e;t.__k==null&&(t.__k=n.__k||[]),Y.then||Qt(t),N.__e(Y,t,n)}}else s==null&&t.__v==n.__v?(t.__k=n.__k,t.__e=n.__e):c=t.__e=La(n.__e,t,n,a,r,s,i,d,u);return(p=N.diffed)&&p(t),128&t.__u?void 0:c}function Qt(e){e&&(e.__c&&(e.__c.__e=!0),e.__k&&e.__k.some(Qt))}function en(e,t,n){for(var a=0;a<n.length;a++)vt(n[a],n[++a],n[++a]);N.__c&&N.__c(t,e),e.some(function(r){try{e=r.__h,r.__h=[],e.some(function(s){s.call(r)})}catch(s){N.__e(s,r.__v)}})}function tn(e){return typeof e!="object"||e==null||e.__b>0?e:He(e)?e.map(tn):e.constructor!==void 0?null:ue({},e)}function La(e,t,n,a,r,s,i,c,d){var u,p,b,l,f,m,w,x=n.props||ze,C=t.props,g=t.type;if(g=="svg"?r="http://www.w3.org/2000/svg":g=="math"?r="http://www.w3.org/1998/Math/MathML":r||(r="http://www.w3.org/1999/xhtml"),s!=null){for(u=0;u<s.length;u++)if((f=s[u])&&"setAttribute"in f==!!g&&(g?f.localName==g:f.nodeType==3)){e=f,s[u]=null;break}}if(e==null){if(g==null)return document.createTextNode(C);e=document.createElementNS(r,g,C.is&&C),c&&(N.__m&&N.__m(t,s),c=!1),s=null}if(g==null)x===C||c&&e.data==C||(e.data=C);else{if(s=g=="textarea"&&C.defaultValue!=null?null:s&&Ve.call(e.childNodes),!c&&s!=null)for(x={},u=0;u<e.attributes.length;u++)x[(f=e.attributes[u]).name]=f.value;for(u in x)f=x[u],u=="dangerouslySetInnerHTML"?b=f:u=="children"||u in C||u=="value"&&"defaultValue"in C||u=="checked"&&"defaultChecked"in C||Ie(e,u,null,f,r);for(u in C)f=C[u],u=="children"?l=f:u=="dangerouslySetInnerHTML"?p=f:u=="value"?m=f:u=="checked"?w=f:c&&typeof f!="function"||x[u]===f||Ie(e,u,f,x[u],r);if(p)c||b&&(p.__html==b.__html||p.__html==e.innerHTML)||(e.innerHTML=p.__html),t.__k=[];else if(b&&(e.innerHTML=""),Yt(t.type=="template"?e.content:e,He(l)?l:[l],t,n,a,g=="foreignObject"?"http://www.w3.org/1999/xhtml":r,s,i,s?s[0]:n.__k&&Se(n,0),c,d),s!=null)for(u=s.length;u--;)_t(s[u]);c&&g!="textarea"||(u="value",g=="progress"&&m==null?e.removeAttribute("value"):m!=null&&(m!==e[u]||g=="progress"&&!m||g=="option"&&m!=x[u])&&Ie(e,u,m,x[u],r),u="checked",w!=null&&w!=e[u]&&Ie(e,u,w,x[u],r))}return e}function vt(e,t,n){try{if(typeof e=="function"){var a=typeof e.__u=="function";a&&e.__u(),a&&t==null||(e.__u=e(t))}else e.current=t}catch(r){N.__e(r,n)}}function nn(e,t,n){var a,r;if(N.unmount&&N.unmount(e),(a=e.ref)&&(a.current&&a.current!=e.__e||vt(a,null,t)),(a=e.__c)!=null){if(a.componentWillUnmount)try{a.componentWillUnmount()}catch(s){N.__e(s,t)}a.base=a.__P=a.__n=null}if(a=e.__k)for(r=0;r<a.length;r++)a[r]&&nn(a[r],t,n||typeof e.type!="function");n||_t(e.__e),e.__c=e.__=e.__e=void 0}function Ia(e,t,n){return this.constructor(e,n)}function an(e,t,n){var a,r,s,i;t==document&&(t=document.documentElement),N.__&&N.__(e,t),r=(a=typeof n=="function")?null:n&&n.__k||t.__k,s=[],i=[],bt(t,e=(!a&&n||t).__k=ht(qe,null,[e]),r||ze,ze,t.namespaceURI,!a&&n?[n]:r?null:t.firstChild?Ve.call(t.childNodes):null,s,!a&&n?n:r?r.__e:t.firstChild,a,i),en(s,e,i),e.props.children=null}Ve=Be.slice,N={__e:function(e,t,n,a){for(var r,s,i;t=t.__;)if((r=t.__c)&&!r.__)try{if((s=r.constructor)&&s.getDerivedStateFromError!=null&&(r.setState(s.getDerivedStateFromError(e)),i=r.__d),r.componentDidCatch!=null&&(r.componentDidCatch(e,a||{}),i=r.__d),i)return r.__E=r}catch(c){e=c}throw e}},Kt=0,Ma=function(e){return e!=null&&e.constructor===void 0},Fe.prototype.setState=function(e,t){var n;n=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=ue({},this.state),typeof e=="function"&&(e=e(ue({},n),this.props)),e&&ue(n,e),e!=null&&this.__v&&(t&&this._sb.push(t),Ht(this))},Fe.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),Ht(this))},Fe.prototype.render=qe,fe=[],Wt=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,jt=function(e,t){return e.__v.__b-t.__v.__b},Oe.__r=0,dt=Math.random().toString(8),Ae="__d"+dt,Me="__a"+dt,Zt=/(PointerCapture)$|Capture$/i,ft=0,pt=Gt(!1),mt=Gt(!0),Pa=0;var Pe,B,$t,sn,Ge=0,fn=[],V=N,rn=V.__b,on=V.__r,ln=V.diffed,cn=V.__c,un=V.unmount,dn=V.__;function yt(e,t){V.__h&&V.__h(B,e,Ge||t),Ge=0;var n=B.__H||(B.__H={__:[],__h:[]});return e>=n.__.length&&n.__.push({}),n.__[e]}function h(e){return Ge=1,Aa(bn,e)}function Aa(e,t,n){var a=yt(Pe++,2);if(a.t=e,!a.__c&&(a.__=[n?n(t):bn(void 0,t),function(c){var d=a.__N?a.__N[0]:a.__[0],u=a.t(d,c);d!==u&&(a.__N=[u,a.__[1]],a.__c.setState({}))}],a.__c=B,!B.__f)){var r=function(c,d,u){if(!a.__c.__H)return!0;var p=!1,b=a.__c.props!==c;if(a.__c.__H.__.some(function(f){if(f.__N){p=!0;var m=f.__[0];f.__=f.__N,f.__N=void 0,m!==f.__[0]&&(b=!0)}}),s){var l=s.call(this,c,d,u);return p?l||b:l}return!p||b};B.__f=!0;var s=B.shouldComponentUpdate,i=B.componentWillUpdate;B.componentWillUpdate=function(c,d,u){if(this.__e){var p=s;s=void 0,r(c,d,u),s=p}i&&i.call(this,c,d,u)},B.shouldComponentUpdate=r}return a.__N||a.__}function S(e,t){var n=yt(Pe++,3);!V.__s&&hn(n.__H,t)&&(n.__=e,n.u=t,B.__H.__h.push(n))}function z(e){return Ge=5,Na(function(){return{current:e}},[])}function Na(e,t){var n=yt(Pe++,7);return hn(n.__H,t)&&(n.__=e(),n.__H=t,n.__h=e),n.__}function pn(){for(var e;e=fn.shift();){var t=e.__H;if(e.__P&&t)try{t.__h.some(gt),t.__h.some(_n),t.__h=[]}catch(n){t.__h=[],V.__e(n,e.__v)}}}V.__b=function(e){B=null,rn&&rn(e)},V.__=function(e,t){e&&t.__k&&t.__k.__m&&(e.__m=t.__k.__m),dn&&dn(e,t)},V.__r=function(e){on&&on(e),Pe=0;var t=(B=e.__c).__H;t&&($t===B?(t.__h=[],B.__h=[],t.__.some(function(n){n.__N&&(n.__=n.__N),n.u=n.__N=void 0})):(t.__h.length&&pn(),Pe=0)),$t=B},V.diffed=function(e){ln&&ln(e);var t=e.__c;t&&t.__H&&(t.__H.__h.length&&(fn.push(t)!==1&&sn===V.requestAnimationFrame||((sn=V.requestAnimationFrame)||Fa)(pn)),t.__H.__.some(function(n){n.u&&(n.__H=n.u,n.u=void 0)})),$t=B=null},V.__c=function(e,t){t.some(function(n){try{n.__h.some(gt),n.__h=n.__h.filter(function(a){return!a.__||_n(a)})}catch(a){t.some(function(r){r.__h&&(r.__h=[])}),t=[],V.__e(a,n.__v)}}),cn&&cn(e,t)},V.unmount=function(e){un&&un(e);var t,n=e.__c;n&&n.__H&&(n.__H.__.some(function(a){try{gt(a)}catch(r){t=r}}),n.__H=void 0,t&&V.__e(t,n.__v))};var mn=typeof requestAnimationFrame=="function";function Fa(e){var t,n=function(){clearTimeout(a),mn&&cancelAnimationFrame(t),setTimeout(e)},a=setTimeout(n,35);mn&&(t=requestAnimationFrame(n))}function gt(e){var t=B,n=e.__c;typeof n=="function"&&(e.__c=void 0,n()),B=t}function _n(e){var t=B;e.__c=e.__(),B=t}function hn(e,t){return!e||e.length!==t.length||t.some(function(n,a){return n!==e[a]})}function bn(e,t){return typeof t=="function"?t(e):t}var $n=function(e,t,n,a){var r;t[0]=0;for(var s=1;s<t.length;s++){var i=t[s++],c=t[s]?(t[0]|=i?1:2,n[t[s++]]):t[++s];i===3?a[0]=c:i===4?a[1]=Object.assign(a[1]||{},c):i===5?(a[1]=a[1]||{})[t[++s]]=c:i===6?a[1][t[++s]]+=c+"":i?(r=e.apply(c,$n(e,c,n,["",null])),a.push(r),c[0]?t[0]|=2:(t[s-2]=0,t[s]=r)):a.push(c)}return a},vn=new Map;function gn(e){var t=vn.get(this);return t||(t=new Map,vn.set(this,t)),(t=$n(this,t.get(e)||(t.set(e,t=(function(n){for(var a,r,s=1,i="",c="",d=[0],u=function(l){s===1&&(l||(i=i.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?d.push(0,l,i):s===3&&(l||i)?(d.push(3,l,i),s=2):s===2&&i==="..."&&l?d.push(4,l,0):s===2&&i&&!l?d.push(5,0,!0,i):s>=5&&((i||!l&&s===5)&&(d.push(s,0,i,r),s=6),l&&(d.push(s,l,0,r),s=6)),i=""},p=0;p<n.length;p++){p&&(s===1&&u(),u(p));for(var b=0;b<n[p].length;b++)a=n[p][b],s===1?a==="<"?(u(),d=[d],s=3):i+=a:s===4?i==="--"&&a===">"?(s=1,i=""):i=a+i[0]:c?a===c?c="":i+=a:a==='"'||a==="'"?c=a:a===">"?(u(),s=1):s&&(a==="="?(s=5,r=i,i=""):a==="/"&&(s<5||n[p][b+1]===">")?(u(),s===3&&(d=d[0]),s=d,(d=d[0]).push(2,0,s),s=0):a===" "||a==="	"||a===`
`||a==="\r"?(u(),s=2):i+=a),s===3&&i==="!--"&&(s=4,d=d[0])}return u(),d})(e)),t),arguments,[])).length>1?t:t[0]}var o=gn.bind(ht);Q();function kn(e){let t=e,n=new Set;return{get:()=>t,set(a){t=a,n.forEach(r=>r(t))},update(a){this.set(a(t))},subscribe(a){return n.add(a),()=>n.delete(a)}}}function H(e){let[t,n]=h(e.get());return S(()=>e.subscribe(n),[e]),t}var A=kn({user:null,csrfToken:null,ready:!1}),We=kn([]),za=0;function k(e,{actionLabel:t,onAction:n,timeoutMs:a=5e3}={}){let r=++za;return We.update(s=>[...s,{id:r,message:e,actionLabel:t,onAction:n}]),a&&setTimeout(()=>je(r),a),r}function je(e){We.update(t=>t.filter(n=>n.id!==e))}function Ze(e){try{return decodeURIComponent(e)}catch{return e}}function wn(e){let t=Number(e.get("page")||1);return{sort:e.get("sort")||"uploaded_at_desc",game:e.get("game")||"",q:e.get("q")||"",page:Number.isFinite(t)?Math.max(1,t):1}}var Ba=["login","resetPassword","public","publicLibrary","publicGame","publicUser","about","games"];function wt(e){return Ba.includes(e)}function Sn(e,t){return!t&&!wt(e)}var Oa={publicLibrary:"feed",publicGame:"feed",games:"games",library:"library",clip:"library",admin:"admin",profile:"profile"};function St(e){return Oa[e?.name]||""}function xn(e){return e?.name==="publicLibrary"&&e.surface==="search"?"search":St(e)}function Je(e,t){let n=new URLSearchParams(t||""),a=e;return a.startsWith("/c/")?{name:"public",shareId:Ze(a.slice(3))}:a==="/"||a==="/public"||a==="/search"?{name:"publicLibrary",query:wn(n),surface:a==="/search"?"search":"feed"}:a.startsWith("/game/")?{name:"publicGame",game:Ze(a.slice(6)),query:wn(n)}:a==="/about"?{name:"about"}:a==="/games"?{name:"games"}:a.startsWith("/u/")?{name:"publicUser",username:Ze(a.slice(3))}:a==="/library"?{name:"library"}:a.startsWith("/clip/")?{name:"clip",clipId:Ze(a.slice(6))}:a==="/admin"?{name:"admin",tab:n.get("tab")||"overview"}:a==="/account"?{name:"account"}:a==="/profile"?{name:"profile"}:a==="/login"?{name:"login"}:a==="/reset-password"?{name:"resetPassword",token:n.get("token")||"",invite:n.get("invite")==="1"}:{name:"publicLibrary"}}function Cn(e){return Je(e.pathname,e.search).name}var xt=new Set;function G(e){window.history.pushState({},"",e),Tn()}function Tn(){let{pathname:e,search:t}=window.location,n=Je(e,t);xt.forEach(a=>a(n))}window.addEventListener("popstate",Tn);function Mn(){let[e,t]=h(()=>Je(window.location.pathname,window.location.search));return S(()=>(xt.add(t),()=>xt.delete(t)),[]),e}function Pn(e){let t=e.target.closest("a[href^='/']");!t||t.target||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),G(t.getAttribute("href")))}var En={alert:'<path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>',clipboard:'<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>',copy:'<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',external:'<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',edit:'<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/>',fastForward:'<path d="m13 19 9-7-9-7v14Z"/><path d="m2 19 9-7-9-7v14Z"/>',film:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M17 3v18"/><path d="M3 8h4"/><path d="M3 16h4"/><path d="M17 8h4"/><path d="M17 16h4"/>',fullscreen:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/>',home:'<path d="m3 10 9-7 9 7"/><path d="M5 8.5V20a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.5"/><path d="M9 22V12h6v10"/>',info:'<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',logOut:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/>',menu:'<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h16"/>',message:'<path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"/>',notepad:'<path d="M8 2v4"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M6 4h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><path d="M8 14h8"/><path d="M8 18h5"/>',pause:'<path d="M8 5v14"/><path d="M16 5v14"/>',play:'<path d="m8 5 11 7-11 7V5Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',refresh:'<path d="M21 12a9 9 0 0 1-15.5 6.3L3 16"/><path d="M3 21v-5h5"/><path d="M3 12A9 9 0 0 1 18.5 5.7L21 8"/><path d="M21 3v5h-5"/>',rewind:'<path d="m11 19-9-7 9-7v14Z"/><path d="m22 19-9-7 9-7v14Z"/>',save:'<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2Z"/><path d="M17 21v-8H7v8"/><path d="M7 3v5h8"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',server:'<rect width="20" height="8" x="2" y="2" rx="2"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 6h.01"/><path d="M6 18h.01"/>',skipBack:'<path d="M19 20 9 12l10-8v16Z"/><path d="M5 19V5"/>',skipForward:'<path d="m5 4 10 8-10 8V4Z"/><path d="M19 5v14"/>',shield:'<path d="M20 13c0 5-3.5 7.5-7.7 8.8a1 1 0 0 1-.6 0C7.5 20.5 4 18 4 13V5l8-3 8 3v8Z"/>',sliders:'<path d="M4 21v-7"/><path d="M4 10V3"/><path d="M12 21v-9"/><path d="M12 8V3"/><path d="M20 21v-5"/><path d="M20 12V3"/><path d="M2 14h4"/><path d="M10 8h4"/><path d="M18 16h4"/>',theater:'<rect width="20" height="14" x="2" y="5" rx="2"/><path d="M6 9h12"/><path d="M6 15h12"/>',trash:'<path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m17 8-5-5-5 5"/><path d="M12 3v12"/>',user:'<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.9"/><path d="M16 3.1a4 4 0 0 1 0 7.8"/>',volume2:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9 9 0 0 1 0 14"/>',volumeX:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>'};function M(e,{size:t=18}={}){return o`<svg viewBox="0 0 24 24" width=${t} height=${t} fill="none"
    stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"
    aria-hidden="true" dangerouslySetInnerHTML=${{__html:En[e]||""}} />`}function Va(e){return e?.query?.q||""}function Ha(e,t){let n=new URLSearchParams,a=String(t||"").trim(),r=e?.name==="publicGame"?e.game:e?.query?.game||"";a&&n.set("q",a),r&&n.set("game",r);let s=n.toString();return s?`/search?${s}`:"/search"}function Rn({active:e,route:t}){let{user:n}=H(A),[a,r]=h(!1),s=z(null),i=Va(t),[c,d]=h(i);S(()=>{d(i)},[i]);let u=n?.role==="admin"||n?.role==="owner";S(()=>{if(!a)return;let l=m=>{s.current?.contains(m.target)||r(!1)},f=m=>{m.key==="Escape"&&r(!1)};return document.addEventListener("pointerdown",l),document.addEventListener("keydown",f),()=>{document.removeEventListener("pointerdown",l),document.removeEventListener("keydown",f)}},[a]);let p=[["feed","/","Feed"],["library","/library","Library",!!n],["games","/games","Games"],["admin","/admin","Admin",u]].filter(([,,,l])=>l!==!1),b=l=>{l.preventDefault();let f=new FormData(l.target).get("q")?.toString()||"";G(Ha(t,f))};return o`<header class="topbar">
  ...
  </header>`}async function qa(){let{api:e,setCsrfToken:t}=await Promise.resolve().then(()=>(Q(),yn));try{await e("/api/v1/auth/logout",{method:"POST"})}catch{}t(null),A.set({user:null,csrfToken:null,ready:!0}),G("/login")}var Ga=[["feed","/","home","Feed",!0],["games","/games","globe","Games",!0],["library","/library","library","Library","auth"],["search","/search","search","Search",!0],["profile","/profile","user","Profile","auth"]];function Ka(e){return Ga.filter(([,,,,t])=>t!=="auth"||!!e)}function Dn({active:e}){let{user:t}=H(A),n=Ka(t);return o`<nav class="tabbar" aria-label="Primary">
    ${n.map(([a,r,s,i])=>o`
      <a class=${a===e?"tab-on":""} href=${r}>${M(s)}<span>${i}</span></a>`)}
  </nav>`}function Un(){let e=H(We);return o`<div class="toasts" role="status" aria-live="polite">
    ...
    ${n&&o`<p>${n}</p>`}
    ${a}
  </div>`}var ja=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],Za=6,Ja=60;function Ya(e){let t=new URLSearchParams;return t.set("page_size",String(Ja)),e.sort!=="uploaded_at_desc"&&t.set("sort",e.sort),e.game&&t.set("game",e.game),e.q&&t.set("q",e.q),Number(e.page)>1&&t.set("page",String(e.page)),t}function Nn(e){return e?.game_name||"No game"}function Xa(e,t,n=Za){let a=[...e||[]].sort((b,l)=>(l.clip_count||0)-(b.clip_count||0)),r=a.slice(0,n),s=String(t||"").trim(),i=s&&r.some(b=>b.game===s),c=s&&!i?a.find(b=>b.game===s)||{game:s,clip_count:0}:null,d=c?[c,...r]:r,u=new Set(d.map(b=>b.game)),p=a.filter(b=>!u.has(b.game)).length;return{chips:d,extraGameCount:p}}function et({route:e}){let t={sort:"uploaded_at_desc",page:1,q:"",...e.query,game:e.name==="publicGame"?e.game:e.query?.game||""},[n,a]=h(null),[r,s]=h([]),[i,c]=h(null);S(()=>{let m=!0;a(null),c(null);let w=Ya(t);return y(`/api/v1/public/clips?${w}`).then(x=>m&&a(x)).catch(x=>m&&c(x)),()=>{m=!1}},[e.name,t.sort,t.game,t.q,t.page]),S(()=>{let m=!0;return y("/api/v1/public/games").then(w=>m&&s(w.games||[])).catch(()=>{}),()=>{m=!1}},[]);let d=m=>G(ts({...t,page:1,...m}));if(i)return o`<main class="page">
      <${W} name="alert" title="Couldn't load the feed" body=${i.message} />
    </main>`;let u=n?.clips,p=!!(t.game||t.q)||Number(t.page)>1,b=!p,{chips:l,extraGameCount:f}=Xa(r,t.game);return o`<main class="page">
    ${u==null?o`<${es} />`:u.length===0?o`<${W} name="film"
        ...
        <div class="card-grid">
          ${(b?u.slice(4):u).map(m=>o`<${Ce} clip=${{...m,thumbnail_url:se(m),media_url:xe(m)}}
              href=${Tt(m)} showAuthor />`)}
        </div>
        ${ns(n,t,d)}
      `}
  </main>`}function Qa(e){let[t,...n]=e,a=n.slice(0,3);return o`<p class="kicker">Now playing on this server</p>
    <section class="hero">
      ...
      <div class="hero-side">
        ${a.map(r=>o`<a class="hero-row" href=${Tt(r)}>
            <img src=${se(r)} alt="" loading="lazy" />
            <span><b>${r.title}</b>
              <small>${Ct(r)} · ${Nn(r)} · ${ye(r.view_count)}</small></span>
          </a>`)}
      </div>
    </section>`}function es({count:e=8}){return o`<div class="card-grid">
    ${Array.from({length:e},(t,n)=>o`<div class="clip-card" key=${n}>
      <div class="skeleton-thumb"></div>
      <div class="skeleton-line"></div>
      <div class="skeleton-line is-short"></div>
    </div>`)}
  </div>`}function Tt(e){return`/c/${encodeURIComponent(e.share_id)}`}function ts({sort:e="uploaded_at_desc",game:t="",q:n="",page:a=1}={}){let r=new URLSearchParams,s=e||"uploaded_at_desc",i=String(t||"").trim(),c=String(n||"").trim(),d=Math.max(1,Number(a||1));if(s!=="uploaded_at_desc"&&r.set("sort",s),d>1&&r.set("page",String(d)),c)return r.set("q",c),i&&r.set("game",i),`/search?${r.toString()}`;if(i){let p=r.toString();return`/game/${encodeURIComponent(i)}${p?`?${p}`:""}`}let u=r.toString();return u?`/search?${u}`:"/"}function ns(e,t,n){let a=Math.max(1,Number(t.page||1)),r=!!e?.has_more;return a<=1&&!r?"":o`<nav class="pager" aria-label="Public clip pages">
  ...
  </nav>`}Q();function Fn(){let[e,t]=h(null),[n,a]=h(null);return S(()=>{let r=!0;return y("/api/v1/public/games").then(s=>r&&t(s.games||[])).catch(s=>r&&a(s)),()=>{r=!1}},[]),n?o`<main class="page">
  ...
  </main>`}Q();function zn({trigger:e,content:t,onClose:n,label:a,panelClass:r=""}){let[s,i]=h(!1),c=z(null),d=z(null),u=z(null),p=()=>{i(!1),n?.()},b=()=>{if(s){p();return}u.current=document.activeElement,i(!0)};return S(()=>{if(!s)return;let l=w=>{c.current?.contains(w.target)||p()},f=w=>{w.key==="Escape"&&p()};return document.addEventListener("pointerdown",l),document.addEventListener("keydown",f),d.current?.querySelector("input, select, textarea, button, a[href], [tabindex]")?.focus(),()=>{document.removeEventListener("pointerdown",l),document.removeEventListener("keydown",f),u.current?.focus?.()}},[s]),o`<div class="popover-wrap" ref=${c}>
    ${e({open:s,toggle:b})}
  ...
  </dialog>`}var Hn="clipline.libraryView",as=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["updated_at_desc","Updated newest"],["updated_at_asc","Updated oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["size_desc","Size largest"],["size_asc","Size smallest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],tt={title:["title_asc","title_desc"],size:["size_asc","size_desc"],duration:["duration_asc","duration_desc"],uploaded:["uploaded_at_asc","uploaded_at_desc"]},ss=["visibility","status","source_type","from","to","min_duration_seconds","max_duration_seconds","min_size_mib","max_size_mib"],st={sort:"uploaded_at_desc",game:"",source_type:"",visibility:"",status:"",q:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""};function nt(e){if(e===""||e==null)return null;let t=Number(e);return Number.isFinite(t)?t:null}function rs(e){let t=new URLSearchParams;t.set("sort",e.sort||st.sort),t.set("page_size","100");for(let i of["game","source_type","visibility","status","q"])e[i]&&t.set(i,e[i]);e.from&&t.set("from",`${e.from}T00:00:00Z`),e.to&&t.set("to",`${e.to}T23:59:59Z`);let n=nt(e.min_duration_seconds);n!=null&&t.set("min_duration_ms",String(Math.round(n*1e3)));let a=nt(e.max_duration_seconds);a!=null&&t.set("max_duration_ms",String(Math.round(a*1e3)));let r=nt(e.min_size_mib);r!=null&&t.set("min_size_bytes",String(Math.round(r*1024*1024)));let s=nt(e.max_size_mib);return s!=null&&t.set("max_size_bytes",String(Math.round(s*1024*1024))),t}function os(e){return ss.reduce((t,n)=>t+(e[n]?1:0),0)}function is(e,t=6){let n=new Map;for(let a of e){let r=a.game_name;r&&n.set(r,(n.get(r)||0)+1)}return Array.from(n,([a,r])=>({game:a,count:r})).sort((a,r)=>r.count-a.count||a.game.localeCompare(r.game)).slice(0,t)}function On(e,t,{verb:n,allFailedMessage:a}){let r=e.filter(i=>!t.some(c=>c.id===i));if(!t.length)return{succeeded:r,message:null};let s=t.length===e.length?t[0]?.message||a:`Couldn't ${n} ${t.length} of ${e.length} clips.`;return{succeeded:r,message:s}}function ls(e,t){return(e||[]).map(n=>Re(n.public_url,t,n.public_share_id)).filter(Boolean)}async function Vn(e,t,n){let a=0;async function r(){let s=a++;if(!(s>=e.length))return await n(e[s]),r()}await Promise.all(Array.from({length:Math.min(t,e.length)},r))}function cs(){try{return localStorage.getItem(Hn)==="rows"?"rows":"grid"}catch{return"grid"}}function qn(){let[e,t]=h(cs),[n,a]=h(st),[r,s]=h(st.q),[i,c]=h(null),[d,u]=h(null),[p,b]=h(new Set),[l,f]=h(!1),[m,w]=h(!1),[x,C]=h(0),g=z(!1),R=z(null);S(()=>()=>clearTimeout(R.current),[]),S(()=>{let $=!0;return c(null),u(null),y(`/api/v1/clips?${rs(n)}`).then(T=>{$&&(c(T),b(new Set))}).catch(T=>$&&u(T)),()=>{$=!1}},[JSON.stringify(n),x]);let j=$=>{t($);try{localStorage.setItem(Hn,$)}catch{}},J=()=>C($=>$+1),Z=$=>{g.current=$,f($)},re=$=>{let T=$.target.value;s(T),clearTimeout(R.current),R.current=setTimeout(()=>{a(v=>({...v,q:T}))},300)},O=$=>T=>{let v=T.target.value;a(P=>({...P,[$]:v}))},te=()=>{a($=>({...$,visibility:"",status:"",source_type:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""}))},L=$=>a(T=>({...T,game:T.game===$?"":$})),Y=$=>a(T=>({...T,sort:$})),ke=$=>{b(T=>{let v=new Set(T);return v.has($)?v.delete($):v.add($),v})};function ne($,T){c(v=>v&&{...v,clips:v.clips.map(P=>P.id===$?{...P,...T}:P)})}function be($,T){let v=new Set($);c(P=>P&&{...P,clips:P.clips.map(I=>v.has(I.id)?{...I,...T}:I)})}async function ve($){if(g.current)return;let T=Array.from(p);if(!T.length)return;let v=i?.clips||[],P=new Map(T.map(U=>[U,v.find(ae=>ae.id===U)]));Z(!0),be(T,{visibility:$});let I=[],D=new Map;try{await Vn(T,4,async _=>{try{let E=await y(`/api/v1/clips/${encodeURIComponent(_)}/visibility`,{method:"POST",body:{visibility:$}}),F={visibility:E.visibility,public_url:E.public_url,public_share_id:E.public_share_id};ne(_,F),D.set(_,F)}catch(E){I.push({id:_,message:E.message})}});let{succeeded:U,message:ae}=On(T,I,{verb:"update",allFailedMessage:"Couldn't update visibility."});if(ae){for(let{id:_}of I){let E=P.get(_);E&&ne(_,{visibility:E.visibility,public_url:E.public_url,public_share_id:E.public_share_id})}k(ae)}U.length&&(b(new Set),k(`Made ${U.length} clip${U.length===1?"":"s"} ${$}`,{actionLabel:"Undo",onAction:()=>pe(U,P,D)}))}finally{Z(!1)}}async function pe($,T,v){if(g.current){k("Wait for visibility changes to finish.");return}Z(!0);try{for(let D of $){let U=T.get(D);U&&ne(D,{visibility:U.visibility,public_url:U.public_url,public_share_id:U.public_share_id})}let P=[];await Vn($,4,async D=>{let U=T.get(D);if(U)try{let ae=await y(`/api/v1/clips/${encodeURIComponent(D)}/visibility`,{method:"POST",body:{visibility:U.visibility}});ne(D,{visibility:ae.visibility,public_url:ae.public_url,public_share_id:ae.public_share_id})}catch(ae){P.push({id:D,message:ae.message})}});let{message:I}=On($,P,{verb:"undo",allFailedMessage:"Couldn't undo visibility change."});if(I){for(let{id:D}of P){let U=v.get(D);U&&ne(D,U)}k(I)}}finally{Z(!1)}}async function ce(){if(g.current){k("Wait for visibility changes to finish.");return}let $=Array.from(p),T=i?.clips||[],v=$.map(D=>T.find(U=>U.id===D)).filter(Boolean),P=ls(v,window.location.origin),I=v.length-P.length;if(!P.length){k("No links to copy \u2014 selected clips are private.");return}try{await navigator.clipboard.writeText(P.join(`
`)),k(`Copied ${P.length} link${P.length===1?"":"s"}`+(I?` (${I} skipped, private)`:""))}catch{k("Couldn't copy links to clipboard.")}}async function me(){let $=Array.from(p);w(!1);try{let T=await y("/api/v1/clips/bulk-delete",{method:"POST",body:{ids:$}});b(new Set),J(),k(`Deleted ${T.affected} clip${T.affected===1?"":"s"}.`)}catch(T){k(T.message)}}if(d)return o`<main class="page">
    ...
    </main>`;let X=i?.clips,oe=os(n),ie=!!(n.q||n.game)||oe>0,$e=is(X||[]),ge=(X||[]).reduce(($,T)=>$+(T.file_size_bytes||0),0),we=o`<div class="popover-fields">
    ...
    <div class="lib-toolbar">
      ...
      <select class="input" aria-label="Sort" value=${n.sort} onChange=${$=>Y($.target.value)}>
        ${as.map(([$,T])=>o`<option value=${$}>${T}</option>`)}
      </select>
      <${zn}
        label="Filters"
    ...
    ${X==null?o`<${ds} />`:X.length===0?ie?o`<${W} name="film" title="No clips match this view"
    ...
    <${le} open=${m}
      ...
      onConfirm=${me}
      onCancel=${()=>w(!1)} />
  </main>`}function at(e,[t,n]){let a=e.sort===t?"ascending":e.sort===n?"descending":"none",r=e.sort===n?t:n;return{ariaSort:a,next:r}}function us({clips:e,query:t,onSort:n,selected:a,onToggleSelect:r}){let s=at(t,tt.title),i=at(t,tt.size),c=at(t,tt.duration),d=at(t,tt.uploaded);return o`<table class="lib-table">
    <thead>
      <tr>
  ...
  </table>`}function ds({count:e=8}){return o`<div class="card-grid">
    ${Array.from({length:e},(t,n)=>o`<div class="clip-card" key=${n}>
      <div class="skeleton-thumb"></div>
      <div class="skeleton-line"></div>
      <div class="skeleton-line is-short"></div>
    </div>`)}
  </div>`}Q();var ps={ChampionKill:"kill",FirstBlood:"kill",Multikill:"spree",Ace:"spree",DragonKill:"objective",HeraldKill:"objective",BaronKill:"objective",TurretKilled:"structure",InhibKilled:"structure",FirstBrick:"structure"};function Kn(e){let t=Number(e);return Number.isFinite(t)&&t>0?t/1e3:0}function Wn(e,t){let n=Number.isFinite(e)?e:0,a=t>0?t:Number.MAX_SAFE_INTEGER;return Math.max(0,Math.min(a,n))}function rt(e,t){return t>0?Math.max(0,Math.min(100,e/t*100)):0}function Mt(e){if(!Number.isFinite(e))return"0:00";let t=Math.max(0,Math.round(e)),n=Math.floor(t/60),a=t-n*60;return`${n}:${String(a).padStart(2,"0")}`}function Gn(e){if(!Number.isFinite(e))return"0:00.0";let t=Math.max(0,Math.round(e*10)),n=Math.floor(t/600),a=t-n*600,r=Math.floor(a/10);return`${n}:${String(r).padStart(2,"0")}.${a%10}`}function jn(e,t){return`${Gn(e)} / ${t>0?Gn(t):"0:00.0"}`}function ms(e){return ps[e]||"info"}function Zn(e,t){return(e||[]).map((n,a)=>{let r=Number(n.timestamp_ms);if(!Number.isFinite(r))return null;let s=r/1e3;return s<0||t>0&&s>t?null:{index:a,time:s,kind:String(n.kind||"Marker"),label:String(n.label||n.kind||"Marker"),category:ms(n.kind)}}).filter(Boolean).sort((n,a)=>n.time-a.time)}function Jn(e,t){if(!e.length)return null;for(let n of e)if(n.time>t+.05)return n;return e[0]}function Yn(e,t){if(!e.length)return null;for(let n=e.length-1;n>=0;n-=1)if(e[n].time<t-.05)return e[n];return e[e.length-1]}function Xn(e,t){switch(e){case"Space":case"KeyK":return{kind:"toggle-play"};case"ArrowLeft":return{kind:"seek-by",seconds:t?-1:-5};case"ArrowRight":return{kind:"seek-by",seconds:t?1:5};case"KeyJ":return{kind:"seek-by",seconds:-10};case"KeyL":return{kind:"seek-by",seconds:10};case"Comma":return{kind:"seek-by",seconds:-.1};case"Period":return{kind:"seek-by",seconds:.1};case"KeyM":return{kind:t?"previous-marker":"next-marker"};case"Home":return{kind:"seek-to",seconds:0};case"End":return{kind:"seek-to-end"};case"KeyF":return{kind:"fullscreen"};case"KeyT":return{kind:"theater"};default:return null}}var ea="clipline.playerVolume",ta="clipline.clipTheaterMode",fs=2e3,_s=[.25,.5,.75,1,1.25,1.5,2];function hs(e,t){switch(e){case"KeyM":return{kind:"toggle-mute"};case"KeyF":return{kind:"theater"};case"Escape":return{kind:"exit-theater"};default:return Xn(e,t)}}function bs(e){return e instanceof Element?!!e.closest("input, textarea, select, button, a, [contenteditable='true'], [contenteditable='']"):!1}function vs(){try{let e=window.localStorage.getItem(ea);if(e==null)return 1;let t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(1,t)):1}catch{return 1}}function Qn(e){try{window.localStorage.setItem(ea,String(Math.max(0,Math.min(1,e))))}catch{}}function $s(){try{return window.localStorage.getItem(ta)==="true"}catch{return!1}}function gs(e){try{window.localStorage.setItem(ta,String(e))}catch{}}function na({src:e,poster:t,durationMs:n,markers:a}){let r=z(null),s=z(null),i=z(null),c=z(!1),d=z(!1),u=Kn(n),[p,b]=h(!1),[l,f]=h(0),[m,w]=h(u),[x,C]=h(0),[g,R]=h(vs),[j,J]=h(!1),[Z,re]=h(1),[O,te]=h(!1),[L,Y]=h($s),[ke,ne]=h(!0),[be,ve]=h(null),[pe,ce]=h(""),me=Zn(a,m);function X(){ne(!0),window.clearTimeout(i.current),i.current=window.setTimeout(()=>{let _=r.current;_&&!_.paused&&!_.ended&&ne(!1)},fs)}S(()=>{p||(window.clearTimeout(i.current),ne(!0))},[p]),S(()=>{let _=r.current;if(!_)return;let E=()=>Number.isFinite(_.duration)&&_.duration>0?_.duration:u,F=()=>w(E()),Dt=()=>w(E()),Ut=()=>{c.current||f(_.currentTime||0)},Lt=()=>{let Bt=E();if(!(Bt>0)||!_.buffered?.length){C(0);return}let Ot=_.currentTime||0,Ue=0;for(let Le=0;Le<_.buffered.length;Le+=1){let Sa=_.buffered.start(Le),ut=_.buffered.end(Le);if(Ot>=Sa&&Ot<=ut){Ue=ut;break}Ue=Math.max(Ue,ut)}C(rt(Ue,Bt))},It=()=>{b(!0),ce(""),X()},At=()=>b(!1),Nt=()=>b(!1),Ft=()=>{R(_.volume),J(_.muted||_.volume===0)},zt=()=>ce("Playback unavailable");return _.addEventListener("loadedmetadata",F),_.addEventListener("durationchange",Dt),_.addEventListener("timeupdate",Ut),_.addEventListener("progress",Lt),_.addEventListener("play",It),_.addEventListener("pause",At),_.addEventListener("ended",Nt),_.addEventListener("volumechange",Ft),_.addEventListener("error",zt),()=>{_.removeEventListener("loadedmetadata",F),_.removeEventListener("durationchange",Dt),_.removeEventListener("timeupdate",Ut),_.removeEventListener("progress",Lt),_.removeEventListener("play",It),_.removeEventListener("pause",At),_.removeEventListener("ended",Nt),_.removeEventListener("volumechange",Ft),_.removeEventListener("error",zt)}},[e,u]),S(()=>{r.current&&(r.current.volume=g)},[g]),S(()=>{r.current&&(r.current.muted=j)},[j]),S(()=>{r.current&&(r.current.playbackRate=Z)},[Z]),S(()=>{if(document.documentElement.classList.toggle("clipline-theater",L),L){let _=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=_}}},[L]),S(()=>()=>document.documentElement.classList.remove("clipline-theater"),[]);function oe(_){Y(_),gs(_)}function ie(_){let E=r.current;if(!E)return;let F=m>0?Wn(_,m):Math.max(0,_);E.currentTime=F,f(F)}function $e(_){ie((r.current?.currentTime||0)+_)}async function ge(){let _=r.current;if(_)if(_.paused||_.ended)try{await _.play()}catch(E){ce(E?.message||"Playback failed")}else _.pause()}function we(){let _=r.current;_&&(_.muted||_.volume===0?(_.muted=!1,_.volume===0&&(_.volume=1,R(1),Qn(1)),J(!1)):(_.muted=!0,J(!0)))}function $(_){let E=Number(_.target.value);R(E),J(E===0),Qn(E);let F=r.current;F&&(F.volume=E,F.muted=E===0)}async function T(){try{document.fullscreenElement?await document.exitFullscreen():await s.current?.requestFullscreen?.()}catch(_){ce(_?.message||"Fullscreen unavailable")}}function v(_){let E=r.current?.currentTime||0,F=_>0?Jn(me,E):Yn(me,E);F&&ie(F.time)}function P(){c.current=!0,d.current=p,p&&r.current?.pause()}function I(_){let E=Number(_.target.value);f(E),ie(E)}function D(){c.current&&(c.current=!1,d.current&&(d.current=!1,r.current?.play().catch(()=>{})))}function U(_){let E=_.currentTarget.getBoundingClientRect();if(!(E.width>0))return;let F=Math.max(0,Math.min(1,(_.clientX-E.left)/E.width));ve({pct:F*100,time:F*(m||0)})}function ae(){ve(null)}return S(()=>{function _(E){if(E.defaultPrevented||bs(E.target))return;let F=hs(E.code,E.shiftKey);if(F&&!(F.kind==="exit-theater"&&!L))switch(E.preventDefault(),X(),F.kind){case"toggle-play":ge();break;case"seek-by":$e(F.seconds);break;case"seek-to":ie(F.seconds);break;case"seek-to-end":ie(m);break;case"next-marker":v(1);break;case"previous-marker":v(-1);break;case"toggle-mute":we();break;case"theater":oe(!L);break;case"exit-theater":oe(!1);break;case"fullscreen":T();break;default:break}}return document.addEventListener("keydown",_),()=>document.removeEventListener("keydown",_)},[m,L,p]),o`<div class=${`player ${ke?"":"chrome-hidden"}`} ref=${s}
    ...
    <div class="player-overlay">
      <div class="player-timeline" onPointerMove=${U} onPointerLeave=${ae}>
        ...
        ${me.map(_=>o`<span class="player-marker-tick" key=${_.index}
            style=${`left:${rt(_.time,m)}%`} title=${`${_.label} @ ${Mt(_.time)}`}></span>`)}
      ...
      <div class="player-controls">
        ...
        <div class="player-speed-wrap">
          ...
          ${O&&o`<div class="player-speed-menu" role="menu">
            ${_s.map(_=>o`<button type="button" role="menuitem" key=${_}
                class=${`player-speed-item ${_===Z?"is-active":""}`}
                onClick=${()=>{re(_),te(!1)}}>${_}×</button>`)}
          </div>`}
        </div>
        ...
        <button type="button" class="player-btn" aria-label=${L?"Exit theater mode":"Theater mode"}
          aria-pressed=${L} onClick=${()=>oe(!L)}>${M("theater",{size:14})}</button>
        <button type="button" class="player-btn" aria-label="Fullscreen" onClick=${T}>
          ${M("fullscreen",{size:14})}
        </button>
      </div>
    </div>
  </div>`}Q();function ys(e){let t=new Map(e.map(s=>[s.id,s])),n=new Map,a=[],r=0;return e.forEach(s=>{let i=s.parent_comment_id||"";i&&t.has(i)?(n.has(i)||n.set(i,[]),n.get(i).push(s),r+=1):i||(a.push(s),r+=1)}),{roots:a,repliesByParent:n,count:r}}async function ks({apiClient:e=y,shareId:t,body:n,parentCommentId:a,onReload:r=()=>{},onError:s=k}){let i=n.trim();if(!i)return!1;try{return await e(`/api/v1/public/clips/${encodeURIComponent(t)}/comments`,{method:"POST",body:a?{body:i,parent_comment_id:a}:{body:i}}),r(),!0}catch(c){return s(c.message),!1}}function ws(e){return(e||"?").trim().slice(0,1).toUpperCase()||"?"}function Ss(e){let t=e.author_avatar_url;return typeof t=="string"&&t.startsWith("/")?o`<img class="comment-avatar" src=${t} alt="" />`:o`<div class="comment-avatar">${ws(e.author_name)}</div>`}function aa({shareId:e}){let{user:t}=H(A),[n,a]=h(null),[r,s]=h(""),[i,c]=h(null),[d,u]=h(""),[p,b]=h(null);function l(){y(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`).then(g=>a(g.comments||[])).catch(()=>a([]))}S(()=>{let g=!0;return a(null),y(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`).then(R=>g&&a(R.comments||[])).catch(()=>g&&a([])),()=>{g=!1}},[e]);async function f(g,R){return ks({shareId:e,body:g,parentCommentId:R,onReload:l,onError:k})}async function m(g){g.preventDefault(),await f(r)&&s("")}async function w(g,R){g.preventDefault(),await f(d,R)&&(u(""),c(null))}async function x(){let g=p;b(null);try{await y(`/api/v1/public/clips/${encodeURIComponent(e)}/comments/${encodeURIComponent(g)}`,{method:"DELETE"}),l()}catch(R){k(R.message)}}let C=ys(n||[]);return o`<section class="comments">
    ...
    ${n==null?"":C.count===0?o`<p class="comment-signin">No comments yet.</p>`:o`<div class="comment-list">
          ${C.roots.map(g=>sa(g,{depth:0,repliesByParent:C.repliesByParent,user:t,replyOpenId:i,setReplyOpenId:c,replyDraft:d,setReplyDraft:u,submitReply:w,onDelete:b}))}
        </div>`}
  ...
  </section>`}function sa(e,t){let{depth:n,repliesByParent:a,user:r,replyOpenId:s,setReplyOpenId:i,replyDraft:c,setReplyDraft:d,submitReply:u,onDelete:p}=t,b=a.get(e.id)||[];return o`<article class="comment" key=${e.id}>
    ${Ss(e)}
  ...
  </article>`}var xs=["private","public","unlisted"];function Cs(e,t){return e==="clip"?!0:!!t?.viewer_can_edit}function Ts(e,t,n){return e==="public"?t.shareId:n?.public_share_id||null}function Ms(e,t,n){return e==="clip"?t.clipId:n?.viewer_clip_id||null}function Ps(e){let t=e?.height!=null?e.height:"",n=Math.round(e?.fps||0)||"";return`${t}p${n}`}function Es(e,t=8){let n=new URLSearchParams;return e&&n.set("share_id",e),n.set("limit",String(t)),`/api/v1/public/recommendations?${n}`}function Rs(e,t,n=8){return(e||[]).filter(a=>a.share_id!==t).slice(0,n)}function Pt({route:e}){let{user:t}=H(A),[n,a]=h(null),[r,s]=h(null),[i,c]=h([]),[d,u]=h(!1),[p,b]=h(""),[l,f]=h(!1),[m,w]=h(""),[x,C]=h(!1),[g,R]=h(!1),[j,J]=h(!1),Z=e.name==="clip"?`clip:${e.clipId}`:`public:${e.shareId}`,re=Ts(e.name,e,n),O=e.name==="public"||!!n;if(S(()=>{let v=!0;a(null),s(null),u(!1),f(!1),J(!1),C(!1);let P=e.name==="clip"?`/api/v1/clips/${encodeURIComponent(e.clipId)}`:`/api/v1/public/clips/${encodeURIComponent(e.shareId)}`;return y(P).then(I=>{v&&(a(I),e.name==="public"&&y(`/api/v1/public/clips/${encodeURIComponent(e.shareId)}/view`,{method:"POST",body:{}}).then(D=>v&&a(U=>U&&{...U,view_count:D.view_count})).catch(()=>{}))}).catch(I=>v&&s(I)),()=>{v=!1}},[Z]),S(()=>{let v=!0;return O?(c([]),y(Es(re,8)).then(P=>v&&c(P.clips||[])).catch(()=>{}),()=>{v=!1}):(c([]),()=>{v=!1})},[Z,re,O]),r)return o`<main class="page"><${W} name="alert" title="Couldn't load this clip" body=${r.message} /></main>`;if(!n)return o`<main class="page watch"><div><div class="skeleton-thumb"></div></div><aside class="upnext"></aside></main>`;let te=Cs(e.name,n),L=re,Y=Ms(e.name,e,n),ke=e.name==="clip"?Xe({id:n.id}):xe({share_id:e.shareId}),ne=e.name==="clip"?Ee({id:n.id}):se({share_id:e.shareId}),be=e.name==="clip"?t?.display_name||t?.username||"You":n.author_name||"Unknown creator",ve=n.public_url??n.share_url??null,pe=Re(ve,window.location.origin,L),ce=e.name==="clip";function me(){b(n.title),u(!0)}async function X(v){v?.preventDefault?.();let P=p.trim();if(!P||P===n.title){u(!1);return}try{await y(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"PATCH",body:{title:P}}),a(I=>({...I,title:P})),u(!1),k("Title saved.")}catch(I){k(I.message)}}function oe(){w(n.description||""),f(!0)}async function ie(){let v=m.trim();try{await y(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"PATCH",body:{description:v||null}}),a(P=>({...P,description:v||null})),f(!1),k("Description saved.")}catch(P){k(P.message)}}async function $e(v,{force:P=!1}={}){let I=n.visibility;if(!(I===v&&!P)){a(D=>({...D,visibility:v}));try{let D=await y(`/api/v1/clips/${encodeURIComponent(Y)}/visibility`,{method:"POST",body:{visibility:v}});a(U=>({...U,visibility:D.visibility,public_url:D.public_url,public_share_id:D.public_share_id})),k(`Visibility set to ${v}.`,{actionLabel:"Undo",onAction:()=>$e(I,{force:!0})})}catch(D){a(U=>({...U,visibility:I})),k(D.message)}}}async function ge(){if(pe)try{await navigator.clipboard.writeText(pe),k("Link copied.")}catch{k("Couldn't copy the link.")}}async function we(){R(!1);try{await y(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"DELETE"}),k("Clip deleted."),G("/library")}catch(v){k(v.message)}}let $=[n.game_name&&o`<a class="chip chip-on" href=${`/game/${encodeURIComponent(n.game_name)}`}>${n.game_name}</a>`,ye(n.view_count),`Recorded ${K(n.recorded_at)}`,`by ${be}`].filter(Boolean),T=Rs(i,L,8);return o`<main class="page watch">
    <div>
      <${na} src=${ke} poster=${ne} durationMs=${n.duration_ms} markers=${n.markers} />
      ...
      ${te&&o`<div class="watch-actions">
        <div class="seg" role="radiogroup" aria-label="Visibility">
          ${xs.map(v=>o`<button type="button" role="radio" key=${v} aria-checked=${n.visibility===v}
  ...
  </main>`}Q();var Et=[{top:"4%",left:"4%",width:"34%",rotate:-7},{top:"0%",left:"44%",width:"30%",rotate:5},{top:"34%",left:"68%",width:"28%",rotate:-4},{top:"50%",left:"8%",width:"30%",rotate:6},{top:"62%",left:"42%",width:"26%",rotate:-5},{top:"26%",left:"-4%",width:"22%",rotate:9}];function Ds(e){return Array.isArray(e)?e.slice(0,Et.length).map((t,n)=>({clip:t,...Et[n]})):[]}function Us(e){let t=e?.clips;if(!Array.isArray(t)||t.length===0)return null;let n=t.length,a=e.has_more?"+":"";return`${n}${a} clip${n===1?"":"s"} on this instance`}function Ls({top:e,left:t,width:n,rotate:a}){return`top:${e};left:${t};width:${n};transform:rotate(${a}deg);`}function ra(e){let t=String(e||"").trim();return t||null}function Is(){let[e,t]=h(null);S(()=>{let r=!0;return y(`/api/v1/public/clips?page_size=${Et.length}`).then(s=>r&&t(s)).catch(()=>r&&t(null)),()=>{r=!1}},[]);let n=Ds(e?.clips),a=Us(e);return o`<aside class="login-montage" aria-hidden="true">
    ${n.length>0&&o`<div class="login-montage-tiles">
      ${n.map((r,s)=>o`<img key=${s} class="login-montage-tile" style=${Ls(r)}
        src=${se(r.clip)} alt="" loading="lazy" />`)}
    </div>`}
  ...
  </${Te}>`}Q();function De({label:e,value:t,sub:n,meter:a,tone:r}){let s=r?` stat-${r}`:"";return o`<div class="stat-card">
  ...
  </div>`}Q();function ot(e){let t=String(e||"").trim();return t||null}function zs(e){let t=Number(String(e||"").trim());if(!Number.isFinite(t)||t<0)throw new Error("Storage quota must be a non-negative number");return Math.round(t*1024*1024*1024)}function Bs(e,t){return!(e.is_disabled||t?.id===e.id||e.role==="owner"||e.role==="admin"&&t?.role!=="owner")}function ca(e){return e?[["user","User"],["admin","Admin"]]:[["user","User"]]}function Os({isOwner:e,onCreated:t}){let[n,a]=h(!1);async function r(s){if(s.preventDefault(),n)return;a(!0);let i=s.currentTarget,c=new FormData(i);try{await y("/api/v1/users",{method:"POST",body:{username:String(c.get("username")||""),display_name:ot(c.get("display_name")),email:ot(c.get("email")),password:ot(c.get("password")),role:String(c.get("role")||"user")}}),k("User created."),i.reset(),t()}catch(d){k(d.message)}finally{a(!1)}}return o`<form class="panel section" onSubmit=${r}>
    <h2>Create user</h2>
  ...
  </form>`}function Vs({isOwner:e,smtpEnabled:t,onCreated:n}){let[a,r]=h(!1);async function s(i){if(i.preventDefault(),a)return;r(!0);let c=new FormData(i.currentTarget),d=i.submitter?.value==="email"?"email":"link";try{let u=await y("/api/v1/invites",{method:"POST",body:{role:String(c.get("role")||"user"),email:ot(c.get("email")),send_email:d==="email"}});k(d==="email"?"Invite sent.":"Invite link created."),n({...u,kind:"invite"})}catch(u){k(u.message)}finally{r(!1)}}return o`<form class="panel section" onSubmit=${s}>
    <h2>Invite link</h2>
    <label class="field"><span>Role</span>
      <select class="input" name="role">
  ...
  </form>`}function Hs({resetLink:e}){if(!e)return null;let t=e.kind==="invite"?"Invite":"Reset",n=e.username?` for ${e.username}`:"",a=async()=>{try{await navigator.clipboard.writeText(e.reset_url),k("Copied to clipboard.")}catch{k("Copy failed. Select and copy the URL manually.")}};return o`<div class="notice admin-reset-link">
    <div>
  ...
  </div>`}function qs(e){return e.is_disabled?o`<span class="badge badge-warn">Disabled</span>`:o`<span class="badge badge-public">Active</span>`}function Gs({user:e,currentUser:t,onQuota:n,onReset:a,onDisable:r}){let s=e.storage_quota_bytes!=null?q(e.storage_quota_bytes):"No limit",i=!Bs(e,t);return o`<tr>
    <td>
    ...
    <div class="admin-side-stack">
      <${Os} isOwner=${d} onCreated=${()=>{r(null),s()}} />
      <${Vs} isOwner=${d} smtpEnabled=${u}
        onCreated=${f=>{r(f),s()}} />
    </div>
    <div class="panel">
      ...
      <div class="table-wrap">
        <table class="lib-table">
          ...
          <tbody>
            ${e.map(f=>o`<${Gs} key=${f.id} user=${f} currentUser=${n}
  ...
  </form>`}function Ks(e){return`${(e/100).toFixed(e%100===0?0:1)}%`}function Ws(e){switch(e){case"delete_and_retry":return"delete the failed upload and retry from a new session";case"retry":return"retry the current upload request";default:return""}}function js({upload:e}){let t=Math.max(0,Math.min(1e4,Number(e.progress_basis_points||0))),n=Ws(e.recovery_action);return o`<div class="job-item">
    <div class="job-title-line">
      <strong class="mono">${e.id}</strong>
      <span class="badge badge-warn">${Ks(t)}</span>
    </div>
    ...
    <${Rt} title="Recent job errors" items=${n} emptyLabel="No recent job errors."
      renderItem=${a=>o`<${pa} key=${a.id} job=${a} />`} />
  </div>`}var fa=[["overview","server","Overview"],["users","users","Users"],["settings","sliders","Settings"],["jobs","alert","Jobs"]];function Zs(e){return e?.role==="admin"||e?.role==="owner"}async function Js(){let[e,t,n,a,r,s]=await Promise.all([y("/api/v1/admin/overview"),y("/api/v1/admin/settings"),y("/api/v1/users"),y("/api/v1/admin/uploads/failed?limit=50"),y("/api/v1/admin/jobs/dead?limit=50"),y("/api/v1/admin/jobs/recent-errors?limit=50")]);return{overview:e,settings:t,users:n,failedUploads:a,deadJobs:r,recentErrors:s}}function _a({route:e}){let{user:t}=H(A),n=Zs(t),a=!!(t&&!n),r=fa.some(([m])=>m===e.tab)?e.tab:"overview",[s,i]=h(null),[c,d]=h(null),[u,p]=h(null),[b,l]=h(0),f=()=>l(m=>m+1);return S(()=>{a&&(k("Admin access required."),G("/library"))},[a]),S(()=>{if(!n)return;let m=!0;return d(null),Js().then(w=>m&&i(w)).catch(w=>m&&d(w)),()=>{m=!1}},[n,b]),n?o`<main class="page">
    <h1>Admin</h1>
    <p class="page-subtitle">Accounts, instance summary, and processing diagnostics.</p>
    <nav class="ad-tabs" aria-label="Admin views">
      ${fa.map(([m,w,x])=>o`<a key=${m} class=${`ad-tab ${m===r?"ad-tab-on":""}`}
        href=${`/admin?tab=${m}`} aria-current=${m===r?"page":void 0}>${M(w,{size:14})} ${x}</a>`)}
    </nav>
    ${c?o`<${W} name="alert" title="Couldn't load admin data" body=${c.message} />`:s?r==="users"?o`<${ua} users=${s.users} settings=${s.settings} currentUser=${t}
  ...
  </main>`:null}Q();function Ys(e){if(!e?.avatar_url)return"";let t=e.updated_at||"";if(!t)return e.avatar_url;let n=String(e.avatar_url).includes("?")?"&":"?";return`${e.avatar_url}${n}v=${encodeURIComponent(t)}`}function Xs(e){return(e||"C").trim().slice(0,1).toUpperCase()||"C"}function lt({user:e,size:t=40,className:n=""}){let a=Ys(e),r=`width:${t}px;height:${t}px;font-size:${Math.round(t*.4)}px`;if(a)return o`<img class=${`user-avatar ${n}`} style=${r} src=${a} alt="" />`;let s=e?.display_name||e?.username;return o`<div class=${`user-avatar user-avatar-fallback ${n}`} style=${r} aria-hidden="true">
    ${Xs(s)}
  </div>`}function ha(e){let t=String(e||"").trim();return t||null}async function Qs(e){let t=new Headers;t.set("Accept","application/json"),t.set("Content-Type",e.type||"application/octet-stream");let n=kt();n&&t.set("X-CSRF-Token",n);let a=await fetch("/api/v1/me/avatar",{method:"PUT",credentials:"same-origin",headers:t,body:e}),r=await a.json().catch(()=>({}));if(!a.ok)throw new Error(r.error||a.statusText||"Avatar upload failed");return r}function ba(e){A.set({...A.get(),user:e})}function er({user:e}){let[t,n]=h(!1);async function a(r){if(r.preventDefault(),t)return;n(!0);let s=new FormData(r.currentTarget);try{let i=await y("/api/v1/me/profile",{method:"PATCH",body:{display_name:ha(s.get("display_name")),bio:ha(s.get("bio"))}});ba(i),k("Profile saved.")}catch(i){k(i.message)}finally{n(!1)}}return o`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function tr({user:e}){let[t,n]=h(!1);async function a(r){if(r.preventDefault(),t)return;let s=r.currentTarget.elements.avatar?.files?.[0];if(!s){k("Choose an avatar image first.");return}n(!0);try{let i=await Qs(s);ba(i),k("Avatar uploaded.")}catch(i){k(i.message)}finally{n(!1)}}return o`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function va(){let{user:e}=H(A);return e?o`<main class="page">
    <h1>Profile</h1>
  ...
  </main>`:null}Q();async function nr(){let[e,t]=await Promise.all([y("/api/v1/auth/sessions"),y("/api/v1/auth/device-tokens")]);return{sessions:e,deviceTokens:t}}function ar({item:e,onRevoke:t}){return o`<div class="management-item">
    <div>
  ...
  </div>`}function sr({item:e,onRevoke:t}){let n=!!e.revoked_at;return o`<div class="management-item">
    <div>
    ...
    ${e?o`<div class="account-grid">
          <div class="panel">
            ...
            ${e.sessions.length?o`<div class="management-list">${e.sessions.map(p=>o`<${ar} key=${p.id} item=${p}
          ...
          <div class="panel">
            ...
            ${e.deviceTokens.length?o`<div class="management-list">${e.deviceTokens.map(p=>o`<${sr} key=${p.id} item=${p}
    ...
    ${c.length===0?o`<${W} name="film" title="No public clips yet" />`:o`<div class="card-grid">
          ${c.map(d=>o`<${Ce} key=${d.share_id}
            clip=${{...d,thumbnail_url:se(d),media_url:xe(d)}}
            href=${`/c/${encodeURIComponent(d.share_id)}`} showAuthor=${!1} />`)}
        </div>`}
  </main>`}Q();var ya="Clipline is a self-hosted clip library for saved gameplay moments.";function ct(e,t){return o`<div><dt>${e}</dt><dd>${t}</dd></div>`}function ka(){let[e,t]=h(ya);return S(()=>{let n=!0;return y("/api/v1/about").then(a=>n&&t(a.about_text||ya)).catch(()=>{}),()=>{n=!1}},[]),o`<main class="page">
    <h1>About</h1>
  ...
  </main>`}var rr={publicLibrary:et,publicGame:et,games:Fn,library:qn,clip:Pt,public:Pt,login:oa,resetPassword:ia,admin:_a,profile:va,account:$a,publicUser:ga,about:ka},wa=Cn({pathname:window.location.pathname,search:window.location.search});function or(){let e=Mn();wa=e.name;let{ready:t,user:n}=H(A),a=t&&Sn(e.name,n);if(S(()=>{a&&G("/login")},[a]),!t||a)return o`<div class="boot">Loading…</div>`;let r=rr[e.name]||et,s=e.name==="login"||e.name==="resetPassword";return o`<div class="ui" onClick=${Pn}>
    ${!s&&o`<${Rn} active=${St(e)} route=${e} />`}
    <${r} route=${e} />
    ${!s&&o`<${Dn} active=${xn(e)} />`}
    <${Un} />
  </div>`}window.addEventListener("clipline:unauthorized",()=>{de(null),A.set({user:null,csrfToken:null,ready:!0}),wt(wa)||G("/login")});(async()=>{try{let t=await y("/api/v1/auth/me");de(t.csrf_token),A.set({user:t.user,csrfToken:t.csrf_token,ready:!0})}catch{de(null),A.set({user:null,csrfToken:null,ready:!0})}let e=document.querySelector("#app");e.textContent="",an(o`<${or} />`,e)})();
