...
`||a==="\r"?(c(),s=2):i+=a),s===3&&i==="!--"&&(s=4,p=p[0])}return c(),p})(e)),t),arguments,[])).length>1?t:t[0]}var o=Sn.bind(bt);X();function Cn(e){let t=e,n=new Set;return{get:()=>t,set(a){t=a,n.forEach(r=>r(t))},update(a){this.set(a(t))},subscribe(a){return n.add(a),()=>n.delete(a)}}}function q(e){let[t,n]=b(e.get());return S(()=>e.subscribe(n),[e]),t}var N=Cn({user:null,csrfToken:null,ready:!1}),je=Cn([]),qa=0;function w(e,{actionLabel:t,onAction:n,timeoutMs:a=5e3}={}){let r=++qa;return je.update(s=>[...s,{id:r,message:e,actionLabel:t,onAction:n}]),a&&setTimeout(()=>Ze(r),a),r}function Ze(e){je.update(t=>t.filter(n=>n.id!==e))}function Je(e){try{return decodeURIComponent(e)}catch{return e}}function Tn(e){let t=Number(e.get("page")||1);return{sort:e.get("sort")||"uploaded_at_desc",game:e.get("game")||"",q:e.get("q")||"",page:Number.isFinite(t)?Math.max(1,t):1}}var Ga=["login","resetPassword","public","publicLibrary","publicGame","publicUser","about","games"];function St(e){return Ga.includes(e)}function Pn(e,t){return!t&&!St(e)}var Ka={publicLibrary:"feed",publicGame:"feed",games:"games",library:"library",clip:"library",admin:"admin",profile:"profile"};function xt(e){return Ka[e?.name]||""}function Mn(e){return e?.name==="publicLibrary"&&e.surface==="search"?"search":xt(e)}function Ye(e,t){let n=new URLSearchParams(t||""),a=e;return a.startsWith("/c/")?{name:"public",shareId:Je(a.slice(3))}:a==="/"||a==="/public"||a==="/search"?{name:"publicLibrary",query:Tn(n),surface:a==="/search"?"search":"feed"}:a.startsWith("/game/")?{name:"publicGame",game:Je(a.slice(6)),query:Tn(n)}:a==="/about"?{name:"about"}:a==="/games"?{name:"games"}:a.startsWith("/u/")?{name:"publicUser",username:Je(a.slice(3))}:a==="/library"?{name:"library"}:a.startsWith("/clip/")?{name:"clip",clipId:Je(a.slice(6))}:a==="/admin"?{name:"admin",tab:n.get("tab")||"overview"}:a==="/account"?{name:"account"}:a==="/profile"?{name:"profile"}:a==="/login"?{name:"login"}:a==="/reset-password"?{name:"resetPassword",token:n.get("token")||"",invite:n.get("invite")==="1"}:{name:"publicLibrary"}}function En(e){return Ye(e.pathname,e.search).name}var Ct=new Set;function G(e){window.history.pushState({},"",e),Rn()}function Rn(){let{pathname:e,search:t}=window.location,n=Ye(e,t);Ct.forEach(a=>a(n))}window.addEventListener("popstate",Rn);function Dn(){let[e,t]=b(()=>Ye(window.location.pathname,window.location.search));return S(()=>(Ct.add(t),()=>Ct.delete(t)),[]),e}function Un(e){let t=e.target.closest("a[href^='/']");!t||t.target||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),G(t.getAttribute("href")))}var Ln={alert:'<path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>',clipboard:'<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>',copy:'<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',external:'<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',edit:'<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/>',fastForward:'<path d="m13 19 9-7-9-7v14Z"/><path d="m2 19 9-7-9-7v14Z"/>',film:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M17 3v18"/><path d="M3 8h4"/><path d="M3 16h4"/><path d="M17 8h4"/><path d="M17 16h4"/>',fullscreen:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/>',home:'<path d="m3 10 9-7 9 7"/><path d="M5 8.5V20a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.5"/><path d="M9 22V12h6v10"/>',info:'<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',logOut:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/>',menu:'<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h16"/>',message:'<path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"/>',notepad:'<path d="M8 2v4"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M6 4h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><path d="M8 14h8"/><path d="M8 18h5"/>',pause:'<path d="M8 5v14"/><path d="M16 5v14"/>',play:'<path d="m8 5 11 7-11 7V5Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',refresh:'<path d="M21 12a9 9 0 0 1-15.5 6.3L3 16"/><path d="M3 21v-5h5"/><path d="M3 12A9 9 0 0 1 18.5 5.7L21 8"/><path d="M21 3v5h-5"/>',rewind:'<path d="m11 19-9-7 9-7v14Z"/><path d="m22 19-9-7 9-7v14Z"/>',save:'<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2Z"/><path d="M17 21v-8H7v8"/><path d="M7 3v5h8"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',server:'<rect width="20" height="8" x="2" y="2" rx="2"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 6h.01"/><path d="M6 18h.01"/>',skipBack:'<path d="M19 20 9 12l10-8v16Z"/><path d="M5 19V5"/>',skipForward:'<path d="m5 4 10 8-10 8V4Z"/><path d="M19 5v14"/>',shield:'<path d="M20 13c0 5-3.5 7.5-7.7 8.8a1 1 0 0 1-.6 0C7.5 20.5 4 18 4 13V5l8-3 8 3v8Z"/>',sliders:'<path d="M4 21v-7"/><path d="M4 10V3"/><path d="M12 21v-9"/><path d="M12 8V3"/><path d="M20 21v-5"/><path d="M20 12V3"/><path d="M2 14h4"/><path d="M10 8h4"/><path d="M18 16h4"/>',theater:'<rect width="20" height="14" x="2" y="5" rx="2"/><path d="M6 9h12"/><path d="M6 15h12"/>',trash:'<path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m17 8-5-5-5 5"/><path d="M12 3v12"/>',user:'<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.9"/><path d="M16 3.1a4 4 0 0 1 0 7.8"/>',volume2:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9 9 0 0 1 0 14"/>',volumeX:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>'};function C(e,{size:t=18}={}){return o`<svg viewBox="0 0 24 24" width=${t} height=${t} fill="none"
    ...
    <a class="card-thumb" href=${t} tabindex="-1" aria-hidden="true">
      <${On} src=${e.media_url} poster=${e.thumbnail_url} />
    ...
    ${n&&o`<p>${n}</p>`}
    ${a}
  </div>`}var ts=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],ns=6,as=60;function ss(e){let t=new URLSearchParams;return t.set("page_size",String(as)),e.sort!=="uploaded_at_desc"&&t.set("sort",e.sort),e.game&&t.set("game",e.game),e.q&&t.set("q",e.q),Number(e.page)>1&&t.set("page",String(e.page)),t}function Vn(e){return e?.game_name||"No game"}function rs(e,t,n=ns){let a=[...e||[]].sort((h,l)=>(l.clip_count||0)-(h.clip_count||0)),r=a.slice(0,n),s=String(t||"").trim(),i=s&&r.some(h=>h.game===s),u=s&&!i?a.find(h=>h.game===s)||{game:s,clip_count:0}:null,p=u?[u,...r]:r,c=new Set(p.map(h=>h.game)),d=a.filter(h=>!c.has(h.game)).length;return{chips:p,extraGameCount:d}}function nt({route:e}){let t={sort:"uploaded_at_desc",page:1,q:"",...e.query,game:e.name==="publicGame"?e.game:e.query?.game||""},[n,a]=b(null),[r,s]=b([]),[i,u]=b(null);S(()=>{let m=!0;a(null),u(null);let k=ss(t);return y(`/api/v1/public/clips?${k}`).then(x=>m&&a(x)).catch(x=>m&&u(x)),()=>{m=!1}},[e.name,t.sort,t.game,t.q,t.page]),S(()=>{let m=!0;return y("/api/v1/public/games").then(k=>m&&s(k.games||[])).catch(()=>{}),()=>{m=!1}},[]);let p=m=>G(ls({...t,page:1,...m}));if(i)return o`<main class="page">
    ...
    <section class="hero">
      <a class="hero-main" href=${Et(t)}>
        ...
        <span class="hero-caption">▶ ${t.title} — ${Vn(t)} · ${he(t.duration_ms)}</span>
      </a>
      <div class="hero-side">
        ${a.map(r=>o`<a class="hero-row" href=${Et(r)}>
            <img src=${de(r)} alt="" loading="lazy" />
            <span><b>${r.title}</b>
              <small>${Mt(r)} · ${Vn(r)} · ${ye(r.view_count)}</small></span>
          </a>`)}
      </div>
  ...
  </nav>`}X();function Hn(){let[e,t]=b(null),[n,a]=b(null);return S(()=>{let r=!0;return y("/api/v1/public/games").then(s=>r&&t(s.games||[])).catch(s=>r&&a(s)),()=>{r=!1}},[]),n?o`<main class="page">
  ...
  </div>`:null}function le({open:e,title:t,body:n,confirmLabel:a="Confirm",onConfirm:r,onCancel:s,danger:i=!1,confirmDisabled:u=!1}){let p=F(null),c=F(null);return S(()=>{let d=p.current;d&&(e&&!d.open?(d.showModal(),c.current?.focus()):!e&&d.open&&d.close())},[e]),o`<dialog ref=${p} class="confirm-dialog" aria-labelledby="confirm-dialog-title"
...
`)),w(`Copied ${E.length} link${E.length===1?"":"s"}`+(A?` (${A} skipped, private)`:""))}catch{w("Couldn't copy links to clipboard.")}}async function me(){let $=Array.from(d);k(!1);try{let P=await y("/api/v1/clips/bulk-delete",{method:"POST",body:{ids:$}});h(new Set),Z(),w(`Deleted ${P.affected} clip${P.affected===1?"":"s"}.`)}catch(P){w(P.message)}}if(p)return o`<main class="page">
    ...
    ${n==null?"":T.count===0?o`<p class="comment-signin">No comments yet.</p>`:o`<div class="comment-list">
          ${T.roots.map(g=>ca(g,{depth:0,repliesByParent:T.repliesByParent,user:t,replyOpenId:i,setReplyOpenId:u,replyDraft:p,setReplyDraft:c,submitReply:k,onDelete:h}))}
        </div>`}
  ...
  </${Pe}>`}function pa({route:e}){let t=!!e.invite,[n,a]=b(()=>t?"preflight":e.token?"form":"missing-token"),[r,s]=b(""),[i,u]=b(t?null:e.token),[p,c]=b(""),[d,h]=b(!1),l=t;S(()=>{if(!t)return;if(!e.token){a("missing-token");return}let x=!0;return a("preflight"),y("/api/v1/invites/claim",{method:"POST",body:{invite_token:e.token}}).then(T=>{x&&(u(T.reset_token),a("form"))}).catch(T=>{x&&(s(T instanceof _e?T.message:"This invite link is invalid, used, or expired."),a("invalid"))}),()=>{x=!1}},[t,e.token]);async function f(x){if(x.preventDefault(),d)return;h(!0),c("");let T=new FormData(x.currentTarget),g={reset_token:i,new_password:String(T.get("new_password")||"")};l&&(g.username=String(T.get("username")||""),g.display_name=ua(T.get("display_name")),g.email=ua(T.get("email")));try{await y("/api/v1/auth/reset-password",{method:"POST",body:g}),w(l?"Account created. Sign in with your new password.":"Password set. Sign in with your new password."),G("/login")}catch(R){c(R instanceof _e?R.message:"Request failed"),h(!1)}}if(t&&n!=="form"){let x=n==="missing-token"||n==="invalid",T=n==="missing-token"?"This invite link is missing a token.":n==="invalid"?r:"Opening invite\u2026";return o`<${Pe} titleId="invite-title">
  ...
  </form>`}function Ys({isOwner:e,smtpEnabled:t,onCreated:n}){let[a,r]=b(!1);async function s(i){if(i.preventDefault(),a)return;r(!0);let u=new FormData(i.currentTarget),p=i.submitter?.value==="email"?"email":"link";try{let c=await y("/api/v1/invites",{method:"POST",body:{role:String(u.get("role")||"user"),email:lt(u.get("email")),send_email:p==="email"}});w(p==="email"?"Invite sent.":"Invite link created."),n({...c,kind:"invite"})}catch(c){w(c.message)}finally{r(!1)}}return o`<form class="panel section" onSubmit=${s}>
    <h2>Invite link</h2>
    <label class="field"><span>Role</span>
      <select class="input" name="role">
  ...
  </form>`}function Qs({resetLink:e}){if(!e)return null;let t=e.kind==="invite"?"Invite":"Reset",n=e.username?` for ${e.username}`:"",a=async()=>{try{await navigator.clipboard.writeText(e.reset_url),w("Copied to clipboard.")}catch{w("Copy failed. Select and copy the URL manually.")}};return o`<div class="notice admin-reset-link">
    <div>
    ...
    <td>
      ${l?o`<select class="input input-compact" value=${e.role}
    ...
    <div class="panel admin-users-table">
      ...
      <div class="table-wrap">
        <table class="lib-table">
          ...
          <tbody>
            ${e.map(f=>o`<${er} key=${f.id} user=${f} currentUser=${n}
              ...
              onRole=${(m,k)=>u({type:"role",user:m,value:{role:k,password:""}})}
  ...
  </main>`:null}X();function ya(e){let t=String(e||"").trim();return t||null}async function or(e){let t=new Headers;t.set("Accept","application/json"),t.set("Content-Type",e.type||"application/octet-stream");let n=kt();n&&t.set("X-CSRF-Token",n);let a=await fetch("/api/v1/me/avatar",{method:"PUT",credentials:"same-origin",headers:t,body:e}),r=await a.json().catch(()=>({}));if(!a.ok)throw new Error(r.error||a.statusText||"Avatar upload failed");return r}function wa(e){N.set({...N.get(),user:e})}function ir({user:e}){let[t,n]=b(!1);async function a(r){if(r.preventDefault(),t)return;n(!0);let s=new FormData(r.currentTarget);try{let i=await y("/api/v1/me/profile",{method:"PATCH",body:{display_name:ya(s.get("display_name")),bio:ya(s.get("bio"))}});wa(i),w("Profile saved.")}catch(i){w(i.message)}finally{n(!1)}}return o`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function lr({user:e}){let[t,n]=b(!1);async function a(r){if(r.preventDefault(),t)return;let s=r.currentTarget.elements.avatar?.files?.[0];if(!s){w("Choose an avatar image first.");return}n(!0);try{let i=await or(s);wa(i),w("Avatar uploaded.")}catch(i){w(i.message)}finally{n(!1)}}return o`<form class="profile-form" onSubmit=${a}>
  ...
  </main>`:null}X();async function cr(){let[e,t]=await Promise.all([y("/api/v1/auth/sessions"),y("/api/v1/auth/device-tokens")]);return{sessions:e,deviceTokens:t}}function ur({item:e,onRevoke:t}){return o`<div class="management-item">
    <div>
  ...
  </div>`}function Sa(){let[e,t]=b(null),[n,a]=b(null),[r,s]=b(0),[i,u]=b(null);S(()=>{let d=!0;return a(null),cr().then(h=>d&&t(h)).catch(h=>d&&a(h)),()=>{d=!1}},[r]);let p=()=>s(d=>d+1);async function c(){let d=i;u(null);try{if(d.kind==="session"){if(await y(`/api/v1/auth/sessions/${encodeURIComponent(d.item.id)}`,{method:"DELETE",body:{}}),d.item.current){ue(null),N.set({user:null,csrfToken:null,ready:!0}),w("Current session revoked."),G("/login");return}w("Session revoked.")}else await y(`/api/v1/auth/device-tokens/${encodeURIComponent(d.item.id)}`,{method:"DELETE",body:{}}),w("Device token revoked.");p()}catch(h){w(h.message)}}return n?o`<main class="page"><${W} name="alert" title="Couldn't load account data" body=${n.message} /></main>`:o`<main class="page">
    <h1>Account</h1>
  ...
  </main>`}X();var Ca="Clipline is a self-hosted clip library for saved gameplay moments.";function ut(e,t){return o`<div><dt>${e}</dt><dd>${t}</dd></div>`}function Ta(){let[e,t]=b(Ca);return S(()=>{let n=!0;return y("/api/v1/about").then(a=>n&&t(a.about_text||Ca)).catch(()=>{}),()=>{n=!1}},[]),o`<main class="page">
    <h1>About</h1>
  ...
  </main>`}var pr={publicLibrary:nt,publicGame:nt,games:Hn,library:Zn,clip:Dt,public:Dt,login:da,resetPassword:pa,admin:ga,profile:ka,account:Sa,publicUser:xa,about:Ta},Pa=En({pathname:window.location.pathname,search:window.location.search});function mr(){let e=Dn();Pa=e.name;let{ready:t,user:n}=q(N),a=t&&Pn(e.name,n);if(S(()=>{a&&G("/login")},[a]),!t||a)return o`<div class="boot">Loading…</div>`;let r=pr[e.name]||nt,s=e.name==="login"||e.name==="resetPassword";return o`<div class="ui" onClick=${Un}>
