var wa=Object.defineProperty;var ka=(e,t)=>()=>(e&&(t=e(e=0)),t);var xa=(e,t)=>{for(var n in t)wa(e,n,{get:t[n],enumerable:!0})};var an={};xa(an,{ApiError:()=>_e,api:()=>k,getCsrfToken:()=>_t,setCsrfToken:()=>ke});function ke(e){Oe=e}function _t(){return Oe}async function k(e,t={}){let n=(t.method||"GET").toUpperCase(),a=new Headers(t.headers||{});a.set("Accept","application/json");let o=t.body;o&&typeof o!="string"&&(a.set("Content-Type","application/json"),o=JSON.stringify(o)),!["GET","HEAD","OPTIONS"].includes(n)&&Oe&&a.set("X-CSRF-Token",Oe);let s=await fetch(e,{...t,body:o,credentials:"same-origin",headers:a,method:n}),c=(s.headers.get("content-type")||"").includes("application/json")?await s.json():await s.text();if(!s.ok){s.status===401&&window.dispatchEvent(new CustomEvent("clipline:unauthorized"));let d=typeof c=="object"&&c?.error?c.error:s.statusText;throw new _e(d||"Request failed",s.status)}return c}var Oe,_e,J=ka(()=>{Oe=null;_e=class extends Error{constructor(t,n){super(t),this.status=n}}});var ze,A,Ht,Ca,fe,zt,Vt,qt,it,De,we,Kt,ut,lt,ct,Sa,Ie={},Ae=[],Ta=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,Fe=Array.isArray;function de(e,t){for(var n in t)e[n]=t[n];return e}function dt(e){e&&e.parentNode&&e.parentNode.removeChild(e)}function pt(e,t,n){var a,o,s,i={};for(s in t)s=="key"?a=t[s]:s=="ref"?o=t[s]:i[s]=t[s];if(arguments.length>2&&(i.children=arguments.length>3?ze.call(arguments,2):n),typeof e=="function"&&e.defaultProps!=null)for(s in e.defaultProps)i[s]===void 0&&(i[s]=e.defaultProps[s]);return Ue(e,i,a,o,null)}function Ue(e,t,n,a,o){var s={type:e,props:t,key:n,ref:a,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:o??++Ht,__i:-1,__u:0};return o==null&&A.vnode!=null&&A.vnode(s),s}function Be(e){return e.children}function Le(e,t){this.props=e,this.context=t}function ve(e,t){if(t==null)return e.__?ve(e.__,e.__i+1):null;for(var n;t<e.__k.length;t++)if((n=e.__k[t])!=null&&n.__e!=null)return n.__e;return typeof e.type=="function"?ve(e):null}function Ma(e){if(e.__P&&e.__d){var t=e.__v,n=t.__e,a=[],o=[],s=de({},t);s.__v=t.__v+1,A.vnode&&A.vnode(s),mt(e.__P,s,t,e.__n,e.__P.namespaceURI,32&t.__u?[n]:null,a,n??ve(t),!!(32&t.__u),o),s.__v=t.__v,s.__.__k[s.__i]=s,Jt(a,s,o),t.__e=t.__=null,s.__e!=n&&Gt(s)}}function Gt(e){if((e=e.__)!=null&&e.__c!=null)return e.__e=e.__c.base=null,e.__k.some(function(t){if(t!=null&&t.__e!=null)return e.__e=e.__c.base=t.__e}),Gt(e)}function Ft(e){(!e.__d&&(e.__d=!0)&&fe.push(e)&&!Ne.__r++||zt!=A.debounceRendering)&&((zt=A.debounceRendering)||Vt)(Ne)}function Ne(){try{for(var e,t=1;fe.length;)fe.length>t&&fe.sort(qt),e=fe.shift(),t=fe.length,Ma(e)}finally{fe.length=Ne.__r=0}}function Wt(e,t,n,a,o,s,i,c,d,u,p){var h,l,m,v,g,w,x,y=a&&a.__k||Ae,P=t.length;for(d=Pa(n,t,y,d,P),h=0;h<P;h++)(m=n.__k[h])!=null&&(l=m.__i!=-1&&y[m.__i]||Ie,m.__i=h,w=mt(e,m,l,o,s,i,c,d,u,p),v=m.__e,m.ref&&l.ref!=m.ref&&(l.ref&&ft(l.ref,null,m),p.push(m.ref,m.__c||v,m)),g==null&&v!=null&&(g=v),(x=!!(4&m.__u))||l.__k===m.__k?(d=jt(m,d,e,x),x&&l.__e&&(l.__e=null)):typeof m.type=="function"&&w!==void 0?d=w:v&&(d=v.nextSibling),m.__u&=-7);return n.__e=g,d}function Pa(e,t,n,a,o){var s,i,c,d,u,p=n.length,h=p,l=0;for(e.__k=new Array(o),s=0;s<o;s++)(i=t[s])!=null&&typeof i!="boolean"&&typeof i!="function"?(typeof i=="string"||typeof i=="number"||typeof i=="bigint"||i.constructor==String?i=e.__k[s]=Ue(null,i,null,null,null):Fe(i)?i=e.__k[s]=Ue(Be,{children:i},null,null,null):i.constructor===void 0&&i.__b>0?i=e.__k[s]=Ue(i.type,i.props,i.key,i.ref?i.ref:null,i.__v):e.__k[s]=i,d=s+l,i.__=e,i.__b=e.__b+1,c=null,(u=i.__i=Ea(i,n,d,h))!=-1&&(h--,(c=n[u])&&(c.__u|=2)),c==null||c.__v==null?(u==-1&&(o>p?l--:o<p&&l++),typeof i.type!="function"&&(i.__u|=4)):u!=d&&(u==d-1?l--:u==d+1?l++:(u>d?l--:l++,i.__u|=4))):e.__k[s]=null;if(h)for(s=0;s<p;s++)(c=n[s])!=null&&(2&c.__u)==0&&(c.__e==a&&(a=ve(c)),Xt(c,c));return a}function jt(e,t,n,a){var o,s;if(typeof e.type=="function"){for(o=e.__k,s=0;o&&s<o.length;s++)o[s]&&(o[s].__=e,t=jt(o[s],t,n,a));return t}e.__e!=t&&(a&&(t&&e.type&&!t.parentNode&&(t=ve(e)),n.insertBefore(e.__e,t||null)),t=e.__e);do t=t&&t.nextSibling;while(t!=null&&t.nodeType==8);return t}function Ea(e,t,n,a){var o,s,i,c=e.key,d=e.type,u=t[n],p=u!=null&&(2&u.__u)==0;if(u===null&&c==null||p&&c==u.key&&d==u.type)return n;if(a>(p?1:0)){for(o=n-1,s=n+1;o>=0||s<t.length;)if((u=t[i=o>=0?o--:s++])!=null&&(2&u.__u)==0&&c==u.key&&d==u.type)return i}return-1}function Bt(e,t,n){t[0]=="-"?e.setProperty(t,n??""):e[t]=n==null?"":typeof n!="number"||Ta.test(t)?n:n+"px"}function Re(e,t,n,a,o){var s,i;e:if(t=="style")if(typeof n=="string")e.style.cssText=n;else{if(typeof a=="string"&&(e.style.cssText=a=""),a)for(t in a)n&&t in n||Bt(e.style,t,"");if(n)for(t in n)a&&n[t]==a[t]||Bt(e.style,t,n[t])}else if(t[0]=="o"&&t[1]=="n")s=t!=(t=t.replace(Kt,"$1")),i=t.toLowerCase(),t=i in e||t=="onFocusOut"||t=="onFocusIn"?i.slice(2):t.slice(2),e.l||(e.l={}),e.l[t+s]=n,n?a?n[we]=a[we]:(n[we]=ut,e.addEventListener(t,s?ct:lt,s)):e.removeEventListener(t,s?ct:lt,s);else{if(o=="http://www.w3.org/2000/svg")t=t.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(t!="width"&&t!="height"&&t!="href"&&t!="list"&&t!="form"&&t!="tabIndex"&&t!="download"&&t!="rowSpan"&&t!="colSpan"&&t!="role"&&t!="popover"&&t in e)try{e[t]=n??"";break e}catch{}typeof n=="function"||(n==null||n===!1&&t[4]!="-"?e.removeAttribute(t):e.setAttribute(t,t=="popover"&&n==1?"":n))}}function Ot(e){return function(t){if(this.l){var n=this.l[t.type+e];if(t[De]==null)t[De]=ut++;else if(t[De]<n[we])return;return n(A.event?A.event(t):t)}}}function mt(e,t,n,a,o,s,i,c,d,u){var p,h,l,m,v,g,w,x,y,P,I,K,Z,ae,ee,Q,z=t.type;if(t.constructor!==void 0)return null;128&n.__u&&(d=!!(32&n.__u),s=[c=t.__e=n.__e]),(p=A.__b)&&p(t);e:if(typeof z=="function"){h=i.length;try{if(y=t.props,P=z.prototype&&z.prototype.render,I=(p=z.contextType)&&a[p.__c],K=p?I?I.props.value:p.__:a,n.__c?x=(l=t.__c=n.__c).__=l.__E:(P?t.__c=l=new z(y,K):(t.__c=l=new Le(y,K),l.constructor=z,l.render=Da),I&&I.sub(l),l.state||(l.state={}),l.__n=a,m=l.__d=!0,l.__h=[],l._sb=[]),P&&l.__s==null&&(l.__s=l.state),P&&z.getDerivedStateFromProps!=null&&(l.__s==l.state&&(l.__s=de({},l.__s)),de(l.__s,z.getDerivedStateFromProps(y,l.__s))),v=l.props,g=l.state,l.__v=t,m)P&&z.getDerivedStateFromProps==null&&l.componentWillMount!=null&&l.componentWillMount(),P&&l.componentDidMount!=null&&l.__h.push(l.componentDidMount);else{if(P&&z.getDerivedStateFromProps==null&&y!==v&&l.componentWillReceiveProps!=null&&l.componentWillReceiveProps(y,K),t.__v==n.__v||!l.__e&&l.shouldComponentUpdate!=null&&l.shouldComponentUpdate(y,l.__s,K)===!1){t.__v!=n.__v&&(l.props=y,l.state=l.__s,l.__d=!1),t.__e=n.__e,t.__k=n.__k,t.__k.some(function(ne){ne&&(ne.__=t)}),Ae.push.apply(l.__h,l._sb),l._sb=[],l.__h.length&&i.push(l);break e}l.componentWillUpdate!=null&&l.componentWillUpdate(y,l.__s,K),P&&l.componentDidUpdate!=null&&l.__h.push(function(){l.componentDidUpdate(v,g,w)})}if(l.context=K,l.props=y,l.__P=e,l.__e=!1,Z=A.__r,ae=0,P)l.state=l.__s,l.__d=!1,Z&&Z(t),p=l.render(l.props,l.state,l.context),Ae.push.apply(l.__h,l._sb),l._sb=[];else do l.__d=!1,Z&&Z(t),p=l.render(l.props,l.state,l.context),l.state=l.__s;while(l.__d&&++ae<25);l.state=l.__s,l.getChildContext!=null&&(a=de(de({},a),l.getChildContext())),P&&!m&&l.getSnapshotBeforeUpdate!=null&&(w=l.getSnapshotBeforeUpdate(v,g)),ee=p!=null&&p.type===Be&&p.key==null?Yt(p.props.children):p,c=Wt(e,Fe(ee)?ee:[ee],t,n,a,o,s,i,c,d,u),l.base=t.__e,t.__u&=-161,l.__h.length&&i.push(l),x&&(l.__E=l.__=null)}catch(ne){if(i.length=h,t.__v=null,d||s!=null){if(ne.then){for(t.__u|=d?160:128;c&&c.nodeType==8&&c.nextSibling;)c=c.nextSibling;s!=null&&(s[s.indexOf(c)]=null),t.__e=c}else if(s!=null)for(Q=s.length;Q--;)dt(s[Q])}else t.__e=n.__e;t.__k==null&&(t.__k=n.__k||[]),ne.then||Zt(t),A.__e(ne,t,n)}}else s==null&&t.__v==n.__v?(t.__k=n.__k,t.__e=n.__e):c=t.__e=Ra(n.__e,t,n,a,o,s,i,d,u);return(p=A.diffed)&&p(t),128&t.__u?void 0:c}function Zt(e){e&&(e.__c&&(e.__c.__e=!0),e.__k&&e.__k.some(Zt))}function Jt(e,t,n){for(var a=0;a<n.length;a++)ft(n[a],n[++a],n[++a]);A.__c&&A.__c(t,e),e.some(function(o){try{e=o.__h,o.__h=[],e.some(function(s){s.call(o)})}catch(s){A.__e(s,o.__v)}})}function Yt(e){return typeof e!="object"||e==null||e.__b>0?e:Fe(e)?e.map(Yt):e.constructor!==void 0?null:de({},e)}function Ra(e,t,n,a,o,s,i,c,d){var u,p,h,l,m,v,g,w=n.props||Ie,x=t.props,y=t.type;if(y=="svg"?o="http://www.w3.org/2000/svg":y=="math"?o="http://www.w3.org/1998/Math/MathML":o||(o="http://www.w3.org/1999/xhtml"),s!=null){for(u=0;u<s.length;u++)if((m=s[u])&&"setAttribute"in m==!!y&&(y?m.localName==y:m.nodeType==3)){e=m,s[u]=null;break}}if(e==null){if(y==null)return document.createTextNode(x);e=document.createElementNS(o,y,x.is&&x),c&&(A.__m&&A.__m(t,s),c=!1),s=null}if(y==null)w===x||c&&e.data==x||(e.data=x);else{if(s=y=="textarea"&&x.defaultValue!=null?null:s&&ze.call(e.childNodes),!c&&s!=null)for(w={},u=0;u<e.attributes.length;u++)w[(m=e.attributes[u]).name]=m.value;for(u in w)m=w[u],u=="dangerouslySetInnerHTML"?h=m:u=="children"||u in x||u=="value"&&"defaultValue"in x||u=="checked"&&"defaultChecked"in x||Re(e,u,null,m,o);for(u in x)m=x[u],u=="children"?l=m:u=="dangerouslySetInnerHTML"?p=m:u=="value"?v=m:u=="checked"?g=m:c&&typeof m!="function"||w[u]===m||Re(e,u,m,w[u],o);if(p)c||h&&(p.__html==h.__html||p.__html==e.innerHTML)||(e.innerHTML=p.__html),t.__k=[];else if(h&&(e.innerHTML=""),Wt(t.type=="template"?e.content:e,Fe(l)?l:[l],t,n,a,y=="foreignObject"?"http://www.w3.org/1999/xhtml":o,s,i,s?s[0]:n.__k&&ve(n,0),c,d),s!=null)for(u=s.length;u--;)dt(s[u]);c&&y!="textarea"||(u="value",y=="progress"&&v==null?e.removeAttribute("value"):v!=null&&(v!==e[u]||y=="progress"&&!v||y=="option"&&v!=w[u])&&Re(e,u,v,w[u],o),u="checked",g!=null&&g!=e[u]&&Re(e,u,g,w[u],o))}return e}function ft(e,t,n){try{if(typeof e=="function"){var a=typeof e.__u=="function";a&&e.__u(),a&&t==null||(e.__u=e(t))}else e.current=t}catch(o){A.__e(o,n)}}function Xt(e,t,n){var a,o;if(A.unmount&&A.unmount(e),(a=e.ref)&&(a.current&&a.current!=e.__e||ft(a,null,t)),(a=e.__c)!=null){if(a.componentWillUnmount)try{a.componentWillUnmount()}catch(s){A.__e(s,t)}a.base=a.__P=a.__n=null}if(a=e.__k)for(o=0;o<a.length;o++)a[o]&&Xt(a[o],t,n||typeof e.type!="function");n||dt(e.__e),e.__c=e.__=e.__e=void 0}function Da(e,t,n){return this.constructor(e,n)}function Qt(e,t,n){var a,o,s,i;t==document&&(t=document.documentElement),A.__&&A.__(e,t),o=(a=typeof n=="function")?null:n&&n.__k||t.__k,s=[],i=[],mt(t,e=(!a&&n||t).__k=pt(Be,null,[e]),o||Ie,Ie,t.namespaceURI,!a&&n?[n]:o?null:t.firstChild?ze.call(t.childNodes):null,s,!a&&n?n:o?o.__e:t.firstChild,a,i),Jt(s,e,i),e.props.children=null}ze=Ae.slice,A={__e:function(e,t,n,a){for(var o,s,i;t=t.__;)if((o=t.__c)&&!o.__)try{if((s=o.constructor)&&s.getDerivedStateFromError!=null&&(o.setState(s.getDerivedStateFromError(e)),i=o.__d),o.componentDidCatch!=null&&(o.componentDidCatch(e,a||{}),i=o.__d),i)return o.__E=o}catch(c){e=c}throw e}},Ht=0,Ca=function(e){return e!=null&&e.constructor===void 0},Le.prototype.setState=function(e,t){var n;n=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=de({},this.state),typeof e=="function"&&(e=e(de({},n),this.props)),e&&de(n,e),e!=null&&this.__v&&(t&&this._sb.push(t),Ft(this))},Le.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),Ft(this))},Le.prototype.render=Be,fe=[],Vt=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,qt=function(e,t){return e.__v.__b-t.__v.__b},Ne.__r=0,it=Math.random().toString(8),De="__d"+it,we="__a"+it,Kt=/(PointerCapture)$|Capture$/i,ut=0,lt=Ot(!1),ct=Ot(!0),Sa=0;var tn=function(e,t,n,a){var o;t[0]=0;for(var s=1;s<t.length;s++){var i=t[s++],c=t[s]?(t[0]|=i?1:2,n[t[s++]]):t[++s];i===3?a[0]=c:i===4?a[1]=Object.assign(a[1]||{},c):i===5?(a[1]=a[1]||{})[t[++s]]=c:i===6?a[1][t[++s]]+=c+"":i?(o=e.apply(c,tn(e,c,n,["",null])),a.push(o),c[0]?t[0]|=2:(t[s-2]=0,t[s]=o)):a.push(c)}return a},en=new Map;function nn(e){var t=en.get(this);return t||(t=new Map,en.set(this,t)),(t=tn(this,t.get(e)||(t.set(e,t=(function(n){for(var a,o,s=1,i="",c="",d=[0],u=function(l){s===1&&(l||(i=i.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?d.push(0,l,i):s===3&&(l||i)?(d.push(3,l,i),s=2):s===2&&i==="..."&&l?d.push(4,l,0):s===2&&i&&!l?d.push(5,0,!0,i):s>=5&&((i||!l&&s===5)&&(d.push(s,0,i,o),s=6),l&&(d.push(s,l,0,o),s=6)),i=""},p=0;p<n.length;p++){p&&(s===1&&u(),u(p));for(var h=0;h<n[p].length;h++)a=n[p][h],s===1?a==="<"?(u(),d=[d],s=3):i+=a:s===4?i==="--"&&a===">"?(s=1,i=""):i=a+i[0]:c?a===c?c="":i+=a:a==='"'||a==="'"?c=a:a===">"?(u(),s=1):s&&(a==="="?(s=5,o=i,i=""):a==="/"&&(s<5||n[p][h+1]===">")?(u(),s===3&&(d=d[0]),s=d,(d=d[0]).push(2,0,s),s=0):a===" "||a==="	"||a===`
`||a==="\r"?(u(),s=2):i+=a),s===3&&i==="!--"&&(s=4,d=d[0])}return u(),d})(e)),t),arguments,[])).length>1?t:t[0]}var r=nn.bind(pt);J();var xe,O,ht,sn,He=0,fn=[],V=A,on=V.__b,rn=V.__r,ln=V.diffed,cn=V.__c,un=V.unmount,dn=V.__;function vt(e,t){V.__h&&V.__h(O,e,He||t),He=0;var n=O.__H||(O.__H={__:[],__h:[]});return e>=n.__.length&&n.__.push({}),n.__[e]}function f(e){return He=1,Ua(bn,e)}function Ua(e,t,n){var a=vt(xe++,2);if(a.t=e,!a.__c&&(a.__=[n?n(t):bn(void 0,t),function(c){var d=a.__N?a.__N[0]:a.__[0],u=a.t(d,c);d!==u&&(a.__N=[u,a.__[1]],a.__c.setState({}))}],a.__c=O,!O.__f)){var o=function(c,d,u){if(!a.__c.__H)return!0;var p=!1,h=a.__c.props!==c;if(a.__c.__H.__.some(function(m){if(m.__N){p=!0;var v=m.__[0];m.__=m.__N,m.__N=void 0,v!==m.__[0]&&(h=!0)}}),s){var l=s.call(this,c,d,u);return p?l||h:l}return!p||h};O.__f=!0;var s=O.shouldComponentUpdate,i=O.componentWillUpdate;O.componentWillUpdate=function(c,d,u){if(this.__e){var p=s;s=void 0,o(c,d,u),s=p}i&&i.call(this,c,d,u)},O.shouldComponentUpdate=o}return a.__N||a.__}function T(e,t){var n=vt(xe++,3);!V.__s&&hn(n.__H,t)&&(n.__=e,n.u=t,O.__H.__h.push(n))}function F(e){return He=5,La(function(){return{current:e}},[])}function La(e,t){var n=vt(xe++,7);return hn(n.__H,t)&&(n.__=e(),n.__H=t,n.__h=e),n.__}function pn(){for(var e;e=fn.shift();){var t=e.__H;if(e.__P&&t)try{t.__h.some(bt),t.__h.some(_n),t.__h=[]}catch(n){t.__h=[],V.__e(n,e.__v)}}}V.__b=function(e){O=null,on&&on(e)},V.__=function(e,t){e&&t.__k&&t.__k.__m&&(e.__m=t.__k.__m),dn&&dn(e,t)},V.__r=function(e){rn&&rn(e),xe=0;var t=(O=e.__c).__H;t&&(ht===O?(t.__h=[],O.__h=[],t.__.some(function(n){n.__N&&(n.__=n.__N),n.u=n.__N=void 0})):(t.__h.length&&pn(),xe=0)),ht=O},V.diffed=function(e){ln&&ln(e);var t=e.__c;t&&t.__H&&(t.__H.__h.length&&(fn.push(t)!==1&&sn===V.requestAnimationFrame||((sn=V.requestAnimationFrame)||Ia)(pn)),t.__H.__.some(function(n){n.u&&(n.__H=n.u,n.u=void 0)})),ht=O=null},V.__c=function(e,t){t.some(function(n){try{n.__h.some(bt),n.__h=n.__h.filter(function(a){return!a.__||_n(a)})}catch(a){t.some(function(o){o.__h&&(o.__h=[])}),t=[],V.__e(a,n.__v)}}),cn&&cn(e,t)},V.unmount=function(e){un&&un(e);var t,n=e.__c;n&&n.__H&&(n.__H.__.some(function(a){try{bt(a)}catch(o){t=o}}),n.__H=void 0,t&&V.__e(t,n.__v))};var mn=typeof requestAnimationFrame=="function";function Ia(e){var t,n=function(){clearTimeout(a),mn&&cancelAnimationFrame(t),setTimeout(e)},a=setTimeout(n,35);mn&&(t=requestAnimationFrame(n))}function bt(e){var t=O,n=e.__c;typeof n=="function"&&(e.__c=void 0,n()),O=t}function _n(e){var t=O;e.__c=e.__(),O=t}function hn(e,t){return!e||e.length!==t.length||t.some(function(n,a){return n!==e[a]})}function bn(e,t){return typeof t=="function"?t(e):t}function vn(e){let t=e,n=new Set;return{get:()=>t,set(a){t=a,n.forEach(o=>o(t))},update(a){this.set(a(t))},subscribe(a){return n.add(a),()=>n.delete(a)}}}function j(e){let[t,n]=f(e.get());return T(()=>e.subscribe(n),[e]),t}var N=vn({user:null,csrfToken:null,ready:!1}),Ve=vn([]),Aa=0;function C(e,{actionLabel:t,onAction:n,timeoutMs:a=5e3}={}){let o=++Aa;return Ve.update(s=>[...s,{id:o,message:e,actionLabel:t,onAction:n}]),a&&setTimeout(()=>qe(o),a),o}function qe(e){Ve.update(t=>t.filter(n=>n.id!==e))}function Ke(e){try{return decodeURIComponent(e)}catch{return e}}function $n(e){let t=Number(e.get("page")||1);return{sort:e.get("sort")||"uploaded_at_desc",game:e.get("game")||"",q:e.get("q")||"",page:Number.isFinite(t)?Math.max(1,t):1}}var Na=["login","resetPassword","public","publicLibrary","publicGame","publicUser","about","games"];function gn(e){return Na.includes(e)}function Ge(e,t){let n=new URLSearchParams(t||""),a=e;return a.startsWith("/c/")?{name:"public",shareId:Ke(a.slice(3))}:a==="/"||a==="/public"||a==="/search"?{name:"publicLibrary",query:$n(n)}:a.startsWith("/game/")?{name:"publicGame",game:Ke(a.slice(6)),query:$n(n)}:a==="/about"?{name:"about"}:a==="/games"?{name:"games"}:a.startsWith("/u/")?{name:"publicUser",username:Ke(a.slice(3))}:a==="/library"?{name:"library"}:a.startsWith("/clip/")?{name:"clip",clipId:Ke(a.slice(6))}:a==="/admin"?{name:"admin",tab:n.get("tab")||"overview"}:a==="/account"?{name:"account"}:a==="/profile"?{name:"profile"}:a==="/login"?{name:"login"}:a==="/reset-password"?{name:"resetPassword",token:n.get("token")||"",invite:n.get("invite")==="1"}:{name:"publicLibrary"}}var yn=()=>window.location.pathname==="/preview.html";function za(e){let t=e.slice(1)||"/",[n,a=""]=t.split("?");return{pathname:n,search:a?`?${a}`:""}}function We(){return yn()?za(window.location.hash):{pathname:window.location.pathname,search:window.location.search}}function wn(e){return Ge(e.pathname,e.search).name}var $t=new Set;function Y(e){yn()?window.location.hash=e:window.history.pushState({},"",e),gt()}function gt(){let{pathname:e,search:t}=We(),n=Ge(e,t);$t.forEach(a=>a(n))}window.addEventListener("popstate",gt);window.addEventListener("hashchange",gt);function kn(){let{pathname:e,search:t}=We(),[n,a]=f(()=>Ge(e,t));return T(()=>($t.add(a),()=>$t.delete(a)),[]),n}function xn(e){let t=e.target.closest("a[href^='/']");!t||t.target||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),Y(t.getAttribute("href")))}var Cn={alert:'<path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>',clipboard:'<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>',copy:'<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',external:'<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',edit:'<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/>',fastForward:'<path d="m13 19 9-7-9-7v14Z"/><path d="m2 19 9-7-9-7v14Z"/>',film:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M17 3v18"/><path d="M3 8h4"/><path d="M3 16h4"/><path d="M17 8h4"/><path d="M17 16h4"/>',fullscreen:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/>',home:'<path d="m3 10 9-7 9 7"/><path d="M5 8.5V20a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.5"/><path d="M9 22V12h6v10"/>',info:'<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',logOut:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/>',menu:'<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h16"/>',message:'<path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"/>',notepad:'<path d="M8 2v4"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M6 4h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><path d="M8 14h8"/><path d="M8 18h5"/>',pause:'<path d="M8 5v14"/><path d="M16 5v14"/>',play:'<path d="m8 5 11 7-11 7V5Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',refresh:'<path d="M21 12a9 9 0 0 1-15.5 6.3L3 16"/><path d="M3 21v-5h5"/><path d="M3 12A9 9 0 0 1 18.5 5.7L21 8"/><path d="M21 3v5h-5"/>',rewind:'<path d="m11 19-9-7 9-7v14Z"/><path d="m22 19-9-7 9-7v14Z"/>',save:'<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2Z"/><path d="M17 21v-8H7v8"/><path d="M7 3v5h8"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',server:'<rect width="20" height="8" x="2" y="2" rx="2"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 6h.01"/><path d="M6 18h.01"/>',skipBack:'<path d="M19 20 9 12l10-8v16Z"/><path d="M5 19V5"/>',skipForward:'<path d="m5 4 10 8-10 8V4Z"/><path d="M19 5v14"/>',shield:'<path d="M20 13c0 5-3.5 7.5-7.7 8.8a1 1 0 0 1-.6 0C7.5 20.5 4 18 4 13V5l8-3 8 3v8Z"/>',sliders:'<path d="M4 21v-7"/><path d="M4 10V3"/><path d="M12 21v-9"/><path d="M12 8V3"/><path d="M20 21v-5"/><path d="M20 12V3"/><path d="M2 14h4"/><path d="M10 8h4"/><path d="M18 16h4"/>',theater:'<rect width="20" height="14" x="2" y="5" rx="2"/><path d="M6 9h12"/><path d="M6 15h12"/>',trash:'<path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m17 8-5-5-5 5"/><path d="M12 3v12"/>',user:'<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.9"/><path d="M16 3.1a4 4 0 0 1 0 7.8"/>',volume2:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9 9 0 0 1 0 14"/>',volumeX:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>'};function M(e,{size:t=18}={}){return r`<svg viewBox="0 0 24 24" width=${t} height=${t} fill="none"
    stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"
    aria-hidden="true" dangerouslySetInnerHTML=${{__html:Cn[e]||""}} />`}function Sn({active:e}){let{user:t}=j(N),[n,a]=f(!1),o=F(null),s=t?.role==="admin"||t?.role==="owner";T(()=>{if(!n)return;let d=p=>{o.current?.contains(p.target)||a(!1)},u=p=>{p.key==="Escape"&&a(!1)};return document.addEventListener("pointerdown",d),document.addEventListener("keydown",u),()=>{document.removeEventListener("pointerdown",d),document.removeEventListener("keydown",u)}},[n]);let i=[["feed","/","Feed"],["library","/library","Library",!!t],["games","/games","Games"],["admin","/admin","Admin",s]].filter(([,,,d])=>d!==!1),c=d=>{d.preventDefault();let u=new FormData(d.target).get("q")?.toString().trim();Y(u?`/search?q=${encodeURIComponent(u)}`:"/search")};return r`<header class="topbar">
  ...
  </header>`}async function Fa(){let{api:e}=await Promise.resolve().then(()=>(J(),an));try{await e("/api/v1/auth/logout",{method:"POST"})}catch{}N.set({user:null,csrfToken:null,ready:!0}),Y("/login")}function Tn({active:e}){return r`<nav class="tabbar" aria-label="Primary">
  ...
  </nav>`}function Mn(){let e=j(Ve);return r`<div class="toasts" role="status" aria-live="polite">
  ...
  </span>`}function yt(e){return e.owner?.display_name||e.owner?.username||e.owner_username||e.author_name||e.author_username||null}function $e({clip:e,href:t,selectable:n=!1,selected:a=!1,onToggleSelect:o,showVisibility:s=!1,showAuthor:i=!1}){let c=yt(e),d=[e.game_name&&r`<em>${e.game_name}</em>`,i&&c,e.view_count!=null&&be(e.view_count),e.uploaded_at&&je(e.uploaded_at)].filter(Boolean);return r`<article class=${`clip-card ${a?"is-selected":""} ${n?"is-selectable":""}`}>
    ...
    ${n&&r`<p>${n}</p>`}
    ${a}
  </div>`}var Oa=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],Ha=6;function kt({route:e}){let t={sort:"uploaded_at_desc",page:1,q:"",...e.query,game:e.name==="publicGame"?e.game:e.query?.game||""},[n,a]=f(null),[o,s]=f([]),[i,c]=f(null);T(()=>{let g=!0;a(null),c(null);let w=new URLSearchParams;return t.sort!=="uploaded_at_desc"&&w.set("sort",t.sort),t.game&&w.set("game",t.game),t.q&&w.set("q",t.q),Number(t.page)>1&&w.set("page",String(t.page)),k(`/api/v1/public/clips${w.size?`?${w}`:""}`).then(x=>g&&a(x)).catch(x=>g&&c(x)),()=>{g=!1}},[e.name,t.sort,t.game,t.q,t.page]),T(()=>{let g=!0;return k("/api/v1/public/games").then(w=>g&&s(w.games||[])).catch(()=>{}),()=>{g=!1}},[]);let d=g=>Y(Ka({...t,page:1,...g}));if(i)return r`<main class="page">
      <${W} name="alert" title="Couldn't load the feed" body=${i.message} />
    </main>`;let u=n?.clips,p=!!(t.game||t.q)||Number(t.page)>1,h=!p,l=[...o].sort((g,w)=>(w.clip_count||0)-(g.clip_count||0)),m=l.slice(0,Ha),v=l.length-m.length;return r`<main class="page">
    ${u==null?r`<${qa} />`:u.length===0?r`<${W} name="film"
        ...
        <div class="feed-toolbar">
          ...
          <select class="input" value=${t.sort} onChange=${g=>d({sort:g.target.value})}>
            ${Oa.map(([g,w])=>r`<option value=${g}>${w}</option>`)}
          </select>
          <div class="chips">
        ...
        <div class="card-grid">
          ${(h?u.slice(4):u).map(g=>r`<${$e} clip=${{...g,thumbnail_url:se(g)}}
              href=${wt(g)} showAuthor />`)}
        </div>
        ${Ga(n,t,d)}
      `}
  </main>`}function Va(e){let[t,...n]=e,a=n.slice(0,3);return r`<p class="kicker">Now playing on this server</p>
    <section class="hero">
      <a class="hero-main" href=${wt(t)}>
        <img src=${se(t)} alt="" loading="lazy" />
        <span class="hero-caption">▶ ${t.title} — ${t.game_name} · ${he(t.duration_ms)}</span>
      </a>
      <div class="hero-side">
        ${a.map(o=>r`<a class="hero-row" href=${wt(o)}>
            <img src=${se(o)} alt="" loading="lazy" />
            <span><b>${o.title}</b>
              <small>${yt(o)} · ${o.game_name} · ${be(o.view_count)}</small></span>
          </a>`)}
      </div>
    </section>`}function qa({count:e=8}){return r`<div class="card-grid">
    ${Array.from({length:e},(t,n)=>r`<div class="clip-card" key=${n}>
      <div class="skeleton-thumb"></div>
      <div class="skeleton-line"></div>
      <div class="skeleton-line is-short"></div>
    </div>`)}
  </div>`}function wt(e){return`/c/${encodeURIComponent(e.share_id)}`}function Ka({sort:e="uploaded_at_desc",game:t="",q:n="",page:a=1}={}){let o=new URLSearchParams,s=e||"uploaded_at_desc",i=String(t||"").trim(),c=String(n||"").trim(),d=Math.max(1,Number(a||1));if(s!=="uploaded_at_desc"&&o.set("sort",s),d>1&&o.set("page",String(d)),c)return o.set("q",c),i&&o.set("game",i),`/search?${o.toString()}`;if(i){let p=o.toString();return`/game/${encodeURIComponent(i)}${p?`?${p}`:""}`}let u=o.toString();return u?`/search?${u}`:"/"}function Ga(e,t,n){let a=Math.max(1,Number(t.page||1)),o=!!e?.has_more;return a<=1&&!o?"":r`<nav class="pager" aria-label="Public clip pages">
  ...
  </nav>`}J();function Un(){let[e,t]=f(null),[n,a]=f(null);return T(()=>{let o=!0;return k("/api/v1/public/games").then(s=>o&&t(s.games||[])).catch(s=>o&&a(s)),()=>{o=!1}},[]),n?r`<main class="page">
  ...
  </dialog>`}var Nn="clipline.libraryView",Wa=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["updated_at_desc","Updated newest"],["updated_at_asc","Updated oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["size_desc","Size largest"],["size_asc","Size smallest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],Ye={title:["title_asc","title_desc"],size:["size_asc","size_desc"],duration:["duration_asc","duration_desc"],uploaded:["uploaded_at_asc","uploaded_at_desc"]},ja=["visibility","status","source_type","from","to","min_duration_seconds","max_duration_seconds","min_size_mib","max_size_mib"],et={sort:"uploaded_at_desc",game:"",source_type:"",visibility:"",status:"",q:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""};function Xe(e){if(e===""||e==null)return null;let t=Number(e);return Number.isFinite(t)?t:null}function Za(e){let t=new URLSearchParams;t.set("sort",e.sort||et.sort),t.set("page_size","100");for(let i of["game","source_type","visibility","status","q"])e[i]&&t.set(i,e[i]);e.from&&t.set("from",`${e.from}T00:00:00Z`),e.to&&t.set("to",`${e.to}T23:59:59Z`);let n=Xe(e.min_duration_seconds);n!=null&&t.set("min_duration_ms",String(Math.round(n*1e3)));let a=Xe(e.max_duration_seconds);a!=null&&t.set("max_duration_ms",String(Math.round(a*1e3)));let o=Xe(e.min_size_mib);o!=null&&t.set("min_size_bytes",String(Math.round(o*1024*1024)));let s=Xe(e.max_size_mib);return s!=null&&t.set("max_size_bytes",String(Math.round(s*1024*1024))),t}function Ja(e){return ja.reduce((t,n)=>t+(e[n]?1:0),0)}function Ya(e,t=6){let n=new Map;for(let a of e){let o=a.game_name;o&&n.set(o,(n.get(o)||0)+1)}return Array.from(n,([a,o])=>({game:a,count:o})).sort((a,o)=>o.count-a.count||a.game.localeCompare(o.game)).slice(0,t)}async function An(e,t,n){let a=0;async function o(){let s=a++;if(!(s>=e.length))return await n(e[s]),o()}await Promise.all(Array.from({length:Math.min(t,e.length)},o))}function Xa(){try{return localStorage.getItem(Nn)==="rows"?"rows":"grid"}catch{return"grid"}}function zn(){let[e,t]=f(Xa),[n,a]=f(et),[o,s]=f(et.q),[i,c]=f(null),[d,u]=f(null),[p,h]=f(new Set),[l,m]=f(!1),[v,g]=f(0),w=F(null);T(()=>()=>clearTimeout(w.current),[]),T(()=>{let $=!0;return c(null),u(null),k(`/api/v1/clips?${Za(n)}`).then(S=>{$&&(c(S),h(new Set))}).catch(S=>$&&u(S)),()=>{$=!1}},[JSON.stringify(n),v]);let x=$=>{t($);try{localStorage.setItem(Nn,$)}catch{}},y=()=>g($=>$+1),P=$=>{let S=$.target.value;s(S),clearTimeout(w.current),w.current=setTimeout(()=>{a(D=>({...D,q:S}))},300)},I=$=>S=>{let D=S.target.value;a(U=>({...U,[$]:D}))},K=()=>{a($=>({...$,visibility:"",status:"",source_type:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""}))},Z=$=>a(S=>({...S,game:S.game===$?"":$})),ae=$=>a(S=>({...S,sort:$})),ee=$=>{h(S=>{let D=new Set(S);return D.has($)?D.delete($):D.add($),D})};function Q($,S){c(D=>D&&{...D,clips:D.clips.map(U=>U.id===$?{...U,...S}:U)})}function z($,S){let D=new Set($);c(U=>U&&{...U,clips:U.clips.map(b=>D.has(b.id)?{...b,...S}:b)})}async function ne($){let S=Array.from(p);if(!S.length)return;let D=i?.clips||[],U=new Map(S.map(E=>[E,D.find(H=>H.id===E)]));z(S,{visibility:$});let b=[];if(await An(S,4,async E=>{try{let H=await k(`/api/v1/clips/${encodeURIComponent(E)}/visibility`,{method:"POST",body:{visibility:$}});Q(E,{visibility:H.visibility,public_url:H.public_url})}catch(H){b.push({id:E,message:H.message})}}),b.length){for(let{id:E}of b){let H=U.get(E);H&&Q(E,{visibility:H.visibility,public_url:H.public_url})}C(b.length===S.length?b[0].message||"Couldn't update visibility.":`Couldn't update ${b.length} of ${S.length} clips.`)}let R=S.filter(E=>!b.some(H=>H.id===E));R.length&&(h(new Set),C(`Made ${R.length} clip${R.length===1?"":"s"} ${$}`,{actionLabel:"Undo",onAction:()=>ye(R,U)}))}async function ye($,S){for(let D of $){let U=S.get(D);U&&Q(D,{visibility:U.visibility,public_url:U.public_url})}await An($,4,async D=>{let U=S.get(D);if(U)try{await k(`/api/v1/clips/${encodeURIComponent(D)}/visibility`,{method:"POST",body:{visibility:U.visibility}})}catch{}})}async function ie(){let $=Array.from(p),S=i?.clips||[],D=$.map(R=>S.find(E=>E.id===R)).filter(Boolean),U=D.filter(R=>R.public_url),b=D.length-U.length;if(!U.length){C("No links to copy \u2014 selected clips are private.");return}try{await navigator.clipboard.writeText(U.map(R=>R.public_url).join(`
`)),C(`Copied ${U.length} link${U.length===1?"":"s"}`+(b?` (${b} skipped, private)`:""))}catch{C("Couldn't copy links to clipboard.")}}async function le(){let $=Array.from(p);m(!1);try{let S=await k("/api/v1/clips/bulk-delete",{method:"POST",body:{ids:$}});h(new Set),y(),C(`Deleted ${S.affected} clip${S.affected===1?"":"s"}.`)}catch(S){C(S.message)}}if(d)return r`<main class="page">
    ...
    </main>`;let te=i?.clips,pe=Ja(n),ce=!!(n.q||n.game)||pe>0,oe=Ya(te||[]),ue=(te||[]).reduce(($,S)=>$+(S.file_size_bytes||0),0),me=r`<div class="popover-fields">
    <label class="field"><span>Visibility</span>
      <select class="input" value=${n.visibility} onChange=${I("visibility")}>
    ...
    <label class="field"><span>Status</span>
      <select class="input" value=${n.status} onChange=${I("status")}>
        <option value="">Any</option>
    ...
    <label class="field"><span>Source</span>
      <input class="input" type="text" value=${n.source_type} onInput=${I("source_type")} placeholder="Source type" />
    </label>
    <label class="field"><span>From</span>
      <input class="input" type="date" value=${n.from} onInput=${I("from")} />
    </label>
    <label class="field"><span>To</span>
      <input class="input" type="date" value=${n.to} onInput=${I("to")} />
    </label>
    <label class="field"><span>Min duration (s)</span>
      <input class="input" type="number" min="0" value=${n.min_duration_seconds} onInput=${I("min_duration_seconds")} />
    </label>
    <label class="field"><span>Max duration (s)</span>
      <input class="input" type="number" min="0" value=${n.max_duration_seconds} onInput=${I("max_duration_seconds")} />
    </label>
    <label class="field"><span>Min size (MiB)</span>
      <input class="input" type="number" min="0" step="0.1" value=${n.min_size_mib} onInput=${I("min_size_mib")} />
    </label>
    <label class="field"><span>Max size (MiB)</span>
      <input class="input" type="number" min="0" step="0.1" value=${n.max_size_mib} onInput=${I("max_size_mib")} />
    </label>
    ...
    <div class="lib-toolbar">
      ...
      <select class="input" aria-label="Sort" value=${n.sort} onChange=${$=>ae($.target.value)}>
        ${Wa.map(([$,S])=>r`<option value=${$}>${S}</option>`)}
      </select>
      <${Ln}
        label="Filters"
    ...
    ${te==null?r`<${es} />`:te.length===0?ce?r`<${W} name="film" title="No clips match this view"
    ...
    <${re} open=${l}
      ...
      onConfirm=${le}
      onCancel=${()=>m(!1)} />
  </main>`}function Qe(e,[t,n]){let a=e.sort===t?"ascending":e.sort===n?"descending":"none",o=e.sort===n?t:n;return{ariaSort:a,next:o}}function Qa({clips:e,query:t,onSort:n}){let a=Qe(t,Ye.title),o=Qe(t,Ye.size),s=Qe(t,Ye.duration),i=Qe(t,Ye.uploaded);return r`<table class="lib-table">
    <thead>
      <tr>
        <th></th>
  ...
  </table>`}function es({count:e=8}){return r`<div class="card-grid">
    ${Array.from({length:e},(t,n)=>r`<div class="clip-card" key=${n}>
      <div class="skeleton-thumb"></div>
      <div class="skeleton-line"></div>
      <div class="skeleton-line is-short"></div>
    </div>`)}
  </div>`}J();var ts={ChampionKill:"kill",FirstBlood:"kill",Multikill:"spree",Ace:"spree",DragonKill:"objective",HeraldKill:"objective",BaronKill:"objective",TurretKilled:"structure",InhibKilled:"structure",FirstBrick:"structure"};function Bn(e){let t=Number(e);return Number.isFinite(t)&&t>0?t/1e3:0}function On(e,t){let n=Number.isFinite(e)?e:0,a=t>0?t:Number.MAX_SAFE_INTEGER;return Math.max(0,Math.min(a,n))}function tt(e,t){return t>0?Math.max(0,Math.min(100,e/t*100)):0}function xt(e){if(!Number.isFinite(e))return"0:00";let t=Math.max(0,Math.round(e)),n=Math.floor(t/60),a=t-n*60;return`${n}:${String(a).padStart(2,"0")}`}function Fn(e){if(!Number.isFinite(e))return"0:00.0";let t=Math.max(0,Math.round(e*10)),n=Math.floor(t/600),a=t-n*600,o=Math.floor(a/10);return`${n}:${String(o).padStart(2,"0")}.${a%10}`}function Hn(e,t){return`${Fn(e)} / ${t>0?Fn(t):"0:00.0"}`}function ns(e){return ts[e]||"info"}function Vn(e,t){return(e||[]).map((n,a)=>{let o=Number(n.timestamp_ms);if(!Number.isFinite(o))return null;let s=o/1e3;return s<0||t>0&&s>t?null:{index:a,time:s,kind:String(n.kind||"Marker"),label:String(n.label||n.kind||"Marker"),category:ns(n.kind)}}).filter(Boolean).sort((n,a)=>n.time-a.time)}function qn(e,t){if(!e.length)return null;for(let n of e)if(n.time>t+.05)return n;return e[0]}function Kn(e,t){if(!e.length)return null;for(let n=e.length-1;n>=0;n-=1)if(e[n].time<t-.05)return e[n];return e[e.length-1]}function Gn(e,t){switch(e){case"Space":case"KeyK":return{kind:"toggle-play"};case"ArrowLeft":return{kind:"seek-by",seconds:t?-1:-5};case"ArrowRight":return{kind:"seek-by",seconds:t?1:5};case"KeyJ":return{kind:"seek-by",seconds:-10};case"KeyL":return{kind:"seek-by",seconds:10};case"Comma":return{kind:"seek-by",seconds:-.1};case"Period":return{kind:"seek-by",seconds:.1};case"KeyM":return{kind:t?"previous-marker":"next-marker"};case"Home":return{kind:"seek-to",seconds:0};case"End":return{kind:"seek-to-end"};case"KeyF":return{kind:"fullscreen"};case"KeyT":return{kind:"theater"};default:return null}}var jn="clipline.playerVolume",Zn="clipline.clipTheaterMode",as=2e3,ss=[.25,.5,.75,1,1.25,1.5,2];function os(e,t){switch(e){case"KeyM":return{kind:"toggle-mute"};case"KeyF":return{kind:"theater"};case"Escape":return{kind:"exit-theater"};default:return Gn(e,t)}}function rs(e){return e instanceof Element?!!e.closest("input, textarea, select, button, a, [contenteditable='true'], [contenteditable='']"):!1}function is(){try{let e=window.localStorage.getItem(jn);if(e==null)return 1;let t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(1,t)):1}catch{return 1}}function Wn(e){try{window.localStorage.setItem(jn,String(Math.max(0,Math.min(1,e))))}catch{}}function ls(){try{return window.localStorage.getItem(Zn)==="true"}catch{return!1}}function cs(e){try{window.localStorage.setItem(Zn,String(e))}catch{}}function Jn({src:e,poster:t,durationMs:n,markers:a}){let o=F(null),s=F(null),i=F(null),c=F(!1),d=F(!1),u=Bn(n),[p,h]=f(!1),[l,m]=f(0),[v,g]=f(u),[w,x]=f(0),[y,P]=f(is),[I,K]=f(!1),[Z,ae]=f(1),[ee,Q]=f(!1),[z,ne]=f(ls),[ye,ie]=f(!0),[le,te]=f(null),[pe,ce]=f(""),oe=Vn(a,v);function ue(){ie(!0),window.clearTimeout(i.current),i.current=window.setTimeout(()=>{let _=o.current;_&&!_.paused&&!_.ended&&ie(!1)},as)}T(()=>{p||(window.clearTimeout(i.current),ie(!0))},[p]),T(()=>{let _=o.current;if(!_)return;let L=()=>Number.isFinite(_.duration)&&_.duration>0?_.duration:u,B=()=>g(L()),Mt=()=>g(L()),Pt=()=>{c.current||m(_.currentTime||0)},Et=()=>{let At=L();if(!(At>0)||!_.buffered?.length){x(0);return}let Nt=_.currentTime||0,Pe=0;for(let Ee=0;Ee<_.buffered.length;Ee+=1){let ya=_.buffered.start(Ee),rt=_.buffered.end(Ee);if(Nt>=ya&&Nt<=rt){Pe=rt;break}Pe=Math.max(Pe,rt)}x(tt(Pe,At))},Rt=()=>{h(!0),ce(""),ue()},Dt=()=>h(!1),Ut=()=>h(!1),Lt=()=>{P(_.volume),K(_.muted||_.volume===0)},It=()=>ce("Playback unavailable");return _.addEventListener("loadedmetadata",B),_.addEventListener("durationchange",Mt),_.addEventListener("timeupdate",Pt),_.addEventListener("progress",Et),_.addEventListener("play",Rt),_.addEventListener("pause",Dt),_.addEventListener("ended",Ut),_.addEventListener("volumechange",Lt),_.addEventListener("error",It),()=>{_.removeEventListener("loadedmetadata",B),_.removeEventListener("durationchange",Mt),_.removeEventListener("timeupdate",Pt),_.removeEventListener("progress",Et),_.removeEventListener("play",Rt),_.removeEventListener("pause",Dt),_.removeEventListener("ended",Ut),_.removeEventListener("volumechange",Lt),_.removeEventListener("error",It)}},[e,u]),T(()=>{o.current&&(o.current.volume=y)},[y]),T(()=>{o.current&&(o.current.muted=I)},[I]),T(()=>{o.current&&(o.current.playbackRate=Z)},[Z]),T(()=>{if(document.documentElement.classList.toggle("clipline-theater",z),z){let _=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=_}}},[z]),T(()=>()=>document.documentElement.classList.remove("clipline-theater"),[]);function me(_){ne(_),cs(_)}function $(_){let L=o.current;if(!L)return;let B=v>0?On(_,v):Math.max(0,_);L.currentTime=B,m(B)}function S(_){$((o.current?.currentTime||0)+_)}async function D(){let _=o.current;if(_)if(_.paused||_.ended)try{await _.play()}catch(L){ce(L?.message||"Playback failed")}else _.pause()}function U(){let _=o.current;_&&(_.muted||_.volume===0?(_.muted=!1,_.volume===0&&(_.volume=1,P(1),Wn(1)),K(!1)):(_.muted=!0,K(!0)))}function b(_){let L=Number(_.target.value);P(L),K(L===0),Wn(L);let B=o.current;B&&(B.volume=L,B.muted=L===0)}async function R(){try{document.fullscreenElement?await document.exitFullscreen():await s.current?.requestFullscreen?.()}catch(_){ce(_?.message||"Fullscreen unavailable")}}function E(_){let L=o.current?.currentTime||0,B=_>0?qn(oe,L):Kn(oe,L);B&&$(B.time)}function H(){c.current=!0,d.current=p,p&&o.current?.pause()}function Te(_){let L=Number(_.target.value);m(L),$(L)}function Me(){c.current&&(c.current=!1,d.current&&(d.current=!1,o.current?.play().catch(()=>{})))}function $a(_){let L=_.currentTarget.getBoundingClientRect();if(!(L.width>0))return;let B=Math.max(0,Math.min(1,(_.clientX-L.left)/L.width));te({pct:B*100,time:B*(v||0)})}function ga(){te(null)}return T(()=>{function _(L){if(L.defaultPrevented||rs(L.target))return;let B=os(L.code,L.shiftKey);if(B&&!(B.kind==="exit-theater"&&!z))switch(L.preventDefault(),ue(),B.kind){case"toggle-play":D();break;case"seek-by":S(B.seconds);break;case"seek-to":$(B.seconds);break;case"seek-to-end":$(v);break;case"next-marker":E(1);break;case"previous-marker":E(-1);break;case"toggle-mute":U();break;case"theater":me(!z);break;case"exit-theater":me(!1);break;case"fullscreen":R();break;default:break}}return document.addEventListener("keydown",_),()=>document.removeEventListener("keydown",_)},[v,z,p]),r`<div class=${`player ${ye?"":"chrome-hidden"}`} ref=${s}
    ...
    <video ref=${o} class="player-video" src=${e} poster=${t||void 0}
      preload="metadata" playsinline onClick=${D}></video>
    ${pe&&r`<div class="player-note">${pe}</div>`}
    <div class="player-overlay">
      <div class="player-timeline" onPointerMove=${$a} onPointerLeave=${ga}>
        ...
        ${oe.map(_=>r`<span class="player-marker-tick" key=${_.index}
            style=${`left:${tt(_.time,v)}%`} title=${`${_.label} @ ${xt(_.time)}`}></span>`)}
        ...
        ${le&&r`<div class="player-hover-time" style=${`left:${le.pct}%`}>${xt(le.time)}</div>`}
      </div>
      <div class="player-controls">
        ...
        <button type="button" class="player-btn player-play" aria-label=${p?"Pause":"Play"} onClick=${D}>
          ${M(p?"pause":"play",{size:16})}
        </button>
        <span class="player-time">${Hn(l,v)}</span>
        ...
        <div class="player-speed-wrap">
          ...
          ${ee&&r`<div class="player-speed-menu" role="menu">
            ${ss.map(_=>r`<button type="button" role="menuitem" key=${_}
                class=${`player-speed-item ${_===Z?"is-active":""}`}
                onClick=${()=>{ae(_),Q(!1)}}>${_}×</button>`)}
          </div>`}
        </div>
        <button type="button" class="player-btn" aria-label=${I?"Unmute":"Mute"} onClick=${U}>
          ${M(I?"volumeX":"volume2",{size:14})}
        </button>
        <input class="player-volume" type="range" min="0" max="1" step="0.01" value=${I?0:y}
        ...
        <button type="button" class="player-btn" aria-label="Fullscreen" onClick=${R}>
          ${M("fullscreen",{size:14})}
        </button>
      </div>
    </div>
  </div>`}J();function us(e){let t=new Map(e.map(s=>[s.id,s])),n=new Map,a=[],o=0;return e.forEach(s=>{let i=s.parent_comment_id||"";i&&t.has(i)?(n.has(i)||n.set(i,[]),n.get(i).push(s),o+=1):i||(a.push(s),o+=1)}),{roots:a,repliesByParent:n,count:o}}function ds(e){return(e||"?").trim().slice(0,1).toUpperCase()||"?"}function ps(e){let t=e.author_avatar_url;return typeof t=="string"&&t.startsWith("/")?r`<img class="comment-avatar" src=${t} alt="" />`:r`<div class="comment-avatar">${ds(e.author_name)}</div>`}function Yn({shareId:e}){let{user:t}=j(N),[n,a]=f(null),[o,s]=f(""),[i,c]=f(null),[d,u]=f(""),[p,h]=f(null);function l(){k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`).then(y=>a(y.comments||[])).catch(()=>a([]))}T(()=>{let y=!0;return a(null),k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`).then(P=>y&&a(P.comments||[])).catch(()=>y&&a([])),()=>{y=!1}},[e]);async function m(y,P){let I=y.trim();if(I)try{await k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`,{method:"POST",body:P?{body:I,parent_comment_id:P}:{body:I}}),l()}catch(K){C(K.message)}}async function v(y){y.preventDefault(),await m(o),s("")}async function g(y,P){y.preventDefault(),await m(d,P),u(""),c(null)}async function w(){let y=p;h(null);try{await k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments/${encodeURIComponent(y)}`,{method:"DELETE"}),l()}catch(P){C(P.message)}}let x=us(n||[]);return r`<section class="comments">
    ...
    ${n==null?"":x.count===0?r`<p class="comment-signin">No comments yet.</p>`:r`<div class="comment-list">
          ${x.roots.map(y=>Xn(y,{depth:0,repliesByParent:x.repliesByParent,user:t,replyOpenId:i,setReplyOpenId:c,replyDraft:d,setReplyDraft:u,submitReply:g,onDelete:h}))}
        </div>`}
  ...
  </section>`}function Xn(e,t){let{depth:n,repliesByParent:a,user:o,replyOpenId:s,setReplyOpenId:i,replyDraft:c,setReplyDraft:d,submitReply:u,onDelete:p}=t,h=a.get(e.id)||[];return r`<article class="comment" key=${e.id}>
    ${ps(e)}
  ...
  </article>`}var ms=["private","public","unlisted"];function fs(e,t){return e==="clip"?!0:!!t?.viewer_can_edit}function _s(e,t,n){return e==="public"?t.shareId:n?.public_share_id||null}function hs(e,t,n){return e==="clip"?t.clipId:n?.viewer_clip_id||null}function bs(e,t,n){if(e)try{return`${t}${new URL(e).pathname}`}catch{}return n?`${t}/c/${encodeURIComponent(n)}`:null}function vs(e){let t=e?.height!=null?e.height:"",n=Math.round(e?.fps||0)||"";return`${t}p${n}`}function $s(e,t,n=8){return(e||[]).filter(a=>a.share_id!==t).slice(0,n)}function Ct({route:e}){let{user:t}=j(N),[n,a]=f(null),[o,s]=f(null),[i,c]=f([]),[d,u]=f(!1),[p,h]=f(""),[l,m]=f(!1),[v,g]=f(""),[w,x]=f(!1),[y,P]=f(!1),[I,K]=f(!1),Z=e.name==="clip"?`clip:${e.clipId}`:`public:${e.shareId}`;if(T(()=>{let b=!0;a(null),s(null),u(!1),m(!1),K(!1),x(!1);let R=e.name==="clip"?`/api/v1/clips/${encodeURIComponent(e.clipId)}`:`/api/v1/public/clips/${encodeURIComponent(e.shareId)}`;return k(R).then(E=>{b&&(a(E),e.name==="public"&&k(`/api/v1/public/clips/${encodeURIComponent(e.shareId)}/view`,{method:"POST",body:{}}).then(H=>b&&a(Te=>Te&&{...Te,view_count:H.view_count})).catch(()=>{}))}).catch(E=>b&&s(E)),()=>{b=!1}},[Z]),T(()=>{let b=!0;return k("/api/v1/public/clips").then(R=>b&&c(R.clips||[])).catch(()=>{}),()=>{b=!1}},[Z]),o)return r`<main class="page"><${W} name="alert" title="Couldn't load this clip" body=${o.message} /></main>`;if(!n)return r`<main class="page watch"><div><div class="skeleton-thumb"></div></div><aside class="upnext"></aside></main>`;let ae=fs(e.name,n),ee=_s(e.name,e,n),Q=hs(e.name,e,n),z=e.name==="clip"?Ze({id:n.id}):Pn({share_id:e.shareId}),ne=e.name==="clip"?Ce({id:n.id}):se({share_id:e.shareId}),ye=e.name==="clip"?t?.display_name||t?.username||"You":n.author_name||"Unknown creator",ie=n.public_url??n.share_url??null,le=bs(ie,window.location.origin,ee),te=e.name==="clip";function pe(){h(n.title),u(!0)}async function ce(b){b?.preventDefault?.();let R=p.trim();if(!R||R===n.title){u(!1);return}try{await k(`/api/v1/clips/${encodeURIComponent(Q)}`,{method:"PATCH",body:{title:R}}),a(E=>({...E,title:R})),u(!1),C("Title saved.")}catch(E){C(E.message)}}function oe(){g(n.description||""),m(!0)}async function ue(){let b=v.trim();try{await k(`/api/v1/clips/${encodeURIComponent(Q)}`,{method:"PATCH",body:{description:b||null}}),a(R=>({...R,description:b||null})),m(!1),C("Description saved.")}catch(R){C(R.message)}}async function me(b){let R=n.visibility;if(R!==b){a(E=>({...E,visibility:b}));try{let E=await k(`/api/v1/clips/${encodeURIComponent(Q)}/visibility`,{method:"POST",body:{visibility:b}});a(H=>({...H,visibility:E.visibility,public_url:E.public_url,public_share_id:E.public_share_id})),C(`Visibility set to ${b}.`,{actionLabel:"Undo",onAction:()=>me(R)})}catch(E){a(H=>({...H,visibility:R})),C(E.message)}}}async function $(){if(le)try{await navigator.clipboard.writeText(le),C("Link copied.")}catch{C("Couldn't copy the link.")}}async function S(){P(!1);try{await k(`/api/v1/clips/${encodeURIComponent(Q)}`,{method:"DELETE"}),C("Clip deleted."),Y("/library")}catch(b){C(b.message)}}let D=[n.game_name&&r`<a class="chip chip-on" href=${`/game/${encodeURIComponent(n.game_name)}`}>${n.game_name}</a>`,be(n.view_count),`Recorded ${G(n.recorded_at)}`,`by ${ye}`].filter(Boolean),U=$s(i,ee,8);return r`<main class="page watch">
    <div>
      ...
      <p class="watch-meta">${D.map((b,R)=>r`${R>0?" \xB7 ":""}${b}`)}</p>

      ${ae&&r`<div class="watch-actions">
        <div class="seg" role="radiogroup" aria-label="Visibility">
          ${ms.map(b=>r`<button type="button" role="radio" key=${b} aria-checked=${n.visibility===b}
      ...
      ${te&&r`<button type="button" class="details-strip" aria-expanded=${I}
        onClick=${()=>K(b=>!b)}>
        ...
        <span class="details-chev">${I?"\u25B4 less":"\u25BE more"}</span>
      </button>`}
      ${te&&I&&r`<dl class="details-full">
  ...
  </main>`}J();var St=[{top:"4%",left:"4%",width:"34%",rotate:-7},{top:"0%",left:"44%",width:"30%",rotate:5},{top:"34%",left:"68%",width:"28%",rotate:-4},{top:"50%",left:"8%",width:"30%",rotate:6},{top:"62%",left:"42%",width:"26%",rotate:-5},{top:"26%",left:"-4%",width:"22%",rotate:9}];function gs(e){return Array.isArray(e)?e.slice(0,St.length).map((t,n)=>({clip:t,...St[n]})):[]}function ys(e){let t=e?.clips;if(!Array.isArray(t)||t.length===0)return null;let n=t.length,a=e.has_more?"+":"";return`${n}${a} clip${n===1?"":"s"} on this instance`}function ws({top:e,left:t,width:n,rotate:a}){return`top:${e};left:${t};width:${n};transform:rotate(${a}deg);`}function Qn(e){let t=String(e||"").trim();return t||null}function ks(){let[e,t]=f(null);T(()=>{let o=!0;return k(`/api/v1/public/clips?page_size=${St.length}`).then(s=>o&&t(s)).catch(()=>o&&t(null)),()=>{o=!1}},[]);let n=gs(e?.clips),a=ys(e);return r`<aside class="login-montage" aria-hidden="true">
    ${n.length>0&&r`<div class="login-montage-tiles">
      ${n.map((o,s)=>r`<img key=${s} class="login-montage-tile" style=${ws(o)}
  ...
  </div>`}function xs(e){let t=Number(e?.global_storage_warning_threshold_bytes||0);if(!t)return null;let n=Number(e?.total_storage_bytes||0);return Math.max(0,Math.min(1,n/t))}function Cs(e){if(!e?.global_storage_warning_threshold_bytes)return"Disabled";let t=q(e.global_storage_warning_threshold_bytes);return e.global_storage_warning?`At or above ${t}`:`Below ${t}`}function Ss({deadJobs:e=[],failedUploads:t=[]}={}){let n=e.length+t.length;return{failedCount:n,healthy:n===0}}function X(e,t){return r`<div><dt>${e}</dt><dd>${t??"Unknown"}</dd></div>`}function na({overview:e,deadJobs:t,failedUploads:n}){let a=xs(e),{failedCount:o,healthy:s}=Ss({deadJobs:t,failedUploads:n}),i=e.global_storage_warning_threshold_bytes;return r`<div>
    <div class="stat-grid">
  ...
  </div>`}J();function nt(e){let t=String(e||"").trim();return t||null}function Ts(e){let t=Number(String(e||"").trim());if(!Number.isFinite(t)||t<0)throw new Error("Storage quota must be a non-negative number");return Math.round(t*1024*1024*1024)}function Ms(e,t){return!(e.is_disabled||t?.id===e.id||e.role==="owner"||e.role==="admin"&&t?.role!=="owner")}function aa(e){return e?[["user","User"],["admin","Admin"]]:[["user","User"]]}function Ps({isOwner:e,onCreated:t}){let[n,a]=f(!1);async function o(s){if(s.preventDefault(),n)return;a(!0);let i=s.currentTarget,c=new FormData(i);try{await k("/api/v1/users",{method:"POST",body:{username:String(c.get("username")||""),display_name:nt(c.get("display_name")),email:nt(c.get("email")),password:nt(c.get("password")),role:String(c.get("role")||"user")}}),C("User created."),i.reset(),t()}catch(d){C(d.message)}finally{a(!1)}}return r`<form class="panel section" onSubmit=${o}>
    <h2>Create user</h2>
  ...
  </form>`}function Es({isOwner:e,smtpEnabled:t,onCreated:n}){let[a,o]=f(!1);async function s(i){if(i.preventDefault(),a)return;o(!0);let c=new FormData(i.currentTarget),d=i.submitter?.value==="email"?"email":"link";try{let u=await k("/api/v1/invites",{method:"POST",body:{role:String(c.get("role")||"user"),email:nt(c.get("email")),send_email:d==="email"}});C(d==="email"?"Invite sent.":"Invite link created."),n({...u,kind:"invite"})}catch(u){C(u.message)}finally{o(!1)}}return r`<form class="panel section" onSubmit=${s}>
    <h2>Invite link</h2>
    <label class="field"><span>Role</span>
      <select class="input" name="role">
  ...
  </form>`}function Rs({resetLink:e}){if(!e)return null;let t=e.kind==="invite"?"Invite":"Reset",n=e.username?` for ${e.username}`:"",a=async()=>{try{await navigator.clipboard.writeText(e.reset_url),C("Copied to clipboard.")}catch{C("Copy failed. Select and copy the URL manually.")}};return r`<div class="notice admin-reset-link">
    <div>
  ...
  </div>`}function Ds(e){return e.is_disabled?r`<span class="badge badge-warn">Disabled</span>`:r`<span class="badge badge-public">Active</span>`}function Us({user:e,currentUser:t,onQuota:n,onReset:a,onDisable:o}){let s=e.storage_quota_bytes!=null?q(e.storage_quota_bytes):"No limit",i=!Ms(e,t);return r`<tr>
    <td>
    ...
    <div class="admin-side-stack">
      <${Ps} isOwner=${d} onCreated=${()=>{o(null),s()}} />
      <${Es} isOwner=${d} smtpEnabled=${u}
        onCreated=${m=>{o(m),s()}} />
    </div>
    <div class="panel">
      ...
      <div class="table-wrap">
        <table class="lib-table">
          ...
          <tbody>
            ${e.map(m=>r`<${Us} key=${m.id} user=${m} currentUser=${n}
  ...
  </form>`}function Ls(e){return`${(e/100).toFixed(e%100===0?0:1)}%`}function Is(e){switch(e){case"delete_and_retry":return"delete the failed upload and retry from a new session";case"retry":return"retry the current upload request";default:return""}}function As({upload:e}){let t=Math.max(0,Math.min(1e4,Number(e.progress_basis_points||0))),n=Is(e.recovery_action);return r`<div class="job-item">
    ...
    <${Tt} title="Failed uploads" items=${e} emptyLabel="No failed uploads."
      renderItem=${a=>r`<${As} key=${a.id} upload=${a} />`} />
    ...
    <${Tt} title="Recent job errors" items=${n} emptyLabel="No recent job errors."
      renderItem=${a=>r`<${ra} key=${a.id} job=${a} />`} />
  </div>`}var la=[["overview","server","Overview"],["users","users","Users"],["settings","sliders","Settings"],["jobs","alert","Jobs"]];async function Ns(){let[e,t,n,a,o,s]=await Promise.all([k("/api/v1/admin/overview"),k("/api/v1/admin/settings"),k("/api/v1/users"),k("/api/v1/admin/uploads/failed?limit=50"),k("/api/v1/admin/jobs/dead?limit=50"),k("/api/v1/admin/jobs/recent-errors?limit=50")]);return{overview:e,settings:t,users:n,failedUploads:a,deadJobs:o,recentErrors:s}}function ca({route:e}){let{user:t}=j(N),n=la.some(([l])=>l===e.tab)?e.tab:"overview",[a,o]=f(null),[s,i]=f(null),[c,d]=f(null),[u,p]=f(0),h=()=>p(l=>l+1);return T(()=>{let l=!0;return i(null),Ns().then(m=>l&&o(m)).catch(m=>l&&i(m)),()=>{l=!1}},[u]),r`<main class="page">
    <h1>Admin</h1>
    <p class="page-subtitle">Accounts, instance summary, and processing diagnostics.</p>
    <nav class="ad-tabs" aria-label="Admin views">
      ${la.map(([l,m,v])=>r`<a key=${l} class=${`ad-tab ${l===n?"ad-tab-on":""}`}
        href=${`/admin?tab=${l}`} aria-current=${l===n?"page":void 0}>${M(m,{size:14})} ${v}</a>`)}
    </nav>
    ${s?r`<${W} name="alert" title="Couldn't load admin data" body=${s.message} />`:a?n==="users"?r`<${sa} users=${a.users} settings=${a.settings} currentUser=${t}
          resetLink=${c} setResetLink=${d} reload=${h} />`:n==="settings"?r`<${oa} settings=${a.settings} isOwner=${t?.role==="owner"} reload=${h} />`:n==="jobs"?r`<${ia} failedUploads=${a.failedUploads} deadJobs=${a.deadJobs} recentErrors=${a.recentErrors} />`:r`<${na} overview=${a.overview} deadJobs=${a.deadJobs} failedUploads=${a.failedUploads} />`:r`<p class="empty-state">Loading admin data…</p>`}
  </main>`}J();function zs(e){if(!e?.avatar_url)return"";let t=e.updated_at||"";if(!t)return e.avatar_url;let n=String(e.avatar_url).includes("?")?"&":"?";return`${e.avatar_url}${n}v=${encodeURIComponent(t)}`}function Fs(e){return(e||"C").trim().slice(0,1).toUpperCase()||"C"}function st({user:e,size:t=40,className:n=""}){let a=zs(e),o=`width:${t}px;height:${t}px;font-size:${Math.round(t*.4)}px`;if(a)return r`<img class=${`user-avatar ${n}`} style=${o} src=${a} alt="" />`;let s=e?.display_name||e?.username;return r`<div class=${`user-avatar user-avatar-fallback ${n}`} style=${o} aria-hidden="true">
    ${Fs(s)}
  </div>`}function ua(e){let t=String(e||"").trim();return t||null}async function Bs(e){let t=new Headers;t.set("Accept","application/json"),t.set("Content-Type",e.type||"application/octet-stream");let n=_t();n&&t.set("X-CSRF-Token",n);let a=await fetch("/api/v1/me/avatar",{method:"PUT",credentials:"same-origin",headers:t,body:e}),o=await a.json().catch(()=>({}));if(!a.ok)throw new Error(o.error||a.statusText||"Avatar upload failed");return o}function da(e){N.set({...N.get(),user:e})}function Os({user:e}){let[t,n]=f(!1);async function a(o){if(o.preventDefault(),t)return;n(!0);let s=new FormData(o.currentTarget);try{let i=await k("/api/v1/me/profile",{method:"PATCH",body:{display_name:ua(s.get("display_name")),bio:ua(s.get("bio"))}});da(i),C("Profile saved.")}catch(i){C(i.message)}finally{n(!1)}}return r`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function Hs({user:e}){let[t,n]=f(!1);async function a(o){if(o.preventDefault(),t)return;let s=o.currentTarget.elements.avatar?.files?.[0];if(!s){C("Choose an avatar image first.");return}n(!0);try{let i=await Bs(s);da(i),C("Avatar uploaded.")}catch(i){C(i.message)}finally{n(!1)}}return r`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function pa(){let{user:e}=j(N);return e?r`<main class="page">
    <h1>Profile</h1>
  ...
  </main>`:null}J();async function Vs(){let[e,t]=await Promise.all([k("/api/v1/auth/sessions"),k("/api/v1/auth/device-tokens")]);return{sessions:e,deviceTokens:t}}function qs({item:e,onRevoke:t}){return r`<div class="management-item">
    <div>
  ...
  </div>`}function Ks({item:e,onRevoke:t}){let n=!!e.revoked_at;return r`<div class="management-item">
    <div>
    ...
    ${e?r`<div class="account-grid">
          ...
          <div class="panel">
            ...
            ${e.deviceTokens.length?r`<div class="management-list">${e.deviceTokens.map(p=>r`<${Ks} key=${p.id} item=${p}
  ...
  </main>`}J();var _a="Clipline is a self-hosted clip library for saved gameplay moments.";function ot(e,t){return r`<div><dt>${e}</dt><dd>${t}</dd></div>`}function ha(){let[e,t]=f(_a);return T(()=>{let n=!0;return k("/api/v1/about").then(a=>n&&t(a.about_text||_a)).catch(()=>{}),()=>{n=!1}},[]),r`<main class="page">
    <h1>About</h1>
  ...
  </main>`}var Gs={publicLibrary:kt,publicGame:kt,games:Un,library:zn,clip:Ct,public:Ct,login:ea,resetPassword:ta,admin:ca,profile:pa,account:ma,publicUser:fa,about:ha},ba={publicLibrary:"feed",publicGame:"feed",games:"games",library:"library",clip:"library",admin:"admin",profile:"profile"},va=wn(We());function Ws({route:e}){return r`<main class="page"><p class="kicker">Not ported yet</p>
    <p>Route <code>${e.name}</code> still renders in the legacy app — open it from
    <a href="/">the served site</a>.</p></main>`}function js(){let e=kn();va=e.name;let{ready:t}=j(N);if(!t)return r`<div class="boot">Loading…</div>`;let n=Gs[e.name]||Ws,a=e.name==="login"||e.name==="resetPassword";return r`<div class="ui" onClick=${xn}>
    ${!a&&r`<${Sn} active=${ba[e.name]||""} />`}
    <${n} route=${e} />
    ${!a&&r`<${Tn} active=${ba[e.name]||""} />`}
    <${Mn} />
  </div>`}window.addEventListener("clipline:unauthorized",()=>{N.set({user:null,csrfToken:null,ready:!0}),gn(va)||Y("/login")});(async()=>{try{let e=await k("/api/v1/auth/me");ke(e.csrf_token),N.set({user:e.user,csrfToken:e.csrf_token,ready:!0})}catch{N.set({user:null,csrfToken:null,ready:!0})}Qt(r`<${js} />`,document.querySelector("#app"))})();
