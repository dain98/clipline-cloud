...
`||a==="\r"?(u(),s=2):i+=a),s===3&&i==="!--"&&(s=4,d=d[0])}return u(),d})(e)),t),arguments,[])).length>1?t:t[0]}var o=gn.bind(ht);Q();function kn(e){let t=e,n=new Set;return{get:()=>t,set(a){t=a,n.forEach(r=>r(t))},update(a){this.set(a(t))},subscribe(a){return n.add(a),()=>n.delete(a)}}}function q(e){let[t,n]=_(e.get());return C(()=>e.subscribe(n),[e]),t}var A=kn({user:null,csrfToken:null,ready:!1}),We=kn([]),za=0;function w(e,{actionLabel:t,onAction:n,timeoutMs:a=5e3}={}){let r=++za;return We.update(s=>[...s,{id:r,message:e,actionLabel:t,onAction:n}]),a&&setTimeout(()=>je(r),a),r}function je(e){We.update(t=>t.filter(n=>n.id!==e))}function Ze(e){try{return decodeURIComponent(e)}catch{return e}}function wn(e){let t=Number(e.get("page")||1);return{sort:e.get("sort")||"uploaded_at_desc",game:e.get("game")||"",q:e.get("q")||"",page:Number.isFinite(t)?Math.max(1,t):1}}var Ba=["login","resetPassword","public","publicLibrary","publicGame","publicUser","about","games"];function wt(e){return Ba.includes(e)}function Sn(e,t){return!t&&!wt(e)}var Oa={publicLibrary:"feed",publicGame:"feed",games:"games",library:"library",clip:"library",admin:"admin",profile:"profile"};function St(e){return Oa[e?.name]||""}function xn(e){return e?.name==="publicLibrary"&&e.surface==="search"?"search":St(e)}function Je(e,t){let n=new URLSearchParams(t||""),a=e;return a.startsWith("/c/")?{name:"public",shareId:Ze(a.slice(3))}:a==="/"||a==="/public"||a==="/search"?{name:"publicLibrary",query:wn(n),surface:a==="/search"?"search":"feed"}:a.startsWith("/game/")?{name:"publicGame",game:Ze(a.slice(6)),query:wn(n)}:a==="/about"?{name:"about"}:a==="/games"?{name:"games"}:a.startsWith("/u/")?{name:"publicUser",username:Ze(a.slice(3))}:a==="/library"?{name:"library"}:a.startsWith("/clip/")?{name:"clip",clipId:Ze(a.slice(6))}:a==="/admin"?{name:"admin",tab:n.get("tab")||"overview"}:a==="/account"?{name:"account"}:a==="/profile"?{name:"profile"}:a==="/login"?{name:"login"}:a==="/reset-password"?{name:"resetPassword",token:n.get("token")||"",invite:n.get("invite")==="1"}:{name:"publicLibrary"}}function Cn(e){return Je(e.pathname,e.search).name}var xt=new Set;function W(e){window.history.pushState({},"",e),Tn()}function Tn(){let{pathname:e,search:t}=window.location,n=Je(e,t);xt.forEach(a=>a(n))}window.addEventListener("popstate",Tn);function Mn(){let[e,t]=_(()=>Je(window.location.pathname,window.location.search));return C(()=>(xt.add(t),()=>xt.delete(t)),[]),e}function Pn(e){let t=e.target.closest("a[href^='/']");!t||t.target||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),W(t.getAttribute("href")))}var En={alert:'<path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>',clipboard:'<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>',copy:'<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',external:'<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',edit:'<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/>',fastForward:'<path d="m13 19 9-7-9-7v14Z"/><path d="m2 19 9-7-9-7v14Z"/>',film:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M17 3v18"/><path d="M3 8h4"/><path d="M3 16h4"/><path d="M17 8h4"/><path d="M17 16h4"/>',fullscreen:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/>',home:'<path d="m3 10 9-7 9 7"/><path d="M5 8.5V20a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.5"/><path d="M9 22V12h6v10"/>',info:'<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',logOut:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/>',menu:'<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h16"/>',message:'<path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"/>',notepad:'<path d="M8 2v4"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M6 4h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><path d="M8 14h8"/><path d="M8 18h5"/>',pause:'<path d="M8 5v14"/><path d="M16 5v14"/>',play:'<path d="m8 5 11 7-11 7V5Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',refresh:'<path d="M21 12a9 9 0 0 1-15.5 6.3L3 16"/><path d="M3 21v-5h5"/><path d="M3 12A9 9 0 0 1 18.5 5.7L21 8"/><path d="M21 3v5h-5"/>',rewind:'<path d="m11 19-9-7 9-7v14Z"/><path d="m22 19-9-7 9-7v14Z"/>',save:'<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2Z"/><path d="M17 21v-8H7v8"/><path d="M7 3v5h8"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',server:'<rect width="20" height="8" x="2" y="2" rx="2"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 6h.01"/><path d="M6 18h.01"/>',skipBack:'<path d="M19 20 9 12l10-8v16Z"/><path d="M5 19V5"/>',skipForward:'<path d="m5 4 10 8-10 8V4Z"/><path d="M19 5v14"/>',shield:'<path d="M20 13c0 5-3.5 7.5-7.7 8.8a1 1 0 0 1-.6 0C7.5 20.5 4 18 4 13V5l8-3 8 3v8Z"/>',sliders:'<path d="M4 21v-7"/><path d="M4 10V3"/><path d="M12 21v-9"/><path d="M12 8V3"/><path d="M20 21v-5"/><path d="M20 12V3"/><path d="M2 14h4"/><path d="M10 8h4"/><path d="M18 16h4"/>',theater:'<rect width="20" height="14" x="2" y="5" rx="2"/><path d="M6 9h12"/><path d="M6 15h12"/>',trash:'<path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m17 8-5-5-5 5"/><path d="M12 3v12"/>',user:'<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.9"/><path d="M16 3.1a4 4 0 0 1 0 7.8"/>',volume2:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9 9 0 0 1 0 14"/>',volumeX:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>'};function M(e,{size:t=18}={}){return o`<svg viewBox="0 0 24 24" width=${t} height=${t} fill="none"
  ...
  </header>`}async function qa(){let{api:e,setCsrfToken:t}=await Promise.resolve().then(()=>(Q(),yn));try{await e("/api/v1/auth/logout",{method:"POST"})}catch{}t(null),A.set({user:null,csrfToken:null,ready:!0}),W("/login")}var Ka=[["feed","/","home","Feed",!0],["games","/games","globe","Games",!0],["library","/library","library","Library","auth"],["search","/search","search","Search",!0],["profile","/profile","user","Profile","auth"]];function Ga(e){return Ka.filter(([,,,,t])=>t!=="auth"||!!e)}function Dn({active:e}){let{user:t}=q(A),n=Ga(t);return o`<nav class="tabbar" aria-label="Primary">
    ${n.map(([a,r,s,i])=>o`
    ...
    ${u==null?o`<${Qa} />`:u.length===0?o`<${Z} name="film"
        ...
        <div class="card-grid">
          ${(v?u.slice(4):u).map($=>o`<${Ce} clip=${{...$,thumbnail_url:se($),media_url:xe($)}}
              href=${Tt($)} showAuthor />`)}
        </div>
        ${ts(n,t,d)}
      `}
  ...
  </nav>`}Q();function Fn(){let[e,t]=_(null),[n,a]=_(null);return C(()=>{let r=!0;return k("/api/v1/public/games").then(s=>r&&t(s.games||[])).catch(s=>r&&a(s)),()=>{r=!1}},[]),n?o`<main class="page">
  ...
  </main>`}Q();function zn({trigger:e,content:t,onClose:n,label:a,panelClass:r=""}){let[s,i]=_(!1),c=z(null),d=z(null),u=z(null),p=()=>{i(!1),n?.()},v=()=>{if(s){p();return}u.current=document.activeElement,i(!0)};return C(()=>{if(!s)return;let l=$=>{c.current?.contains($.target)||p()},m=$=>{$.key==="Escape"&&p()};return document.addEventListener("pointerdown",l),document.addEventListener("keydown",m),d.current?.querySelector("input, select, textarea, button, a[href], [tabindex]")?.focus(),()=>{document.removeEventListener("pointerdown",l),document.removeEventListener("keydown",m),u.current?.focus?.()}},[s]),o`<div class="popover-wrap" ref=${c}>
    ${e({open:s,toggle:v})}
  ...
  </div>`:null}function le({open:e,title:t,body:n,confirmLabel:a="Confirm",onConfirm:r,onCancel:s,danger:i=!1,confirmDisabled:c=!1}){let d=z(null),u=z(null);return C(()=>{let p=d.current;p&&(e&&!p.open?(p.showModal(),u.current?.focus()):!e&&p.open&&p.close())},[e]),o`<dialog ref=${d} class="confirm-dialog" aria-labelledby="confirm-dialog-title"
  ...
  </dialog>`}var Hn="clipline.libraryView",ns=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["updated_at_desc","Updated newest"],["updated_at_asc","Updated oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["size_desc","Size largest"],["size_asc","Size smallest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],tt={title:["title_asc","title_desc"],size:["size_asc","size_desc"],duration:["duration_asc","duration_desc"],uploaded:["uploaded_at_asc","uploaded_at_desc"]},as=["visibility","status","source_type","from","to","min_duration_seconds","max_duration_seconds","min_size_mib","max_size_mib"],st={sort:"uploaded_at_desc",game:"",source_type:"",visibility:"",status:"",q:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""};function nt(e){if(e===""||e==null)return null;let t=Number(e);return Number.isFinite(t)?t:null}function ss(e){let t=new URLSearchParams;t.set("sort",e.sort||st.sort),t.set("page_size","100");for(let i of["game","source_type","visibility","status","q"])e[i]&&t.set(i,e[i]);e.from&&t.set("from",`${e.from}T00:00:00Z`),e.to&&t.set("to",`${e.to}T23:59:59Z`);let n=nt(e.min_duration_seconds);n!=null&&t.set("min_duration_ms",String(Math.round(n*1e3)));let a=nt(e.max_duration_seconds);a!=null&&t.set("max_duration_ms",String(Math.round(a*1e3)));let r=nt(e.min_size_mib);r!=null&&t.set("min_size_bytes",String(Math.round(r*1024*1024)));let s=nt(e.max_size_mib);return s!=null&&t.set("max_size_bytes",String(Math.round(s*1024*1024))),t}function rs(e){return as.reduce((t,n)=>t+(e[n]?1:0),0)}function os(e,t=6){let n=new Map;for(let a of e){let r=a.game_name;r&&n.set(r,(n.get(r)||0)+1)}return Array.from(n,([a,r])=>({game:a,count:r})).sort((a,r)=>r.count-a.count||a.game.localeCompare(r.game)).slice(0,t)}function On(e,t,{verb:n,allFailedMessage:a}){let r=e.filter(i=>!t.some(c=>c.id===i));if(!t.length)return{succeeded:r,message:null};let s=t.length===e.length?t[0]?.message||a:`Couldn't ${n} ${t.length} of ${e.length} clips.`;return{succeeded:r,message:s}}function is(e,t){return(e||[]).map(n=>Re(n.public_url,t,n.public_share_id)).filter(Boolean)}async function Vn(e,t,n){let a=0;async function r(){let s=a++;if(!(s>=e.length))return await n(e[s]),r()}await Promise.all(Array.from({length:Math.min(t,e.length)},r))}function ls(){try{return localStorage.getItem(Hn)==="rows"?"rows":"grid"}catch{return"grid"}}function qn(){let[e,t]=_(ls),[n,a]=_(st),[r,s]=_(st.q),[i,c]=_(null),[d,u]=_(null),[p,v]=_(new Set),[l,m]=_(!1),[h,$]=_(!1),[S,x]=_(0),y=z(!1),R=z(null);C(()=>()=>clearTimeout(R.current),[]),C(()=>{let g=!0;return c(null),u(null),k(`/api/v1/clips?${ss(n)}`).then(T=>{g&&(c(T),v(new Set))}).catch(T=>g&&u(T)),()=>{g=!1}},[JSON.stringify(n),S]);let B=g=>{t(g);try{localStorage.setItem(Hn,g)}catch{}},G=()=>x(g=>g+1),J=g=>{y.current=g,m(g)},re=g=>{let T=g.target.value;s(T),clearTimeout(R.current),R.current=setTimeout(()=>{a(b=>({...b,q:T}))},300)},V=g=>T=>{let b=T.target.value;a(P=>({...P,[g]:b}))},te=()=>{a(g=>({...g,visibility:"",status:"",source_type:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""}))},L=g=>a(T=>({...T,game:T.game===g?"":g})),Y=g=>a(T=>({...T,sort:g})),ke=g=>{v(T=>{let b=new Set(T);return b.has(g)?b.delete(g):b.add(g),b})};function ne(g,T){c(b=>b&&{...b,clips:b.clips.map(P=>P.id===g?{...P,...T}:P)})}function be(g,T){let b=new Set(g);c(P=>P&&{...P,clips:P.clips.map(I=>b.has(I.id)?{...I,...T}:I)})}async function ve(g){if(y.current)return;let T=Array.from(p);if(!T.length)return;let b=i?.clips||[],P=new Map(T.map(U=>[U,b.find(ae=>ae.id===U)]));J(!0),be(T,{visibility:g});let I=[],D=new Map;try{await Vn(T,4,async f=>{try{let E=await k(`/api/v1/clips/${encodeURIComponent(f)}/visibility`,{method:"POST",body:{visibility:g}}),F={visibility:E.visibility,public_url:E.public_url,public_share_id:E.public_share_id};ne(f,F),D.set(f,F)}catch(E){I.push({id:f,message:E.message})}});let{succeeded:U,message:ae}=On(T,I,{verb:"update",allFailedMessage:"Couldn't update visibility."});if(ae){for(let{id:f}of I){let E=P.get(f);E&&ne(f,{visibility:E.visibility,public_url:E.public_url,public_share_id:E.public_share_id})}w(ae)}U.length&&(v(new Set),w(`Made ${U.length} clip${U.length===1?"":"s"} ${g}`,{actionLabel:"Undo",onAction:()=>pe(U,P,D)}))}finally{J(!1)}}async function pe(g,T,b){if(y.current){w("Wait for visibility changes to finish.");return}J(!0);try{for(let D of g){let U=T.get(D);U&&ne(D,{visibility:U.visibility,public_url:U.public_url,public_share_id:U.public_share_id})}let P=[];await Vn(g,4,async D=>{let U=T.get(D);if(U)try{let ae=await k(`/api/v1/clips/${encodeURIComponent(D)}/visibility`,{method:"POST",body:{visibility:U.visibility}});ne(D,{visibility:ae.visibility,public_url:ae.public_url,public_share_id:ae.public_share_id})}catch(ae){P.push({id:D,message:ae.message})}});let{message:I}=On(g,P,{verb:"undo",allFailedMessage:"Couldn't undo visibility change."});if(I){for(let{id:D}of P){let U=b.get(D);U&&ne(D,U)}w(I)}}finally{J(!1)}}async function ce(){if(y.current){w("Wait for visibility changes to finish.");return}let g=Array.from(p),T=i?.clips||[],b=g.map(D=>T.find(U=>U.id===D)).filter(Boolean),P=is(b,window.location.origin),I=b.length-P.length;if(!P.length){w("No links to copy \u2014 selected clips are private.");return}try{await navigator.clipboard.writeText(P.join(`
`)),w(`Copied ${P.length} link${P.length===1?"":"s"}`+(I?` (${I} skipped, private)`:""))}catch{w("Couldn't copy links to clipboard.")}}async function me(){let g=Array.from(p);$(!1);try{let T=await k("/api/v1/clips/bulk-delete",{method:"POST",body:{ids:g}});v(new Set),G(),w(`Deleted ${T.affected} clip${T.affected===1?"":"s"}.`)}catch(T){w(T.message)}}if(d)return o`<main class="page">
      <${Z} name="alert" title="Couldn't load your library" body=${d.message} />
    </main>`;let X=i?.clips,oe=rs(n),ie=!!(n.q||n.game)||oe>0,$e=os(X||[]),ge=(X||[]).reduce((g,T)=>g+(T.file_size_bytes||0),0),we=o`<div class="popover-fields">
    ...
    <div class="lib-header">
      <div>
        <h1>Library</h1>
        <p>${(X||[]).length} clip${(X||[]).length===1?"":"s"} · ${K(ge)} used</p>
      </div>
      <div class="seg" role="group" aria-label="View">
        <button type="button" class=${`seg-item ${e==="grid"?"seg-on":""}`}
          aria-pressed=${e==="grid"} onClick=${()=>B("grid")}>Grid</button>
        <button type="button" class=${`seg-item ${e==="rows"?"seg-on":""}`}
          aria-pressed=${e==="rows"} onClick=${()=>B("rows")}>Rows</button>
      </div>
    </div>
    ...
    <div class="lib-toolbar">
      <input class="input" type="search" aria-label="Search clips" placeholder="Search title or game"
        value=${r} onInput=${re} />
      <select class="input" aria-label="Sort" value=${n.sort} onChange=${g=>Y(g.target.value)}>
        ${ns.map(([g,T])=>o`<option value=${g}>${T}</option>`)}
      </select>
      <${zn}
        label="Filters"
        panelClass="popover-filters"
        trigger=${({open:g,toggle:T})=>o`<button type="button" class="btn" aria-haspopup="dialog"
    ...
    ${$e.length>0&&o`<div class="lib-chips">
      ...
      ${$e.map(g=>o`<button type="button" class=${`chip ${n.game===g.game?"chip-on":""}`}
        aria-pressed=${n.game===g.game} onClick=${()=>L(g.game)}>${g.game}</button>`)}
    </div>`}

    ${X==null?o`<${us} />`:X.length===0?ie?o`<${Z} name="film" title="No clips match this view"
          ...
          ${X.map(g=>o`<${Ce} key=${g.id}
            clip=${{...g,thumbnail_url:Ee(g),media_url:Xe(g)}}
            href=${`/clip/${encodeURIComponent(g.id)}`}
            selectable selected=${p.has(g.id)} onToggleSelect=${ke} showVisibility />`)}
        </div>`:o`<${cs} clips=${X} query=${n} onSort=${Y}
  ...
  </div>`}Q();var ds={ChampionKill:"kill",FirstBlood:"kill",Multikill:"spree",Ace:"spree",DragonKill:"objective",HeraldKill:"objective",BaronKill:"objective",TurretKilled:"structure",InhibKilled:"structure",FirstBrick:"structure"};function Gn(e){let t=Number(e);return Number.isFinite(t)&&t>0?t/1e3:0}function Wn(e,t){let n=Number.isFinite(e)?e:0,a=t>0?t:Number.MAX_SAFE_INTEGER;return Math.max(0,Math.min(a,n))}function rt(e,t){return t>0?Math.max(0,Math.min(100,e/t*100)):0}function Mt(e){if(!Number.isFinite(e))return"0:00";let t=Math.max(0,Math.round(e)),n=Math.floor(t/60),a=t-n*60;return`${n}:${String(a).padStart(2,"0")}`}function Kn(e){if(!Number.isFinite(e))return"0:00.0";let t=Math.max(0,Math.round(e*10)),n=Math.floor(t/600),a=t-n*600,r=Math.floor(a/10);return`${n}:${String(r).padStart(2,"0")}.${a%10}`}function jn(e,t){return`${Kn(e)} / ${t>0?Kn(t):"0:00.0"}`}function ps(e){return ds[e]||"info"}function Zn(e,t){return(e||[]).map((n,a)=>{let r=Number(n.timestamp_ms);if(!Number.isFinite(r))return null;let s=r/1e3;return s<0||t>0&&s>t?null:{index:a,time:s,kind:String(n.kind||"Marker"),label:String(n.label||n.kind||"Marker"),category:ps(n.kind)}}).filter(Boolean).sort((n,a)=>n.time-a.time)}function Jn(e,t){if(!e.length)return null;for(let n of e)if(n.time>t+.05)return n;return e[0]}function Yn(e,t){if(!e.length)return null;for(let n=e.length-1;n>=0;n-=1)if(e[n].time<t-.05)return e[n];return e[e.length-1]}function Xn(e,t){switch(e){case"Space":case"KeyK":return{kind:"toggle-play"};case"ArrowLeft":return{kind:"seek-by",seconds:t?-1:-5};case"ArrowRight":return{kind:"seek-by",seconds:t?1:5};case"KeyJ":return{kind:"seek-by",seconds:-10};case"KeyL":return{kind:"seek-by",seconds:10};case"Comma":return{kind:"seek-by",seconds:-.1};case"Period":return{kind:"seek-by",seconds:.1};case"KeyM":return{kind:t?"previous-marker":"next-marker"};case"Home":return{kind:"seek-to",seconds:0};case"End":return{kind:"seek-to-end"};case"KeyF":return{kind:"fullscreen"};case"KeyT":return{kind:"theater"};default:return null}}var ea="clipline.playerVolume",ta="clipline.clipTheaterMode",ms=2e3,fs=[.25,.5,.75,1,1.25,1.5,2];function _s(e,t){switch(e){case"KeyM":return{kind:"toggle-mute"};case"KeyF":return{kind:"theater"};case"Escape":return{kind:"exit-theater"};default:return Xn(e,t)}}function hs(e){return e instanceof Element?!!e.closest("input, textarea, select, button, a, [contenteditable='true'], [contenteditable='']"):!1}function bs(){try{let e=window.localStorage.getItem(ea);if(e==null)return 1;let t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(1,t)):1}catch{return 1}}function Qn(e){try{window.localStorage.setItem(ea,String(Math.max(0,Math.min(1,e))))}catch{}}function vs(){try{return window.localStorage.getItem(ta)==="true"}catch{return!1}}function $s(e){try{window.localStorage.setItem(ta,String(e))}catch{}}function na({src:e,poster:t,durationMs:n,markers:a}){let r=z(null),s=z(null),i=z(null),c=z(!1),d=z(!1),u=Gn(n),[p,v]=_(!1),[l,m]=_(0),[h,$]=_(u),[S,x]=_(0),[y,R]=_(bs),[B,G]=_(!1),[J,re]=_(1),[V,te]=_(!1),[L,Y]=_(vs),[ke,ne]=_(!0),[be,ve]=_(null),[pe,ce]=_(""),me=Zn(a,h);function X(){ne(!0),window.clearTimeout(i.current),i.current=window.setTimeout(()=>{let f=r.current;f&&!f.paused&&!f.ended&&ne(!1)},ms)}C(()=>{p||(window.clearTimeout(i.current),ne(!0))},[p]),C(()=>{let f=r.current;if(!f)return;let E=()=>Number.isFinite(f.duration)&&f.duration>0?f.duration:u,F=()=>$(E()),Dt=()=>$(E()),Ut=()=>{c.current||m(f.currentTime||0)},Lt=()=>{let Bt=E();if(!(Bt>0)||!f.buffered?.length){x(0);return}let Ot=f.currentTime||0,Ue=0;for(let Le=0;Le<f.buffered.length;Le+=1){let Sa=f.buffered.start(Le),ut=f.buffered.end(Le);if(Ot>=Sa&&Ot<=ut){Ue=ut;break}Ue=Math.max(Ue,ut)}x(rt(Ue,Bt))},It=()=>{v(!0),ce(""),X()},At=()=>v(!1),Nt=()=>v(!1),Ft=()=>{R(f.volume),G(f.muted||f.volume===0)},zt=()=>ce("Playback unavailable");return f.addEventListener("loadedmetadata",F),f.addEventListener("durationchange",Dt),f.addEventListener("timeupdate",Ut),f.addEventListener("progress",Lt),f.addEventListener("play",It),f.addEventListener("pause",At),f.addEventListener("ended",Nt),f.addEventListener("volumechange",Ft),f.addEventListener("error",zt),()=>{f.removeEventListener("loadedmetadata",F),f.removeEventListener("durationchange",Dt),f.removeEventListener("timeupdate",Ut),f.removeEventListener("progress",Lt),f.removeEventListener("play",It),f.removeEventListener("pause",At),f.removeEventListener("ended",Nt),f.removeEventListener("volumechange",Ft),f.removeEventListener("error",zt)}},[e,u]),C(()=>{r.current&&(r.current.volume=y)},[y]),C(()=>{r.current&&(r.current.muted=B)},[B]),C(()=>{r.current&&(r.current.playbackRate=J)},[J]),C(()=>{if(document.documentElement.classList.toggle("clipline-theater",L),L){let f=document.body.style.overflow;return document.body.style.overflow="hidden",()=>{document.body.style.overflow=f}}},[L]),C(()=>()=>document.documentElement.classList.remove("clipline-theater"),[]);function oe(f){Y(f),$s(f)}function ie(f){let E=r.current;if(!E)return;let F=h>0?Wn(f,h):Math.max(0,f);E.currentTime=F,m(F)}function $e(f){ie((r.current?.currentTime||0)+f)}async function ge(){let f=r.current;if(f)if(f.paused||f.ended)try{await f.play()}catch(E){ce(E?.message||"Playback failed")}else f.pause()}function we(){let f=r.current;f&&(f.muted||f.volume===0?(f.muted=!1,f.volume===0&&(f.volume=1,R(1),Qn(1)),G(!1)):(f.muted=!0,G(!0)))}function g(f){let E=Number(f.target.value);R(E),G(E===0),Qn(E);let F=r.current;F&&(F.volume=E,F.muted=E===0)}async function T(){try{document.fullscreenElement?await document.exitFullscreen():await s.current?.requestFullscreen?.()}catch(f){ce(f?.message||"Fullscreen unavailable")}}function b(f){let E=r.current?.currentTime||0,F=f>0?Jn(me,E):Yn(me,E);F&&ie(F.time)}function P(){c.current=!0,d.current=p,p&&r.current?.pause()}function I(f){let E=Number(f.target.value);m(E),ie(E)}function D(){c.current&&(c.current=!1,d.current&&(d.current=!1,r.current?.play().catch(()=>{})))}function U(f){let E=f.currentTarget.getBoundingClientRect();if(!(E.width>0))return;let F=Math.max(0,Math.min(1,(f.clientX-E.left)/E.width));ve({pct:F*100,time:F*(h||0)})}function ae(){ve(null)}return C(()=>{function f(E){if(E.defaultPrevented||hs(E.target))return;let F=_s(E.code,E.shiftKey);if(F&&!(F.kind==="exit-theater"&&!L))switch(E.preventDefault(),X(),F.kind){case"toggle-play":ge();break;case"seek-by":$e(F.seconds);break;case"seek-to":ie(F.seconds);break;case"seek-to-end":ie(h);break;case"next-marker":b(1);break;case"previous-marker":b(-1);break;case"toggle-mute":we();break;case"theater":oe(!L);break;case"exit-theater":oe(!1);break;case"fullscreen":T();break;default:break}}return document.addEventListener("keydown",f),()=>document.removeEventListener("keydown",f)},[h,L,p]),o`<div class=${`player ${ke?"":"chrome-hidden"}`} ref=${s}
    ...
    <div class="player-overlay">
      <div class="player-timeline" onPointerMove=${U} onPointerLeave=${ae}>
        ...
        <div class="player-progress" style=${`width:${rt(l,h)}%`}></div>
        ${me.map(f=>o`<span class="player-marker-tick" key=${f.index}
            style=${`left:${rt(f.time,h)}%`} title=${`${f.label} @ ${Mt(f.time)}`}></span>`)}
      ...
      <div class="player-controls">
        ${me.length>0&&o`<div class="player-cluster">
          <button type="button" class="player-btn" title="Previous marker" aria-label="Previous marker"
            onClick=${()=>b(-1)}>${M("skipBack",{size:14})}</button>
          <button type="button" class="player-btn" title="Next marker" aria-label="Next marker"
            onClick=${()=>b(1)}>${M("skipForward",{size:14})}</button>
        </div>`}
        ...
        <div class="player-speed-wrap">
          <button type="button" class="player-btn player-speed" aria-haspopup="menu" aria-expanded=${V}
            onClick=${()=>te(f=>!f)}>${J}×</button>
          ${V&&o`<div class="player-speed-menu" role="menu">
            ${fs.map(f=>o`<button type="button" role="menuitem" key=${f}
                class=${`player-speed-item ${f===J?"is-active":""}`}
                onClick=${()=>{re(f),te(!1)}}>${f}×</button>`)}
          </div>`}
        </div>
        <button type="button" class="player-btn" aria-label=${B?"Unmute":"Mute"} onClick=${we}>
          ${M(B?"volumeX":"volume2",{size:14})}
        </button>
        <input class="player-volume" type="range" min="0" max="1" step="0.01" value=${B?0:y}
          aria-label="Volume" onInput=${g} />
  ...
  </div>`}Q();function gs(e){let t=new Map(e.map(s=>[s.id,s])),n=new Map,a=[],r=0;return e.forEach(s=>{let i=s.parent_comment_id||"";i&&t.has(i)?(n.has(i)||n.set(i,[]),n.get(i).push(s),r+=1):i||(a.push(s),r+=1)}),{roots:a,repliesByParent:n,count:r}}function ys(e){return(e||"?").trim().slice(0,1).toUpperCase()||"?"}function ks(e){let t=e.author_avatar_url;return typeof t=="string"&&t.startsWith("/")?o`<img class="comment-avatar" src=${t} alt="" />`:o`<div class="comment-avatar">${ys(e.author_name)}</div>`}function aa({shareId:e}){let{user:t}=q(A),[n,a]=_(null),[r,s]=_(""),[i,c]=_(null),[d,u]=_(""),[p,v]=_(null);function l(){k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`).then(y=>a(y.comments||[])).catch(()=>a([]))}C(()=>{let y=!0;return a(null),k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`).then(R=>y&&a(R.comments||[])).catch(()=>y&&a([])),()=>{y=!1}},[e]);async function m(y,R){let B=y.trim();if(B)try{await k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`,{method:"POST",body:R?{body:B,parent_comment_id:R}:{body:B}}),l()}catch(G){w(G.message)}}async function h(y){y.preventDefault(),await m(r),s("")}async function $(y,R){y.preventDefault(),await m(d,R),u(""),c(null)}async function S(){let y=p;v(null);try{await k(`/api/v1/public/clips/${encodeURIComponent(e)}/comments/${encodeURIComponent(y)}`,{method:"DELETE"}),l()}catch(R){w(R.message)}}let x=gs(n||[]);return o`<section class="comments">
    <div class="comments-header"><h2>Comments</h2><span class="muted">${x.count}</span></div>
    ${t?o`<form class="comment-form" onSubmit=${h}>
    ...
    ${n==null?"":x.count===0?o`<p class="comment-signin">No comments yet.</p>`:o`<div class="comment-list">
          ${x.roots.map(y=>sa(y,{depth:0,repliesByParent:x.repliesByParent,user:t,replyOpenId:i,setReplyOpenId:c,replyDraft:d,setReplyDraft:u,submitReply:$,onDelete:v}))}
        </div>`}
  ...
  </article>`}var ws=["private","public","unlisted"];function Ss(e,t){return e==="clip"?!0:!!t?.viewer_can_edit}function xs(e,t,n){return e==="public"?t.shareId:n?.public_share_id||null}function Cs(e,t,n){return e==="clip"?t.clipId:n?.viewer_clip_id||null}function Ts(e){let t=e?.height!=null?e.height:"",n=Math.round(e?.fps||0)||"";return`${t}p${n}`}function Ms(e,t=8){let n=new URLSearchParams;return e&&n.set("share_id",e),n.set("limit",String(t)),`/api/v1/public/recommendations?${n}`}function Ps(e,t,n=8){return(e||[]).filter(a=>a.share_id!==t).slice(0,n)}function Pt({route:e}){let{user:t}=q(A),[n,a]=_(null),[r,s]=_(null),[i,c]=_([]),[d,u]=_(!1),[p,v]=_(""),[l,m]=_(!1),[h,$]=_(""),[S,x]=_(!1),[y,R]=_(!1),[B,G]=_(!1),J=e.name==="clip"?`clip:${e.clipId}`:`public:${e.shareId}`,re=xs(e.name,e,n),V=e.name==="public"||!!n;if(C(()=>{let b=!0;a(null),s(null),u(!1),m(!1),G(!1),x(!1);let P=e.name==="clip"?`/api/v1/clips/${encodeURIComponent(e.clipId)}`:`/api/v1/public/clips/${encodeURIComponent(e.shareId)}`;return k(P).then(I=>{b&&(a(I),e.name==="public"&&k(`/api/v1/public/clips/${encodeURIComponent(e.shareId)}/view`,{method:"POST",body:{}}).then(D=>b&&a(U=>U&&{...U,view_count:D.view_count})).catch(()=>{}))}).catch(I=>b&&s(I)),()=>{b=!1}},[J]),C(()=>{let b=!0;return V?(c([]),k(Ms(re,8)).then(P=>b&&c(P.clips||[])).catch(()=>{}),()=>{b=!1}):(c([]),()=>{b=!1})},[J,re,V]),r)return o`<main class="page"><${Z} name="alert" title="Couldn't load this clip" body=${r.message} /></main>`;if(!n)return o`<main class="page watch"><div><div class="skeleton-thumb"></div></div><aside class="upnext"></aside></main>`;let te=Ss(e.name,n),L=re,Y=Cs(e.name,e,n),ke=e.name==="clip"?Xe({id:n.id}):xe({share_id:e.shareId}),ne=e.name==="clip"?Ee({id:n.id}):se({share_id:e.shareId}),be=e.name==="clip"?t?.display_name||t?.username||"You":n.author_name||"Unknown creator",ve=n.public_url??n.share_url??null,pe=Re(ve,window.location.origin,L),ce=e.name==="clip";function me(){v(n.title),u(!0)}async function X(b){b?.preventDefault?.();let P=p.trim();if(!P||P===n.title){u(!1);return}try{await k(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"PATCH",body:{title:P}}),a(I=>({...I,title:P})),u(!1),w("Title saved.")}catch(I){w(I.message)}}function oe(){$(n.description||""),m(!0)}async function ie(){let b=h.trim();try{await k(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"PATCH",body:{description:b||null}}),a(P=>({...P,description:b||null})),m(!1),w("Description saved.")}catch(P){w(P.message)}}async function $e(b,{force:P=!1}={}){let I=n.visibility;if(!(I===b&&!P)){a(D=>({...D,visibility:b}));try{let D=await k(`/api/v1/clips/${encodeURIComponent(Y)}/visibility`,{method:"POST",body:{visibility:b}});a(U=>({...U,visibility:D.visibility,public_url:D.public_url,public_share_id:D.public_share_id})),w(`Visibility set to ${b}.`,{actionLabel:"Undo",onAction:()=>$e(I,{force:!0})})}catch(D){a(U=>({...U,visibility:I})),w(D.message)}}}async function ge(){if(pe)try{await navigator.clipboard.writeText(pe),w("Link copied.")}catch{w("Couldn't copy the link.")}}async function we(){R(!1);try{await k(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"DELETE"}),w("Clip deleted."),W("/library")}catch(b){w(b.message)}}let g=[n.game_name&&o`<a class="chip chip-on" href=${`/game/${encodeURIComponent(n.game_name)}`}>${n.game_name}</a>`,ye(n.view_count),`Recorded ${j(n.recorded_at)}`,`by ${be}`].filter(Boolean),T=Ps(i,L,8);return o`<main class="page watch">
    <div>
      ...
      <div class="watch-titlerow">
        ${d?o`<input class="input watch-title-input" value=${p} autofocus
              onInput=${b=>v(b.target.value)} onBlur=${X}
              onKeyDown=${b=>{b.key==="Enter"&&X(b),b.key==="Escape"&&u(!1)}} />`:o`<h1>${n.title}
              ${te&&o`<button type="button" class="edit-pencil" aria-label="Edit title" onClick=${me}
                >${M("edit",{size:14})}</button>`}</h1>`}
      </div>
      <p class="watch-meta">${g.map((b,P)=>o`${P>0?" \xB7 ":""}${b}`)}</p>

      ${te&&o`<div class="watch-actions">
        <div class="seg" role="radiogroup" aria-label="Visibility">
          ${ws.map(b=>o`<button type="button" role="radio" key=${b} aria-checked=${n.visibility===b}
              class=${`seg-item ${n.visibility===b?"seg-on":""}`} onClick=${()=>$e(b)}
        ...
        <div class="watch-more">
          ...
          ${S&&o`<div class="menu" role="menu">
            <button type="button" class="menu-danger" role="menuitem"
              onClick=${()=>{x(!1),R(!0)}}>${M("trash",{size:14})} Delete clip</button>
          </div>`}
        </div>
      </div>`}

      <div class="watch-desc">
        ${l?o`<textarea class="input" rows="5" value=${h} autofocus
              onInput=${b=>$(b.target.value)} onBlur=${ie}
              onKeyDown=${b=>{b.key==="Enter"&&(b.ctrlKey||b.metaKey)&&ie(),b.key==="Escape"&&m(!1)}}></textarea>`:n.description?o`<p>${n.description}
      ...
      ${ce&&o`<button type="button" class="details-strip" aria-expanded=${B}
        onClick=${()=>G(b=>!b)}>
    ...
    <aside class="upnext">
      ...
      ${T.map(b=>o`<a class="upnext-row" key=${b.share_id} href=${`/c/${encodeURIComponent(b.share_id)}`}>
          <img src=${se(b)} alt="" loading="lazy" />
          <span><b>${b.title}</b><small>${b.author_name} · ${b.game_name||"No game"} · ${ye(b.view_count)}</small></span>
        </a>`)}
    </aside>
  ...
  </main>`}Q();var Et=[{top:"4%",left:"4%",width:"34%",rotate:-7},{top:"0%",left:"44%",width:"30%",rotate:5},{top:"34%",left:"68%",width:"28%",rotate:-4},{top:"50%",left:"8%",width:"30%",rotate:6},{top:"62%",left:"42%",width:"26%",rotate:-5},{top:"26%",left:"-4%",width:"22%",rotate:9}];function Es(e){return Array.isArray(e)?e.slice(0,Et.length).map((t,n)=>({clip:t,...Et[n]})):[]}function Rs(e){let t=e?.clips;if(!Array.isArray(t)||t.length===0)return null;let n=t.length,a=e.has_more?"+":"";return`${n}${a} clip${n===1?"":"s"} on this instance`}function Ds({top:e,left:t,width:n,rotate:a}){return`top:${e};left:${t};width:${n};transform:rotate(${a}deg);`}function ra(e){let t=String(e||"").trim();return t||null}function Us(){let[e,t]=_(null);C(()=>{let r=!0;return k(`/api/v1/public/clips?page_size=${Et.length}`).then(s=>r&&t(s)).catch(()=>r&&t(null)),()=>{r=!1}},[]);let n=Es(e?.clips),a=Rs(e);return o`<aside class="login-montage" aria-hidden="true">
    ${n.length>0&&o`<div class="login-montage-tiles">
      ${n.map((r,s)=>o`<img key=${s} class="login-montage-tile" style=${Ds(r)}
  ...
  </${Te}>`}function ia({route:e}){let t=!!e.invite,[n,a]=_(()=>t?"preflight":e.token?"form":"missing-token"),[r,s]=_(""),[i,c]=_(t?null:e.token),[d,u]=_(""),[p,v]=_(!1),l=t;C(()=>{if(!t)return;if(!e.token){a("missing-token");return}let S=!0;return a("preflight"),k("/api/v1/invites/claim",{method:"POST",body:{invite_token:e.token}}).then(x=>{S&&(c(x.reset_token),a("form"))}).catch(x=>{S&&(s(x instanceof _e?x.message:"This invite link is invalid, used, or expired."),a("invalid"))}),()=>{S=!1}},[t,e.token]);async function m(S){if(S.preventDefault(),p)return;v(!0),u("");let x=new FormData(S.currentTarget),y={reset_token:i,new_password:String(x.get("new_password")||"")};l&&(y.username=String(x.get("username")||""),y.display_name=ra(x.get("display_name")),y.email=ra(x.get("email")));try{await k("/api/v1/auth/reset-password",{method:"POST",body:y}),w(l?"Account created. Sign in with your new password.":"Password set. Sign in with your new password."),W("/login")}catch(R){u(R instanceof _e?R.message:"Request failed"),v(!1)}}if(t&&n!=="form"){let S=n==="missing-token"||n==="invalid",x=n==="missing-token"?"This invite link is missing a token.":n==="invalid"?r:"Opening invite\u2026";return o`<${Te} titleId="invite-title">
  ...
  </div>`}function Ls(e){let t=Number(e?.global_storage_warning_threshold_bytes||0);if(!t)return null;let n=Number(e?.total_storage_bytes||0);return Math.max(0,Math.min(1,n/t))}function Is(e){if(!e?.global_storage_warning_threshold_bytes)return"Disabled";let t=K(e.global_storage_warning_threshold_bytes);return e.global_storage_warning?`At or above ${t}`:`Below ${t}`}function As({deadJobs:e=[],failedUploads:t=[]}={}){let n=e.length+t.length;return{failedCount:n,healthy:n===0}}function ee(e,t){return o`<div><dt>${e}</dt><dd>${t??"Unknown"}</dd></div>`}function la({overview:e,deadJobs:t,failedUploads:n}){let a=Ls(e),{failedCount:r,healthy:s}=As({deadJobs:t,failedUploads:n}),i=e.global_storage_warning_threshold_bytes;return o`<div>
    <div class="stat-grid">
    ...
    <div class="panel">
      ...
      <dl class="ad-kv">
        ...
        ${ee("Stored clips",`${e.total_clips} clips \u2014 ${K(e.total_storage_bytes)}`)}
        ${ee("Users",`${e.total_users} total`)}
        ${ee("Max upload",K(e.max_upload_size_bytes))}
        ${ee("Part size",K(e.upload_part_size_bytes))}
        ${ee("Single PUT max",K(e.single_put_max_bytes))}
        ${ee("Active uploads/user",e.max_active_upload_sessions_per_user)}
        ${ee("User quota",e.user_storage_quota_bytes?K(e.user_storage_quota_bytes):"Disabled")}
        ${ee("Storage warning",Is(e))}
  ...
  </div>`}Q();function ot(e){let t=String(e||"").trim();return t||null}function Ns(e){let t=Number(String(e||"").trim());if(!Number.isFinite(t)||t<0)throw new Error("Storage quota must be a non-negative number");return Math.round(t*1024*1024*1024)}function Fs(e,t){return!(e.is_disabled||t?.id===e.id||e.role==="owner"||e.role==="admin"&&t?.role!=="owner")}function ca(e){return e?[["user","User"],["admin","Admin"]]:[["user","User"]]}function zs({isOwner:e,onCreated:t}){let[n,a]=_(!1);async function r(s){if(s.preventDefault(),n)return;a(!0);let i=s.currentTarget,c=new FormData(i);try{await k("/api/v1/users",{method:"POST",body:{username:String(c.get("username")||""),display_name:ot(c.get("display_name")),email:ot(c.get("email")),password:ot(c.get("password")),role:String(c.get("role")||"user")}}),w("User created."),i.reset(),t()}catch(d){w(d.message)}finally{a(!1)}}return o`<form class="panel section" onSubmit=${r}>
    <h2>Create user</h2>
  ...
  </form>`}function Bs({isOwner:e,smtpEnabled:t,onCreated:n}){let[a,r]=_(!1);async function s(i){if(i.preventDefault(),a)return;r(!0);let c=new FormData(i.currentTarget),d=i.submitter?.value==="email"?"email":"link";try{let u=await k("/api/v1/invites",{method:"POST",body:{role:String(c.get("role")||"user"),email:ot(c.get("email")),send_email:d==="email"}});w(d==="email"?"Invite sent.":"Invite link created."),n({...u,kind:"invite"})}catch(u){w(u.message)}finally{r(!1)}}return o`<form class="panel section" onSubmit=${s}>
    <h2>Invite link</h2>
    <label class="field"><span>Role</span>
      <select class="input" name="role">
  ...
  </form>`}function Os({resetLink:e}){if(!e)return null;let t=e.kind==="invite"?"Invite":"Reset",n=e.username?` for ${e.username}`:"",a=async()=>{try{await navigator.clipboard.writeText(e.reset_url),w("Copied to clipboard.")}catch{w("Copy failed. Select and copy the URL manually.")}};return o`<div class="notice admin-reset-link">
    <div>
  ...
  </div>`}function Vs(e){return e.is_disabled?o`<span class="badge badge-warn">Disabled</span>`:o`<span class="badge badge-public">Active</span>`}function Hs({user:e,currentUser:t,onQuota:n,onReset:a,onDisable:r}){let s=e.storage_quota_bytes!=null?K(e.storage_quota_bytes):"No limit",i=!Fs(e,t);return o`<tr>
    <td>
  ...
  </tr>`}function ua({users:e,settings:t,currentUser:n,resetLink:a,setResetLink:r,reload:s}){let[i,c]=_(null),d=n?.role==="owner",u=!!t?.smtp_enabled,p=()=>c(null);async function v(){let{type:m,user:h,value:$}=i;p();try{if(m==="quota"){let S=$.trim()?Ns($):null;await k(`/api/v1/users/${encodeURIComponent(h.id)}`,{method:"PATCH",body:{storage_quota_bytes:S}}),w("Storage quota updated.")}else if(m==="disable")await k(`/api/v1/users/${encodeURIComponent(h.id)}`,{method:"DELETE",body:{reauth_password:$}}),w("User disabled.");else if(m==="reset"){let S=await k(`/api/v1/users/${encodeURIComponent(h.id)}/reset-password`,{method:"POST",body:{reauth_password:$}});r({...S,kind:"reset"}),w("Reset link created.")}s()}catch(S){w(S.message)}}let l={quota:{title:"Set storage quota",description:"Enter a per-user storage limit in GiB. Leave it blank to remove the per-user limit.",confirmLabel:"Save quota",danger:!1,field:o`<label class="field"><span>Quota GiB</span>
        <input class="input" type="number" min="0" step="0.1" placeholder="No per-user limit"
          value=${i?.value||""} onInput=${m=>c(h=>({...h,value:m.target.value}))} /></label>`},disable:{title:"Disable user?",description:"This immediately revokes the user's sessions and device tokens.",confirmLabel:"Disable",danger:!0,field:o`<label class="field"><span>Your password</span>
        <input class="input" type="password" required value=${i?.value||""}
          onInput=${m=>c(h=>({...h,value:m.target.value}))} /></label>`},reset:{title:"Create reset link?",description:"This creates a temporary password reset link for the selected user.",confirmLabel:"Create link",danger:!1,field:o`<label class="field"><span>Your password</span>
        <input class="input" type="password" required value=${i?.value||""}
          onInput=${m=>c(h=>({...h,value:m.target.value}))} /></label>`}}[i?.type];return o`<div class="admin-grid">
    <div class="admin-side-stack">
      <${zs} isOwner=${d} onCreated=${()=>{r(null),s()}} />
      <${Bs} isOwner=${d} smtpEnabled=${u}
        onCreated=${m=>{r(m),s()}} />
    </div>
    <div class="panel">
      ...
      <div class="table-wrap">
        <table class="lib-table">
          ...
          <tbody>
            ${e.map(m=>o`<${Hs} key=${m.id} user=${m} currentUser=${n}
  ...
  </form>`}function qs(e){return`${(e/100).toFixed(e%100===0?0:1)}%`}function Ks(e){switch(e){case"delete_and_retry":return"delete the failed upload and retry from a new session";case"retry":return"retry the current upload request";default:return""}}function Gs({upload:e}){let t=Math.max(0,Math.min(1e4,Number(e.progress_basis_points||0))),n=Ks(e.recovery_action);return o`<div class="job-item">
    <div class="job-title-line">
      <strong class="mono">${e.id}</strong>
      <span class="badge badge-warn">${qs(t)}</span>
    </div>
    ...
    <${Rt} title="Failed uploads" items=${e} emptyLabel="No failed uploads."
      renderItem=${a=>o`<${Gs} key=${a.id} upload=${a} />`} />
    ...
    <${Rt} title="Recent job errors" items=${n} emptyLabel="No recent job errors."
      renderItem=${a=>o`<${pa} key=${a.id} job=${a} />`} />
  </div>`}var fa=[["overview","server","Overview"],["users","users","Users"],["settings","sliders","Settings"],["jobs","alert","Jobs"]];function Ws(e){return e?.role==="admin"||e?.role==="owner"}async function js(){let[e,t,n,a,r,s]=await Promise.all([k("/api/v1/admin/overview"),k("/api/v1/admin/settings"),k("/api/v1/users"),k("/api/v1/admin/uploads/failed?limit=50"),k("/api/v1/admin/jobs/dead?limit=50"),k("/api/v1/admin/jobs/recent-errors?limit=50")]);return{overview:e,settings:t,users:n,failedUploads:a,deadJobs:r,recentErrors:s}}function _a({route:e}){let{user:t}=q(A),n=Ws(t),a=!!(t&&!n),r=fa.some(([h])=>h===e.tab)?e.tab:"overview",[s,i]=_(null),[c,d]=_(null),[u,p]=_(null),[v,l]=_(0),m=()=>l(h=>h+1);return C(()=>{a&&(w("Admin access required."),W("/library"))},[a]),C(()=>{if(!n)return;let h=!0;return d(null),js().then($=>h&&i($)).catch($=>h&&d($)),()=>{h=!1}},[n,v]),n?o`<main class="page">
    <h1>Admin</h1>
    <p class="page-subtitle">Accounts, instance summary, and processing diagnostics.</p>
    <nav class="ad-tabs" aria-label="Admin views">
      ${fa.map(([h,$,S])=>o`<a key=${h} class=${`ad-tab ${h===r?"ad-tab-on":""}`}
        href=${`/admin?tab=${h}`} aria-current=${h===r?"page":void 0}>${M($,{size:14})} ${S}</a>`)}
    </nav>
    ${c?o`<${Z} name="alert" title="Couldn't load admin data" body=${c.message} />`:s?r==="users"?o`<${ua} users=${s.users} settings=${s.settings} currentUser=${t}
          resetLink=${u} setResetLink=${p} reload=${m} />`:r==="settings"?o`<${da} settings=${s.settings} isOwner=${t?.role==="owner"} reload=${m} />`:r==="jobs"?o`<${ma} failedUploads=${s.failedUploads} deadJobs=${s.deadJobs} recentErrors=${s.recentErrors} />`:o`<${la} overview=${s.overview} deadJobs=${s.deadJobs} failedUploads=${s.failedUploads} />`:o`<p class="empty-state">Loading admin data…</p>`}
  </main>`:null}Q();function Zs(e){if(!e?.avatar_url)return"";let t=e.updated_at||"";if(!t)return e.avatar_url;let n=String(e.avatar_url).includes("?")?"&":"?";return`${e.avatar_url}${n}v=${encodeURIComponent(t)}`}function Js(e){return(e||"C").trim().slice(0,1).toUpperCase()||"C"}function lt({user:e,size:t=40,className:n=""}){let a=Zs(e),r=`width:${t}px;height:${t}px;font-size:${Math.round(t*.4)}px`;if(a)return o`<img class=${`user-avatar ${n}`} style=${r} src=${a} alt="" />`;let s=e?.display_name||e?.username;return o`<div class=${`user-avatar user-avatar-fallback ${n}`} style=${r} aria-hidden="true">
    ${Js(s)}
  </div>`}function ha(e){let t=String(e||"").trim();return t||null}async function Ys(e){let t=new Headers;t.set("Accept","application/json"),t.set("Content-Type",e.type||"application/octet-stream");let n=kt();n&&t.set("X-CSRF-Token",n);let a=await fetch("/api/v1/me/avatar",{method:"PUT",credentials:"same-origin",headers:t,body:e}),r=await a.json().catch(()=>({}));if(!a.ok)throw new Error(r.error||a.statusText||"Avatar upload failed");return r}function ba(e){A.set({...A.get(),user:e})}function Xs({user:e}){let[t,n]=_(!1);async function a(r){if(r.preventDefault(),t)return;n(!0);let s=new FormData(r.currentTarget);try{let i=await k("/api/v1/me/profile",{method:"PATCH",body:{display_name:ha(s.get("display_name")),bio:ha(s.get("bio"))}});ba(i),w("Profile saved.")}catch(i){w(i.message)}finally{n(!1)}}return o`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function Qs({user:e}){let[t,n]=_(!1);async function a(r){if(r.preventDefault(),t)return;let s=r.currentTarget.elements.avatar?.files?.[0];if(!s){w("Choose an avatar image first.");return}n(!0);try{let i=await Ys(s);ba(i),w("Avatar uploaded.")}catch(i){w(i.message)}finally{n(!1)}}return o`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function va(){let{user:e}=q(A);return e?o`<main class="page">
    <h1>Profile</h1>
  ...
  </main>`:null}Q();async function er(){let[e,t]=await Promise.all([k("/api/v1/auth/sessions"),k("/api/v1/auth/device-tokens")]);return{sessions:e,deviceTokens:t}}function tr({item:e,onRevoke:t}){return o`<div class="management-item">
    <div>
  ...
  </div>`}function nr({item:e,onRevoke:t}){let n=!!e.revoked_at;return o`<div class="management-item">
    <div>
    ...
    ${e?o`<div class="account-grid">
          <div class="panel">
            ...
            ${e.sessions.length?o`<div class="management-list">${e.sessions.map(p=>o`<${tr} key=${p.id} item=${p}
          ...
          <div class="panel">
            ...
            ${e.deviceTokens.length?o`<div class="management-list">${e.deviceTokens.map(p=>o`<${nr} key=${p.id} item=${p}
  ...
  </main>`}Q();var ya="Clipline is a self-hosted clip library for saved gameplay moments.";function ct(e,t){return o`<div><dt>${e}</dt><dd>${t}</dd></div>`}function ka(){let[e,t]=_(ya);return C(()=>{let n=!0;return k("/api/v1/about").then(a=>n&&t(a.about_text||ya)).catch(()=>{}),()=>{n=!1}},[]),o`<main class="page">
    <h1>About</h1>
  ...
  </main>`}var ar={publicLibrary:et,publicGame:et,games:Fn,library:qn,clip:Pt,public:Pt,login:oa,resetPassword:ia,admin:_a,profile:va,account:$a,publicUser:ga,about:ka},wa=Cn({pathname:window.location.pathname,search:window.location.search});function sr(){let e=Mn();wa=e.name;let{ready:t,user:n}=q(A),a=t&&Sn(e.name,n);if(C(()=>{a&&W("/login")},[a]),!t||a)return o`<div class="boot">Loading…</div>`;let r=ar[e.name]||et,s=e.name==="login"||e.name==="resetPassword";return o`<div class="ui" onClick=${Pn}>
    ${!s&&o`<${Rn} active=${St(e)} route=${e} />`}
    <${r} route=${e} />
    ${!s&&o`<${Dn} active=${xn(e)} />`}
    <${Un} />
  </div>`}window.addEventListener("clipline:unauthorized",()=>{de(null),A.set({user:null,csrfToken:null,ready:!0}),wt(wa)||W("/login")});(async()=>{try{let t=await k("/api/v1/auth/me");de(t.csrf_token),A.set({user:t.user,csrfToken:t.csrf_token,ready:!0})}catch{de(null),A.set({user:null,csrfToken:null,ready:!0})}let e=document.querySelector("#app");e.textContent="",an(o`<${sr} />`,e)})();
