var Ma=Object.defineProperty;var Pa=(e,t)=>()=>(e&&(t=e(e=0)),t);var Ea=(e,t)=>{for(var n in t)Ma(e,n,{get:t[n],enumerable:!0})};var wn={};Ea(wn,{ApiError:()=>he,api:()=>y,getCsrfToken:()=>wt,setCsrfToken:()=>ue});function ue(e){We=e}function wt(){return We}async function y(e,t={}){let n=(t.method||"GET").toUpperCase(),a=new Headers(t.headers||{});a.set("Accept","application/json");let r=t.body;r&&typeof r!="string"&&(a.set("Content-Type","application/json"),r=JSON.stringify(r)),!["GET","HEAD","OPTIONS"].includes(n)&&We&&a.set("X-CSRF-Token",We);let s=await fetch(e,{...t,body:r,credentials:"same-origin",headers:a,method:n}),c=(s.headers.get("content-type")||"").includes("application/json")?await s.json():await s.text();if(!s.ok){s.status===401&&window.dispatchEvent(new CustomEvent("clipline:unauthorized"));let d=typeof c=="object"&&c?.error?c.error:s.statusText;throw new he(d||"Request failed",s.status)}return c}var We,he,Q=Pa(()=>{We=null;he=class extends Error{constructor(t,n){super(t),this.status=n}}});var He,F,jt,Ra,fe,qt,Zt,Jt,pt,Ne,Pe,Yt,ht,mt,ft,Ua,Be={},Ve=[],Da=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,qe=Array.isArray;function ce(e,t){for(var n in t)e[n]=t[n];return e}function _t(e){e&&e.parentNode&&e.parentNode.removeChild(e)}function bt(e,t,n){var a,r,s,i={};for(s in t)s=="key"?a=t[s]:s=="ref"?r=t[s]:i[s]=t[s];if(arguments.length>2&&(i.children=arguments.length>3?He.call(arguments,2):n),typeof e=="function"&&e.defaultProps!=null)for(s in e.defaultProps)i[s]===void 0&&(i[s]=e.defaultProps[s]);return Fe(e,i,a,r,null)}function Fe(e,t,n,a,r){var s={type:e,props:t,key:n,ref:a,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:r??++jt,__i:-1,__u:0};return r==null&&F.vnode!=null&&F.vnode(s),s}function Ge(e){return e.children}function ze(e,t){this.props=e,this.context=t}function Se(e,t){if(t==null)return e.__?Se(e.__,e.__i+1):null;for(var n;t<e.__k.length;t++)if((n=e.__k[t])!=null&&n.__e!=null)return n.__e;return typeof e.type=="function"?Se(e):null}function La(e){if(e.__P&&e.__d){var t=e.__v,n=t.__e,a=[],r=[],s=ce({},t);s.__v=t.__v+1,F.vnode&&F.vnode(s),vt(e.__P,s,t,e.__n,e.__P.namespaceURI,32&t.__u?[n]:null,a,n??Se(t),!!(32&t.__u),r),s.__v=t.__v,s.__.__k[s.__i]=s,nn(a,s,r),t.__e=t.__=null,s.__e!=n&&Xt(s)}}function Xt(e){if((e=e.__)!=null&&e.__c!=null)return e.__e=e.__c.base=null,e.__k.some(function(t){if(t!=null&&t.__e!=null)return e.__e=e.__c.base=t.__e}),Xt(e)}function Gt(e){(!e.__d&&(e.__d=!0)&&fe.push(e)&&!Oe.__r++||qt!=F.debounceRendering)&&((qt=F.debounceRendering)||Zt)(Oe)}function Oe(){try{for(var e,t=1;fe.length;)fe.length>t&&fe.sort(Jt),e=fe.shift(),t=fe.length,La(e)}finally{fe.length=Oe.__r=0}}function Qt(e,t,n,a,r,s,i,c,d,u,p){var b,l,h,f,w,x,C,g=a&&a.__k||Ve,R=t.length;for(d=Ia(n,t,g,d,R),b=0;b<R;b++)(h=n.__k[b])!=null&&(l=h.__i!=-1&&g[h.__i]||Be,h.__i=b,x=vt(e,h,l,r,s,i,c,d,u,p),f=h.__e,h.ref&&l.ref!=h.ref&&(l.ref&&$t(l.ref,null,h),p.push(h.ref,h.__c||f,h)),w==null&&f!=null&&(w=f),(C=!!(4&h.__u))||l.__k===h.__k?(d=en(h,d,e,C),C&&l.__e&&(l.__e=null)):typeof h.type=="function"&&x!==void 0?d=x:f&&(d=f.nextSibling),h.__u&=-7);return n.__e=w,d}function Ia(e,t,n,a,r){var s,i,c,d,u,p=n.length,b=p,l=0;for(e.__k=new Array(r),s=0;s<r;s++)(i=t[s])!=null&&typeof i!="boolean"&&typeof i!="function"?(typeof i=="string"||typeof i=="number"||typeof i=="bigint"||i.constructor==String?i=e.__k[s]=Fe(null,i,null,null,null):qe(i)?i=e.__k[s]=Fe(Ge,{children:i},null,null,null):i.constructor===void 0&&i.__b>0?i=e.__k[s]=Fe(i.type,i.props,i.key,i.ref?i.ref:null,i.__v):e.__k[s]=i,d=s+l,i.__=e,i.__b=e.__b+1,c=null,(u=i.__i=Aa(i,n,d,b))!=-1&&(b--,(c=n[u])&&(c.__u|=2)),c==null||c.__v==null?(u==-1&&(r>p?l--:r<p&&l++),typeof i.type!="function"&&(i.__u|=4)):u!=d&&(u==d-1?l--:u==d+1?l++:(u>d?l--:l++,i.__u|=4))):e.__k[s]=null;if(b)for(s=0;s<p;s++)(c=n[s])!=null&&(2&c.__u)==0&&(c.__e==a&&(a=Se(c)),sn(c,c));return a}function en(e,t,n,a){var r,s;if(typeof e.type=="function"){for(r=e.__k,s=0;r&&s<r.length;s++)r[s]&&(r[s].__=e,t=en(r[s],t,n,a));return t}e.__e!=t&&(a&&(t&&e.type&&!t.parentNode&&(t=Se(e)),n.insertBefore(e.__e,t||null)),t=e.__e);do t=t&&t.nextSibling;while(t!=null&&t.nodeType==8);return t}function Aa(e,t,n,a){var r,s,i,c=e.key,d=e.type,u=t[n],p=u!=null&&(2&u.__u)==0;if(u===null&&c==null||p&&c==u.key&&d==u.type)return n;if(a>(p?1:0)){for(r=n-1,s=n+1;r>=0||s<t.length;)if((u=t[i=r>=0?r--:s++])!=null&&(2&u.__u)==0&&c==u.key&&d==u.type)return i}return-1}function Kt(e,t,n){t[0]=="-"?e.setProperty(t,n??""):e[t]=n==null?"":typeof n!="number"||Da.test(t)?n:n+"px"}function Ae(e,t,n,a,r){var s,i;e:if(t=="style")if(typeof n=="string")e.style.cssText=n;else{if(typeof a=="string"&&(e.style.cssText=a=""),a)for(t in a)n&&t in n||Kt(e.style,t,"");if(n)for(t in n)a&&n[t]==a[t]||Kt(e.style,t,n[t])}else if(t[0]=="o"&&t[1]=="n")s=t!=(t=t.replace(Yt,"$1")),i=t.toLowerCase(),t=i in e||t=="onFocusOut"||t=="onFocusIn"?i.slice(2):t.slice(2),e.l||(e.l={}),e.l[t+s]=n,n?a?n[Pe]=a[Pe]:(n[Pe]=ht,e.addEventListener(t,s?ft:mt,s)):e.removeEventListener(t,s?ft:mt,s);else{if(r=="http://www.w3.org/2000/svg")t=t.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(t!="width"&&t!="height"&&t!="href"&&t!="list"&&t!="form"&&t!="tabIndex"&&t!="download"&&t!="rowSpan"&&t!="colSpan"&&t!="role"&&t!="popover"&&t in e)try{e[t]=n??"";break e}catch{}typeof n=="function"||(n==null||n===!1&&t[4]!="-"?e.removeAttribute(t):e.setAttribute(t,t=="popover"&&n==1?"":n))}}function Wt(e){return function(t){if(this.l){var n=this.l[t.type+e];if(t[Ne]==null)t[Ne]=ht++;else if(t[Ne]<n[Pe])return;return n(F.event?F.event(t):t)}}}function vt(e,t,n,a,r,s,i,c,d,u){var p,b,l,h,f,w,x,C,g,R,j,Z,J,se,V,te,I=t.type;if(t.constructor!==void 0)return null;128&n.__u&&(d=!!(32&n.__u),s=[c=t.__e=n.__e]),(p=F.__b)&&p(t);e:if(typeof I=="function"){b=i.length;try{if(g=t.props,R=I.prototype&&I.prototype.render,j=(p=I.contextType)&&a[p.__c],Z=p?j?j.props.value:p.__:a,n.__c?C=(l=t.__c=n.__c).__=l.__E:(R?t.__c=l=new I(g,Z):(t.__c=l=new ze(g,Z),l.constructor=I,l.render=Fa),j&&j.sub(l),l.state||(l.state={}),l.__n=a,h=l.__d=!0,l.__h=[],l._sb=[]),R&&l.__s==null&&(l.__s=l.state),R&&I.getDerivedStateFromProps!=null&&(l.__s==l.state&&(l.__s=ce({},l.__s)),ce(l.__s,I.getDerivedStateFromProps(g,l.__s))),f=l.props,w=l.state,l.__v=t,h)R&&I.getDerivedStateFromProps==null&&l.componentWillMount!=null&&l.componentWillMount(),R&&l.componentDidMount!=null&&l.__h.push(l.componentDidMount);else{if(R&&I.getDerivedStateFromProps==null&&g!==f&&l.componentWillReceiveProps!=null&&l.componentWillReceiveProps(g,Z),t.__v==n.__v||!l.__e&&l.shouldComponentUpdate!=null&&l.shouldComponentUpdate(g,l.__s,Z)===!1){t.__v!=n.__v&&(l.props=g,l.state=l.__s,l.__d=!1),t.__e=n.__e,t.__k=n.__k,t.__k.some(function(Y){Y&&(Y.__=t)}),Ve.push.apply(l.__h,l._sb),l._sb=[],l.__h.length&&i.push(l);break e}l.componentWillUpdate!=null&&l.componentWillUpdate(g,l.__s,Z),R&&l.componentDidUpdate!=null&&l.__h.push(function(){l.componentDidUpdate(f,w,x)})}if(l.context=Z,l.props=g,l.__P=e,l.__e=!1,J=F.__r,se=0,R)l.state=l.__s,l.__d=!1,J&&J(t),p=l.render(l.props,l.state,l.context),Ve.push.apply(l.__h,l._sb),l._sb=[];else do l.__d=!1,J&&J(t),p=l.render(l.props,l.state,l.context),l.state=l.__s;while(l.__d&&++se<25);l.state=l.__s,l.getChildContext!=null&&(a=ce(ce({},a),l.getChildContext())),R&&!h&&l.getSnapshotBeforeUpdate!=null&&(x=l.getSnapshotBeforeUpdate(f,w)),V=p!=null&&p.type===Ge&&p.key==null?an(p.props.children):p,c=Qt(e,qe(V)?V:[V],t,n,a,r,s,i,c,d,u),l.base=t.__e,t.__u&=-161,l.__h.length&&i.push(l),C&&(l.__E=l.__=null)}catch(Y){if(i.length=b,t.__v=null,d||s!=null){if(Y.then){for(t.__u|=d?160:128;c&&c.nodeType==8&&c.nextSibling;)c=c.nextSibling;s!=null&&(s[s.indexOf(c)]=null),t.__e=c}else if(s!=null)for(te=s.length;te--;)_t(s[te])}else t.__e=n.__e;t.__k==null&&(t.__k=n.__k||[]),Y.then||tn(t),F.__e(Y,t,n)}}else s==null&&t.__v==n.__v?(t.__k=n.__k,t.__e=n.__e):c=t.__e=Na(n.__e,t,n,a,r,s,i,d,u);return(p=F.diffed)&&p(t),128&t.__u?void 0:c}function tn(e){e&&(e.__c&&(e.__c.__e=!0),e.__k&&e.__k.some(tn))}function nn(e,t,n){for(var a=0;a<n.length;a++)$t(n[a],n[++a],n[++a]);F.__c&&F.__c(t,e),e.some(function(r){try{e=r.__h,r.__h=[],e.some(function(s){s.call(r)})}catch(s){F.__e(s,r.__v)}})}function an(e){return typeof e!="object"||e==null||e.__b>0?e:qe(e)?e.map(an):e.constructor!==void 0?null:ce({},e)}function Na(e,t,n,a,r,s,i,c,d){var u,p,b,l,h,f,w,x=n.props||Be,C=t.props,g=t.type;if(g=="svg"?r="http://www.w3.org/2000/svg":g=="math"?r="http://www.w3.org/1998/Math/MathML":r||(r="http://www.w3.org/1999/xhtml"),s!=null){for(u=0;u<s.length;u++)if((h=s[u])&&"setAttribute"in h==!!g&&(g?h.localName==g:h.nodeType==3)){e=h,s[u]=null;break}}if(e==null){if(g==null)return document.createTextNode(C);e=document.createElementNS(r,g,C.is&&C),c&&(F.__m&&F.__m(t,s),c=!1),s=null}if(g==null)x===C||c&&e.data==C||(e.data=C);else{if(s=g=="textarea"&&C.defaultValue!=null?null:s&&He.call(e.childNodes),!c&&s!=null)for(x={},u=0;u<e.attributes.length;u++)x[(h=e.attributes[u]).name]=h.value;for(u in x)h=x[u],u=="dangerouslySetInnerHTML"?b=h:u=="children"||u in C||u=="value"&&"defaultValue"in C||u=="checked"&&"defaultChecked"in C||Ae(e,u,null,h,r);for(u in C)h=C[u],u=="children"?l=h:u=="dangerouslySetInnerHTML"?p=h:u=="value"?f=h:u=="checked"?w=h:c&&typeof h!="function"||x[u]===h||Ae(e,u,h,x[u],r);if(p)c||b&&(p.__html==b.__html||p.__html==e.innerHTML)||(e.innerHTML=p.__html),t.__k=[];else if(b&&(e.innerHTML=""),Qt(t.type=="template"?e.content:e,qe(l)?l:[l],t,n,a,g=="foreignObject"?"http://www.w3.org/1999/xhtml":r,s,i,s?s[0]:n.__k&&Se(n,0),c,d),s!=null)for(u=s.length;u--;)_t(s[u]);c&&g!="textarea"||(u="value",g=="progress"&&f==null?e.removeAttribute("value"):f!=null&&(f!==e[u]||g=="progress"&&!f||g=="option"&&f!=x[u])&&Ae(e,u,f,x[u],r),u="checked",w!=null&&w!=e[u]&&Ae(e,u,w,x[u],r))}return e}function $t(e,t,n){try{if(typeof e=="function"){var a=typeof e.__u=="function";a&&e.__u(),a&&t==null||(e.__u=e(t))}else e.current=t}catch(r){F.__e(r,n)}}function sn(e,t,n){var a,r;if(F.unmount&&F.unmount(e),(a=e.ref)&&(a.current&&a.current!=e.__e||$t(a,null,t)),(a=e.__c)!=null){if(a.componentWillUnmount)try{a.componentWillUnmount()}catch(s){F.__e(s,t)}a.base=a.__P=a.__n=null}if(a=e.__k)for(r=0;r<a.length;r++)a[r]&&sn(a[r],t,n||typeof e.type!="function");n||_t(e.__e),e.__c=e.__=e.__e=void 0}function Fa(e,t,n){return this.constructor(e,n)}function rn(e,t,n){var a,r,s,i;t==document&&(t=document.documentElement),F.__&&F.__(e,t),r=(a=typeof n=="function")?null:n&&n.__k||t.__k,s=[],i=[],vt(t,e=(!a&&n||t).__k=bt(Ge,null,[e]),r||Be,Be,t.namespaceURI,!a&&n?[n]:r?null:t.firstChild?He.call(t.childNodes):null,s,!a&&n?n:r?r.__e:t.firstChild,a,i),nn(s,e,i),e.props.children=null}He=Ve.slice,F={__e:function(e,t,n,a){for(var r,s,i;t=t.__;)if((r=t.__c)&&!r.__)try{if((s=r.constructor)&&s.getDerivedStateFromError!=null&&(r.setState(s.getDerivedStateFromError(e)),i=r.__d),r.componentDidCatch!=null&&(r.componentDidCatch(e,a||{}),i=r.__d),i)return r.__E=r}catch(c){e=c}throw e}},jt=0,Ra=function(e){return e!=null&&e.constructor===void 0},ze.prototype.setState=function(e,t){var n;n=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=ce({},this.state),typeof e=="function"&&(e=e(ce({},n),this.props)),e&&ce(n,e),e!=null&&this.__v&&(t&&this._sb.push(t),Gt(this))},ze.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),Gt(this))},ze.prototype.render=Ge,fe=[],Zt=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Jt=function(e,t){return e.__v.__b-t.__v.__b},Oe.__r=0,pt=Math.random().toString(8),Ne="__d"+pt,Pe="__a"+pt,Yt=/(PointerCapture)$|Capture$/i,ht=0,mt=Wt(!1),ft=Wt(!0),Ua=0;var Ee,B,gt,on,Ke=0,_n=[],O=F,ln=O.__b,cn=O.__r,un=O.diffed,dn=O.__c,pn=O.unmount,mn=O.__;function kt(e,t){O.__h&&O.__h(B,e,Ke||t),Ke=0;var n=B.__H||(B.__H={__:[],__h:[]});return e>=n.__.length&&n.__.push({}),n.__[e]}function _(e){return Ke=1,za($n,e)}function za(e,t,n){var a=kt(Ee++,2);if(a.t=e,!a.__c&&(a.__=[n?n(t):$n(void 0,t),function(c){var d=a.__N?a.__N[0]:a.__[0],u=a.t(d,c);d!==u&&(a.__N=[u,a.__[1]],a.__c.setState({}))}],a.__c=B,!B.__f)){var r=function(c,d,u){if(!a.__c.__H)return!0;var p=!1,b=a.__c.props!==c;if(a.__c.__H.__.some(function(h){if(h.__N){p=!0;var f=h.__[0];h.__=h.__N,h.__N=void 0,f!==h.__[0]&&(b=!0)}}),s){var l=s.call(this,c,d,u);return p?l||b:l}return!p||b};B.__f=!0;var s=B.shouldComponentUpdate,i=B.componentWillUpdate;B.componentWillUpdate=function(c,d,u){if(this.__e){var p=s;s=void 0,r(c,d,u),s=p}i&&i.call(this,c,d,u)},B.shouldComponentUpdate=r}return a.__N||a.__}function S(e,t){var n=kt(Ee++,3);!O.__s&&vn(n.__H,t)&&(n.__=e,n.u=t,B.__H.__h.push(n))}function z(e){return Ke=5,Ba(function(){return{current:e}},[])}function Ba(e,t){var n=kt(Ee++,7);return vn(n.__H,t)&&(n.__=e(),n.__H=t,n.__h=e),n.__}function fn(){for(var e;e=_n.shift();){var t=e.__H;if(e.__P&&t)try{t.__h.some(yt),t.__h.some(bn),t.__h=[]}catch(n){t.__h=[],O.__e(n,e.__v)}}}O.__b=function(e){B=null,ln&&ln(e)},O.__=function(e,t){e&&t.__k&&t.__k.__m&&(e.__m=t.__k.__m),mn&&mn(e,t)},O.__r=function(e){cn&&cn(e),Ee=0;var t=(B=e.__c).__H;t&&(gt===B?(t.__h=[],B.__h=[],t.__.some(function(n){n.__N&&(n.__=n.__N),n.u=n.__N=void 0})):(t.__h.length&&fn(),Ee=0)),gt=B},O.diffed=function(e){un&&un(e);var t=e.__c;t&&t.__H&&(t.__H.__h.length&&(_n.push(t)!==1&&on===O.requestAnimationFrame||((on=O.requestAnimationFrame)||Va)(fn)),t.__H.__.some(function(n){n.u&&(n.__H=n.u,n.u=void 0)})),gt=B=null},O.__c=function(e,t){t.some(function(n){try{n.__h.some(yt),n.__h=n.__h.filter(function(a){return!a.__||bn(a)})}catch(a){t.some(function(r){r.__h&&(r.__h=[])}),t=[],O.__e(a,n.__v)}}),dn&&dn(e,t)},O.unmount=function(e){pn&&pn(e);var t,n=e.__c;n&&n.__H&&(n.__H.__.some(function(a){try{yt(a)}catch(r){t=r}}),n.__H=void 0,t&&O.__e(t,n.__v))};var hn=typeof requestAnimationFrame=="function";function Va(e){var t,n=function(){clearTimeout(a),hn&&cancelAnimationFrame(t),setTimeout(e)},a=setTimeout(n,35);hn&&(t=requestAnimationFrame(n))}function yt(e){var t=B,n=e.__c;typeof n=="function"&&(e.__c=void 0,n()),B=t}function bn(e){var t=B;e.__c=e.__(),B=t}function vn(e,t){return!e||e.length!==t.length||t.some(function(n,a){return n!==e[a]})}function $n(e,t){return typeof t=="function"?t(e):t}var yn=function(e,t,n,a){var r;t[0]=0;for(var s=1;s<t.length;s++){var i=t[s++],c=t[s]?(t[0]|=i?1:2,n[t[s++]]):t[++s];i===3?a[0]=c:i===4?a[1]=Object.assign(a[1]||{},c):i===5?(a[1]=a[1]||{})[t[++s]]=c:i===6?a[1][t[++s]]+=c+"":i?(r=e.apply(c,yn(e,c,n,["",null])),a.push(r),c[0]?t[0]|=2:(t[s-2]=0,t[s]=r)):a.push(c)}return a},gn=new Map;function kn(e){var t=gn.get(this);return t||(t=new Map,gn.set(this,t)),(t=yn(this,t.get(e)||(t.set(e,t=(function(n){for(var a,r,s=1,i="",c="",d=[0],u=function(l){s===1&&(l||(i=i.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?d.push(0,l,i):s===3&&(l||i)?(d.push(3,l,i),s=2):s===2&&i==="..."&&l?d.push(4,l,0):s===2&&i&&!l?d.push(5,0,!0,i):s>=5&&((i||!l&&s===5)&&(d.push(s,0,i,r),s=6),l&&(d.push(s,l,0,r),s=6)),i=""},p=0;p<n.length;p++){p&&(s===1&&u(),u(p));for(var b=0;b<n[p].length;b++)a=n[p][b],s===1?a==="<"?(u(),d=[d],s=3):i+=a:s===4?i==="--"&&a===">"?(s=1,i=""):i=a+i[0]:c?a===c?c="":i+=a:a==='"'||a==="'"?c=a:a===">"?(u(),s=1):s&&(a==="="?(s=5,r=i,i=""):a==="/"&&(s<5||n[p][b+1]===">")?(u(),s===3&&(d=d[0]),s=d,(d=d[0]).push(2,0,s),s=0):a===" "||a==="	"||a===`
`||a==="\r"?(u(),s=2):i+=a),s===3&&i==="!--"&&(s=4,d=d[0])}return u(),d})(e)),t),arguments,[])).length>1?t:t[0]}var o=kn.bind(bt);Q();function Sn(e){let t=e,n=new Set;return{get:()=>t,set(a){t=a,n.forEach(r=>r(t))},update(a){this.set(a(t))},subscribe(a){return n.add(a),()=>n.delete(a)}}}function H(e){let[t,n]=_(e.get());return S(()=>e.subscribe(n),[e]),t}var N=Sn({user:null,csrfToken:null,ready:!1}),je=Sn([]),Oa=0;function k(e,{actionLabel:t,onAction:n,timeoutMs:a=5e3}={}){let r=++Oa;return je.update(s=>[...s,{id:r,message:e,actionLabel:t,onAction:n}]),a&&setTimeout(()=>Ze(r),a),r}function Ze(e){je.update(t=>t.filter(n=>n.id!==e))}function Je(e){try{return decodeURIComponent(e)}catch{return e}}function xn(e){let t=Number(e.get("page")||1);return{sort:e.get("sort")||"uploaded_at_desc",game:e.get("game")||"",q:e.get("q")||"",page:Number.isFinite(t)?Math.max(1,t):1}}var Ha=["login","resetPassword","public","publicLibrary","publicGame","publicUser","about","games"];function St(e){return Ha.includes(e)}function Cn(e,t){return!t&&!St(e)}var qa={publicLibrary:"feed",publicGame:"feed",games:"games",library:"library",clip:"library",admin:"admin",profile:"profile"};function xt(e){return qa[e?.name]||""}function Tn(e){return e?.name==="publicLibrary"&&e.surface==="search"?"search":xt(e)}function Ye(e,t){let n=new URLSearchParams(t||""),a=e;return a.startsWith("/c/")?{name:"public",shareId:Je(a.slice(3))}:a==="/"||a==="/public"||a==="/search"?{name:"publicLibrary",query:xn(n),surface:a==="/search"?"search":"feed"}:a.startsWith("/game/")?{name:"publicGame",game:Je(a.slice(6)),query:xn(n)}:a==="/about"?{name:"about"}:a==="/games"?{name:"games"}:a.startsWith("/u/")?{name:"publicUser",username:Je(a.slice(3))}:a==="/library"?{name:"library"}:a.startsWith("/clip/")?{name:"clip",clipId:Je(a.slice(6))}:a==="/admin"?{name:"admin",tab:n.get("tab")||"overview"}:a==="/account"?{name:"account"}:a==="/profile"?{name:"profile"}:a==="/login"?{name:"login"}:a==="/reset-password"?{name:"resetPassword",token:n.get("token")||"",invite:n.get("invite")==="1"}:{name:"publicLibrary"}}function Mn(e){return Ye(e.pathname,e.search).name}var Ct=new Set;function G(e){window.history.pushState({},"",e),Pn()}function Pn(){let{pathname:e,search:t}=window.location,n=Ye(e,t);Ct.forEach(a=>a(n))}window.addEventListener("popstate",Pn);function En(){let[e,t]=_(()=>Ye(window.location.pathname,window.location.search));return S(()=>(Ct.add(t),()=>Ct.delete(t)),[]),e}function Rn(e){let t=e.target.closest("a[href^='/']");!t||t.target||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||(e.preventDefault(),G(t.getAttribute("href")))}var Un={alert:'<path d="M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0Z"/><path d="M12 9v4"/><path d="M12 17h.01"/>',clipboard:'<rect width="8" height="4" x="8" y="2" rx="1"/><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/>',copy:'<rect width="14" height="14" x="8" y="8" rx="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/>',external:'<path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>',edit:'<path d="M12 20h9"/><path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z"/>',fastForward:'<path d="m13 19 9-7-9-7v14Z"/><path d="m2 19 9-7-9-7v14Z"/>',film:'<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M7 3v18"/><path d="M17 3v18"/><path d="M3 8h4"/><path d="M3 16h4"/><path d="M17 8h4"/><path d="M17 16h4"/>',fullscreen:'<path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/>',globe:'<circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 0 20"/><path d="M12 2a15.3 15.3 0 0 0 0 20"/>',home:'<path d="m3 10 9-7 9 7"/><path d="M5 8.5V20a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8.5"/><path d="M9 22V12h6v10"/>',info:'<circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><path d="M12 8h.01"/>',library:'<path d="m16 6 4 14"/><path d="M12 6v14"/><path d="M8 8v12"/><path d="M4 4v16"/>',lock:'<rect width="18" height="11" x="3" y="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>',logOut:'<path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/>',menu:'<path d="M4 6h16"/><path d="M4 12h16"/><path d="M4 18h16"/>',message:'<path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4Z"/>',notepad:'<path d="M8 2v4"/><path d="M16 2v4"/><path d="M3 10h18"/><path d="M6 4h12a3 3 0 0 1 3 3v12a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Z"/><path d="M8 14h8"/><path d="M8 18h5"/>',pause:'<path d="M8 5v14"/><path d="M16 5v14"/>',play:'<path d="m8 5 11 7-11 7V5Z"/>',plus:'<path d="M5 12h14"/><path d="M12 5v14"/>',check:'<path d="M20 6 9 17l-5-5"/>',refresh:'<path d="M21 12a9 9 0 0 1-15.5 6.3L3 16"/><path d="M3 21v-5h5"/><path d="M3 12A9 9 0 0 1 18.5 5.7L21 8"/><path d="M21 3v5h-5"/>',rewind:'<path d="m11 19-9-7 9-7v14Z"/><path d="m22 19-9-7 9-7v14Z"/>',save:'<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2Z"/><path d="M17 21v-8H7v8"/><path d="M7 3v5h8"/>',search:'<circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/>',server:'<rect width="20" height="8" x="2" y="2" rx="2"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 6h.01"/><path d="M6 18h.01"/>',skipBack:'<path d="M19 20 9 12l10-8v16Z"/><path d="M5 19V5"/>',skipForward:'<path d="m5 4 10 8-10 8V4Z"/><path d="M19 5v14"/>',shield:'<path d="M20 13c0 5-3.5 7.5-7.7 8.8a1 1 0 0 1-.6 0C7.5 20.5 4 18 4 13V5l8-3 8 3v8Z"/>',sliders:'<path d="M4 21v-7"/><path d="M4 10V3"/><path d="M12 21v-9"/><path d="M12 8V3"/><path d="M20 21v-5"/><path d="M20 12V3"/><path d="M2 14h4"/><path d="M10 8h4"/><path d="M18 16h4"/>',theater:'<rect width="20" height="14" x="2" y="5" rx="2"/><path d="M6 9h12"/><path d="M6 15h12"/>',trash:'<path d="M3 6h18"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="m19 6-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6"/><path d="M14 11v6"/>',upload:'<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m17 8-5-5-5 5"/><path d="M12 3v12"/>',user:'<path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/>',users:'<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.9"/><path d="M16 3.1a4 4 0 0 1 0 7.8"/>',volume2:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7"/><path d="M19 5a9 9 0 0 1 0 14"/>',volumeX:'<path d="M11 5 6 9H2v6h4l5 4V5Z"/><path d="m22 9-6 6"/><path d="m16 9 6 6"/>',x:'<path d="M18 6 6 18"/><path d="m6 6 12 12"/>'};function M(e,{size:t=18}={}){return o`<svg viewBox="0 0 24 24" width=${t} height=${t} fill="none"
    stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"
    aria-hidden="true" dangerouslySetInnerHTML=${{__html:Un[e]||""}} />`}function Tt(e){if(!e||typeof e!="string")return"";if(e.startsWith("/"))return e;try{let t=new URL(e,window.location.origin);if(t.origin===window.location.origin)return`${t.pathname}${t.search}`}catch{return""}return""}function Ga(e){let t=Tt(e?.avatar_url);if(!t)return"";let n=e.updated_at||"";if(!n)return t;let a=t.includes("?")?"&":"?";return`${t}${a}v=${encodeURIComponent(n)}`}function Ka(e){return(e||"C").trim().slice(0,1).toUpperCase()||"C"}function xe({user:e,size:t=40,className:n=""}){let a=Ga(e),r=`width:${t}px;height:${t}px;font-size:${Math.round(t*.4)}px`;if(a)return o`<img class=${`user-avatar ${n}`} style=${r} src=${a} alt="" />`;let s=e?.display_name||e?.username;return o`<div class=${`user-avatar user-avatar-fallback ${n}`} style=${r} aria-hidden="true">
    ${Ka(s)}
  </div>`}function Wa(e){return e?.query?.q||""}function ja(e,t){let n=new URLSearchParams,a=String(t||"").trim(),r=e?.name==="publicGame"?e.game:e?.query?.game||"";a&&n.set("q",a),r&&n.set("game",r);let s=n.toString();return s?`/search?${s}`:"/search"}function Dn({active:e,route:t}){let{user:n}=H(N),[a,r]=_(!1),s=z(null),i=Wa(t),[c,d]=_(i);S(()=>{d(i)},[i]);let u=n?.role==="admin"||n?.role==="owner";S(()=>{if(!a)return;let l=f=>{s.current?.contains(f.target)||r(!1)},h=f=>{f.key==="Escape"&&r(!1)};return document.addEventListener("pointerdown",l),document.addEventListener("keydown",h),()=>{document.removeEventListener("pointerdown",l),document.removeEventListener("keydown",h)}},[a]);let p=[["feed","/","Feed"],["library","/library","Library",!!n],["games","/games","Games"],["admin","/admin","Admin",u]].filter(([,,,l])=>l!==!1),b=l=>{l.preventDefault();let h=new FormData(l.target).get("q")?.toString()||"";G(ja(t,h))};return o`<header class="topbar">
    ...
    <nav class="topnav" aria-label="Primary">
      ${p.map(([l,h,f])=>o`
        <a class=${l===e?"topnav-on":""} href=${h}>${f}</a>`)}
    </nav>
  ...
  </header>`}async function Za(){let{api:e,setCsrfToken:t}=await Promise.resolve().then(()=>(Q(),wn));try{await e("/api/v1/auth/logout",{method:"POST"})}catch{}t(null),N.set({user:null,csrfToken:null,ready:!0}),G("/login")}var Ja=[["feed","/","home","Feed",!0],["games","/games","globe","Games",!0],["library","/library","library","Library","auth"],["search","/search","search","Search",!0],["profile","/profile","user","Profile","auth"]];function Ya(e){return Ja.filter(([,,,,t])=>t!=="auth"||!!e)}function Ln({active:e}){let{user:t}=H(N),n=Ya(t);return o`<nav class="tabbar" aria-label="Primary">
    ${n.map(([a,r,s,i])=>o`
      <a class=${a===e?"tab-on":""} href=${r}>${M(s)}<span>${i}</span></a>`)}
  </nav>`}function In(){let e=H(je);return o`<div class="toasts" role="status" aria-live="polite">
    ...
    ${u==null?o`<${rs} />`:u.length===0?o`<${W} name="film"
        ...
        <div class="feed-toolbar">
          ...
          <select class="input" value=${t.sort} onChange=${f=>d({sort:f.target.value})}>
            ${Qa.map(([f,w])=>o`<option value=${f}>${w}</option>`)}
          </select>
          <div class="chips">
            <button class=${`chip ${t.game?"":"chip-on"}`} onClick=${()=>d({game:""})}>All</button>
            ${l.map(f=>o`<button
              class=${`chip ${t.game===f.game?"chip-on":""}`}
              onClick=${()=>d({game:f.game})}>${f.game}</button>`)}
            ${h>0&&o`<a class="chip" href="/games">+${h}</a>`}
          </div>
        </div>
        <div class="card-grid">
          ${(b?u.slice(4):u).map(f=>o`<${Te} clip=${{...f,thumbnail_url:de(f),media_url:Ce(f)}}
              href=${Et(f)} showAuthor />`)}
        </div>
        ${is(n,t,d)}
      `}
    ...
    <section class="hero">
      ...
      <div class="hero-side">
        ${a.map(r=>o`<a class="hero-row" href=${Et(r)}>
            ...
            <span><b>${r.title}</b>
              <small>${Pt(r)} · ${Bn(r)} · ${ye(r.view_count)}</small></span>
          </a>`)}
      </div>
  ...
  </nav>`}Q();function Vn(){let[e,t]=_(null),[n,a]=_(null);return S(()=>{let r=!0;return y("/api/v1/public/games").then(s=>r&&t(s.games||[])).catch(s=>r&&a(s)),()=>{r=!1}},[]),n?o`<main class="page">
  ...
  </main>`}Q();function On({trigger:e,content:t,onClose:n,label:a,panelClass:r=""}){let[s,i]=_(!1),c=z(null),d=z(null),u=z(null),p=()=>{i(!1),n?.()},b=()=>{if(s){p();return}u.current=document.activeElement,i(!0)};return S(()=>{if(!s)return;let l=w=>{c.current?.contains(w.target)||p()},h=w=>{w.key==="Escape"&&p()};return document.addEventListener("pointerdown",l),document.addEventListener("keydown",h),d.current?.querySelector("input, select, textarea, button, a[href], [tabindex]")?.focus(),()=>{document.removeEventListener("pointerdown",l),document.removeEventListener("keydown",h),u.current?.focus?.()}},[s]),o`<div class="popover-wrap" ref=${c}>
    ${e({open:s,toggle:b})}
  ...
  </dialog>`}var Kn="clipline.libraryView",ls=[["uploaded_at_desc","Uploaded newest"],["uploaded_at_asc","Uploaded oldest"],["recorded_at_desc","Recorded newest"],["recorded_at_asc","Recorded oldest"],["updated_at_desc","Updated newest"],["updated_at_asc","Updated oldest"],["created_at_desc","Created newest"],["created_at_asc","Created oldest"],["duration_desc","Duration longest"],["duration_asc","Duration shortest"],["size_desc","Size largest"],["size_asc","Size smallest"],["title_asc","Title A-Z"],["title_desc","Title Z-A"]],at={title:["title_asc","title_desc"],size:["size_asc","size_desc"],duration:["duration_asc","duration_desc"],uploaded:["uploaded_at_asc","uploaded_at_desc"]},cs=["visibility","status","source_type","from","to","min_duration_seconds","max_duration_seconds","min_size_mib","max_size_mib"],ot={sort:"uploaded_at_desc",game:"",source_type:"",visibility:"",status:"",q:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""};function st(e){if(e===""||e==null)return null;let t=Number(e);return Number.isFinite(t)?t:null}function us(e){let t=new URLSearchParams;t.set("sort",e.sort||ot.sort),t.set("page_size","100");for(let i of["game","source_type","visibility","status","q"])e[i]&&t.set(i,e[i]);e.from&&t.set("from",`${e.from}T00:00:00Z`),e.to&&t.set("to",`${e.to}T23:59:59Z`);let n=st(e.min_duration_seconds);n!=null&&t.set("min_duration_ms",String(Math.round(n*1e3)));let a=st(e.max_duration_seconds);a!=null&&t.set("max_duration_ms",String(Math.round(a*1e3)));let r=st(e.min_size_mib);r!=null&&t.set("min_size_bytes",String(Math.round(r*1024*1024)));let s=st(e.max_size_mib);return s!=null&&t.set("max_size_bytes",String(Math.round(s*1024*1024))),t}function ds(e){return cs.reduce((t,n)=>t+(e[n]?1:0),0)}function ps(e,t=6){let n=new Map;for(let a of e){let r=a.game_name;r&&n.set(r,(n.get(r)||0)+1)}return Array.from(n,([a,r])=>({game:a,count:r})).sort((a,r)=>r.count-a.count||a.game.localeCompare(r.game)).slice(0,t)}function qn(e,t,{verb:n,allFailedMessage:a}){let r=e.filter(i=>!t.some(c=>c.id===i));if(!t.length)return{succeeded:r,message:null};let s=t.length===e.length?t[0]?.message||a:`Couldn't ${n} ${t.length} of ${e.length} clips.`;return{succeeded:r,message:s}}function ms(e,t){return(e||[]).map(n=>Re(n.public_url,t,n.public_share_id)).filter(Boolean)}async function Gn(e,t,n){let a=0;async function r(){let s=a++;if(!(s>=e.length))return await n(e[s]),r()}await Promise.all(Array.from({length:Math.min(t,e.length)},r))}function fs(){try{return localStorage.getItem(Kn)==="rows"?"rows":"grid"}catch{return"grid"}}function Wn(){let[e,t]=_(fs),[n,a]=_(ot),[r,s]=_(ot.q),[i,c]=_(null),[d,u]=_(null),[p,b]=_(new Set),[l,h]=_(!1),[f,w]=_(!1),[x,C]=_(0),g=z(!1),R=z(null);S(()=>()=>clearTimeout(R.current),[]),S(()=>{let $=!0;return c(null),u(null),y(`/api/v1/clips?${us(n)}`).then(T=>{$&&(c(T),b(new Set))}).catch(T=>$&&u(T)),()=>{$=!1}},[JSON.stringify(n),x]);let j=$=>{t($);try{localStorage.setItem(Kn,$)}catch{}},Z=()=>C($=>$+1),J=$=>{g.current=$,h($)},se=$=>{let T=$.target.value;s(T),clearTimeout(R.current),R.current=setTimeout(()=>{a(v=>({...v,q:T}))},300)},V=$=>T=>{let v=T.target.value;a(E=>({...E,[$]:v}))},te=()=>{a($=>({...$,visibility:"",status:"",source_type:"",from:"",to:"",min_duration_seconds:"",max_duration_seconds:"",min_size_mib:"",max_size_mib:""}))},I=$=>a(T=>({...T,game:T.game===$?"":$})),Y=$=>a(T=>({...T,sort:$})),ke=$=>{b(T=>{let v=new Set(T);return v.has($)?v.delete($):v.add($),v})};function ne($,T){c(v=>v&&{...v,clips:v.clips.map(E=>E.id===$?{...E,...T}:E)})}function be($,T){let v=new Set($);c(E=>E&&{...E,clips:E.clips.map(A=>v.has(A.id)?{...A,...T}:A)})}async function ve($){if(g.current)return;let T=Array.from(p);if(!T.length)return;let v=i?.clips||[],E=new Map(T.map(D=>[D,v.find(ae=>ae.id===D)]));J(!0),be(T,{visibility:$});let A=[],U=new Map;try{await Gn(T,4,async m=>{try{let P=await y(`/api/v1/clips/${encodeURIComponent(m)}/visibility`,{method:"POST",body:{visibility:$}}),L={visibility:P.visibility,public_url:P.public_url,public_share_id:P.public_share_id};ne(m,L),U.set(m,L)}catch(P){A.push({id:m,message:P.message})}});let{succeeded:D,message:ae}=qn(T,A,{verb:"update",allFailedMessage:"Couldn't update visibility."});if(ae){for(let{id:m}of A){let P=E.get(m);P&&ne(m,{visibility:P.visibility,public_url:P.public_url,public_share_id:P.public_share_id})}k(ae)}D.length&&(b(new Set),k(`Made ${D.length} clip${D.length===1?"":"s"} ${$}`,{actionLabel:"Undo",onAction:()=>pe(D,E,U)}))}finally{J(!1)}}async function pe($,T,v){if(g.current){k("Wait for visibility changes to finish.");return}J(!0);try{for(let U of $){let D=T.get(U);D&&ne(U,{visibility:D.visibility,public_url:D.public_url,public_share_id:D.public_share_id})}let E=[];await Gn($,4,async U=>{let D=T.get(U);if(D)try{let ae=await y(`/api/v1/clips/${encodeURIComponent(U)}/visibility`,{method:"POST",body:{visibility:D.visibility}});ne(U,{visibility:ae.visibility,public_url:ae.public_url,public_share_id:ae.public_share_id})}catch(ae){E.push({id:U,message:ae.message})}});let{message:A}=qn($,E,{verb:"undo",allFailedMessage:"Couldn't undo visibility change."});if(A){for(let{id:U}of E){let D=v.get(U);D&&ne(U,D)}k(A)}}finally{J(!1)}}async function re(){if(g.current){k("Wait for visibility changes to finish.");return}let $=Array.from(p),T=i?.clips||[],v=$.map(U=>T.find(D=>D.id===U)).filter(Boolean),E=ms(v,window.location.origin),A=v.length-E.length;if(!E.length){k("No links to copy \u2014 selected clips are private.");return}try{await navigator.clipboard.writeText(E.join(`
`)),k(`Copied ${E.length} link${E.length===1?"":"s"}`+(A?` (${A} skipped, private)`:""))}catch{k("Couldn't copy links to clipboard.")}}async function me(){let $=Array.from(p);w(!1);try{let T=await y("/api/v1/clips/bulk-delete",{method:"POST",body:{ids:$}});b(new Set),Z(),k(`Deleted ${T.affected} clip${T.affected===1?"":"s"}.`)}catch(T){k(T.message)}}if(d)return o`<main class="page">
      <${W} name="alert" title="Couldn't load your library" body=${d.message} />
    </main>`;let X=i?.clips,oe=ds(n),ie=!!(n.q||n.game)||oe>0,$e=ps(X||[]),ge=(X||[]).reduce(($,T)=>$+(T.file_size_bytes||0),0),we=o`<div class="popover-fields">
    ...
    ${X==null?o`<${_s} />`:X.length===0?ie?o`<${W} name="film" title="No clips match this view"
          ...
          ${X.map($=>o`<${Te} key=${$.id}
            clip=${{...$,thumbnail_url:Mt($),media_url:Qe($)}}
    ...
    <${le} open=${f}
      ...
      onConfirm=${me}
      onCancel=${()=>w(!1)} />
  </main>`}function rt(e,[t,n]){let a=e.sort===t?"ascending":e.sort===n?"descending":"none",r=e.sort===n?t:n;return{ariaSort:a,next:r}}function hs({clips:e,query:t,onSort:n,selected:a,onToggleSelect:r}){let s=rt(t,at.title),i=rt(t,at.size),c=rt(t,at.duration),d=rt(t,at.uploaded);return o`<table class="lib-table">
    <thead>
      <tr>
    ...
    <tbody>
      ${e.map(u=>o`<tr key=${u.id} class=${a?.has(u.id)?"is-selected":""}>
        ...
        <td><img class="row-thumb" src=${Mt(u)} alt="" width="64" height="36" loading="lazy" /></td>
  ...
  </div>`}Q();var bs={ChampionKill:"kill",FirstBlood:"kill",Multikill:"spree",Ace:"spree",DragonKill:"objective",HeraldKill:"objective",BaronKill:"objective",TurretKilled:"structure",InhibKilled:"structure",FirstBrick:"structure"};function Zn(e){let t=Number(e);return Number.isFinite(t)&&t>0?t/1e3:0}function Jn(e,t){let n=Number.isFinite(e)?e:0,a=t>0?t:Number.MAX_SAFE_INTEGER;return Math.max(0,Math.min(a,n))}function it(e,t){return t>0?Math.max(0,Math.min(100,e/t*100)):0}function Rt(e){if(!Number.isFinite(e))return"0:00";let t=Math.max(0,Math.round(e)),n=Math.floor(t/60),a=t-n*60;return`${n}:${String(a).padStart(2,"0")}`}function jn(e){if(!Number.isFinite(e))return"0:00.0";let t=Math.max(0,Math.round(e*10)),n=Math.floor(t/600),a=t-n*600,r=Math.floor(a/10);return`${n}:${String(r).padStart(2,"0")}.${a%10}`}function Yn(e,t){return`${jn(e)} / ${t>0?jn(t):"0:00.0"}`}function vs(e){return bs[e]||"info"}function Xn(e,t){return(e||[]).map((n,a)=>{let r=Number(n.timestamp_ms);if(!Number.isFinite(r))return null;let s=r/1e3;return s<0||t>0&&s>t?null:{index:a,time:s,kind:String(n.kind||"Marker"),label:String(n.label||n.kind||"Marker"),category:vs(n.kind)}}).filter(Boolean).sort((n,a)=>n.time-a.time)}function Qn(e,t){if(!e.length)return null;for(let n of e)if(n.time>t+.05)return n;return e[0]}function ea(e,t){if(!e.length)return null;for(let n=e.length-1;n>=0;n-=1)if(e[n].time<t-.05)return e[n];return e[e.length-1]}function ta(e,t){switch(e){case"Space":case"KeyK":return{kind:"toggle-play"};case"ArrowLeft":return{kind:"seek-by",seconds:t?-1:-5};case"ArrowRight":return{kind:"seek-by",seconds:t?1:5};case"KeyJ":return{kind:"seek-by",seconds:-10};case"KeyL":return{kind:"seek-by",seconds:10};case"Comma":return{kind:"seek-by",seconds:-.1};case"Period":return{kind:"seek-by",seconds:.1};case"KeyM":return{kind:t?"previous-marker":"next-marker"};case"Home":return{kind:"seek-to",seconds:0};case"End":return{kind:"seek-to-end"};case"KeyF":return{kind:"fullscreen"};case"KeyT":return{kind:"theater"};default:return null}}var aa="clipline.playerVolume",sa="clipline.clipTheaterMode",$s=2e3,gs=[.25,.5,.75,1,1.25,1.5,2];function ys(e,t){switch(e){case"KeyM":return{kind:"toggle-mute"};case"KeyF":return{kind:"theater"};case"Escape":return{kind:"exit-theater"};default:return ta(e,t)}}function ks(e){return e instanceof Element?!!e.closest("input, textarea, select, button, a, [contenteditable='true'], [contenteditable='']"):!1}function ws(){try{let e=window.localStorage.getItem(aa);if(e==null)return 1;let t=Number(e);return Number.isFinite(t)?Math.max(0,Math.min(1,t)):1}catch{return 1}}function na(e){try{window.localStorage.setItem(aa,String(Math.max(0,Math.min(1,e))))}catch{}}function Ss(){try{return window.localStorage.getItem(sa)==="true"}catch{return!1}}function xs(e){try{window.localStorage.setItem(sa,String(e))}catch{}}function ra({src:e,poster:t,durationMs:n,markers:a}){let r=z(null),s=z(null),i=z(null),c=z(!1),d=z(!1),u=Zn(n),[p,b]=_(!1),[l,h]=_(0),[f,w]=_(u),[x,C]=_(0),[g,R]=_(ws),[j,Z]=_(!1),[J,se]=_(1),[V,te]=_(!1),[I,Y]=_(Ss),[ke,ne]=_(!0),[be,ve]=_(null),[pe,re]=_(""),me=Xn(a,f);function X(){ne(!0),window.clearTimeout(i.current),i.current=window.setTimeout(()=>{let m=r.current;m&&!m.paused&&!m.ended&&ne(!1)},$s)}S(()=>{p||(window.clearTimeout(i.current),ne(!0))},[p]),S(()=>{let m=r.current;if(!m)return;let P=()=>Number.isFinite(m.duration)&&m.duration>0?m.duration:u,L=()=>w(P()),De=()=>w(P()),It=()=>{c.current||h(m.currentTime||0)},At=()=>{let Ot=P();if(!(Ot>0)||!m.buffered?.length){C(0);return}let Ht=m.currentTime||0,Le=0;for(let Ie=0;Ie<m.buffered.length;Ie+=1){let Ta=m.buffered.start(Ie),dt=m.buffered.end(Ie);if(Ht>=Ta&&Ht<=dt){Le=dt;break}Le=Math.max(Le,dt)}C(it(Le,Ot))},Nt=()=>{b(!0),re(""),X()},Ft=()=>b(!1),zt=()=>b(!1),Bt=()=>{R(m.volume),Z(m.muted||m.volume===0)},Vt=()=>re("Playback unavailable");return m.addEventListener("loadedmetadata",L),m.addEventListener("durationchange",De),m.addEventListener("timeupdate",It),m.addEventListener("progress",At),m.addEventListener("play",Nt),m.addEventListener("pause",Ft),m.addEventListener("ended",zt),m.addEventListener("volumechange",Bt),m.addEventListener("error",Vt),()=>{m.removeEventListener("loadedmetadata",L),m.removeEventListener("durationchange",De),m.removeEventListener("timeupdate",It),m.removeEventListener("progress",At),m.removeEventListener("play",Nt),m.removeEventListener("pause",Ft),m.removeEventListener("ended",zt),m.removeEventListener("volumechange",Bt),m.removeEventListener("error",Vt)}},[e,u]),S(()=>{r.current&&(r.current.volume=g)},[g]),S(()=>{r.current&&(r.current.muted=j)},[j]),S(()=>{r.current&&(r.current.playbackRate=J)},[J]),S(()=>{let m=r.current;if(!m)return;let P=!1;async function L(){if(!P)try{await m.play();return}catch{if(P||!m.paused)return;m.muted=!0,Z(!0);try{await m.play()}catch(De){re(De?.message||"Playback unavailable")}}}return m.readyState>=HTMLMediaElement.HAVE_FUTURE_DATA?L():m.addEventListener("canplay",L,{once:!0}),()=>{P=!0,m.removeEventListener("canplay",L)}},[e]),S(()=>{let m=document.documentElement;return m.classList.toggle("clipline-theater",I),()=>m.classList.remove("clipline-theater")},[I]);function oe(m){Y(m),xs(m)}function ie(m){let P=r.current;if(!P)return;let L=f>0?Jn(m,f):Math.max(0,m);P.currentTime=L,h(L)}function $e(m){ie((r.current?.currentTime||0)+m)}async function ge(){let m=r.current;if(m)if(m.paused||m.ended)try{await m.play()}catch(P){re(P?.message||"Playback failed")}else m.pause()}function we(){let m=r.current;m&&(m.muted||m.volume===0?(m.muted=!1,m.volume===0&&(m.volume=1,R(1),na(1)),Z(!1)):(m.muted=!0,Z(!0)))}function $(m){let P=Number(m.target.value);R(P),Z(P===0),na(P);let L=r.current;L&&(L.volume=P,L.muted=P===0)}async function T(){try{document.fullscreenElement?await document.exitFullscreen():await s.current?.requestFullscreen?.()}catch(m){re(m?.message||"Fullscreen unavailable")}}function v(m){let P=r.current?.currentTime||0,L=m>0?Qn(me,P):ea(me,P);L&&ie(L.time)}function E(){c.current=!0,d.current=p,p&&r.current?.pause()}function A(m){let P=Number(m.target.value);h(P),ie(P)}function U(){c.current&&(c.current=!1,d.current&&(d.current=!1,r.current?.play().catch(()=>{})))}function D(m){let P=m.currentTarget.getBoundingClientRect();if(!(P.width>0))return;let L=Math.max(0,Math.min(1,(m.clientX-P.left)/P.width));ve({pct:L*100,time:L*(f||0)})}function ae(){ve(null)}return S(()=>{function m(P){if(P.defaultPrevented||ks(P.target))return;let L=ys(P.code,P.shiftKey);if(L&&!(L.kind==="exit-theater"&&!I))switch(P.preventDefault(),X(),L.kind){case"toggle-play":ge();break;case"seek-by":$e(L.seconds);break;case"seek-to":ie(L.seconds);break;case"seek-to-end":ie(f);break;case"next-marker":v(1);break;case"previous-marker":v(-1);break;case"toggle-mute":we();break;case"theater":oe(!I);break;case"exit-theater":oe(!1);break;case"fullscreen":T();break;default:break}}return document.addEventListener("keydown",m),()=>document.removeEventListener("keydown",m)},[f,I,p]),o`<div class=${`player ${ke?"":"chrome-hidden"}`} ref=${s}
      onPointerMove=${X} onPointerEnter=${X}
      onPointerLeave=${()=>{let m=r.current;m&&!m.paused&&ne(!1)}}
      onFocusIn=${()=>ne(!0)}>
    ...
    <div class="player-overlay">
      <div class="player-timeline" onPointerMove=${D} onPointerLeave=${ae}>
        <div class="player-buffered" style=${`width:${x}%`}></div>
        <div class="player-progress" style=${`width:${it(l,f)}%`}></div>
        ${me.map(m=>o`<span class="player-marker-tick" key=${m.index}
            style=${`left:${it(m.time,f)}%`} title=${`${m.label} @ ${Rt(m.time)}`}></span>`)}
        <input class="player-scrubber" type="range" min="0" max=${f>0?f:0} step="0.01"
          value=${l} disabled=${!(f>0)} aria-label="Seek"
          onPointerDown=${E} onInput=${A} onChange=${U}
          onPointerUp=${U} onPointerCancel=${U} onLostPointerCapture=${U} />
      ...
      <div class="player-controls">
        ...
        <span class="player-time">${Yn(l,f)}</span>
        <div class="player-spacer"></div>
        <div class="player-speed-wrap">
          <button type="button" class="player-btn player-speed" aria-haspopup="menu" aria-expanded=${V}
            onClick=${()=>te(m=>!m)}>${J}×</button>
          ${V&&o`<div class="player-speed-menu" role="menu">
            ${gs.map(m=>o`<button type="button" role="menuitem" key=${m}
                class=${`player-speed-item ${m===J?"is-active":""}`}
                onClick=${()=>{se(m),te(!1)}}>${m}×</button>`)}
          </div>`}
        </div>
        ...
        <button type="button" class="player-btn" aria-label=${I?"Exit theater mode":"Theater mode"}
          aria-pressed=${I} onClick=${()=>oe(!I)}>${M("theater",{size:14})}</button>
        <button type="button" class="player-btn" aria-label="Fullscreen" onClick=${T}>
          ${M("fullscreen",{size:14})}
        </button>
      </div>
    </div>
  </div>`}Q();function Cs(e){let t=new Map(e.map(s=>[s.id,s])),n=new Map,a=[],r=0;return e.forEach(s=>{let i=s.parent_comment_id||"";i&&t.has(i)?(n.has(i)||n.set(i,[]),n.get(i).push(s),r+=1):i||(a.push(s),r+=1)}),{roots:a,repliesByParent:n,count:r}}async function Ts({apiClient:e=y,shareId:t,body:n,parentCommentId:a,onReload:r=()=>{},onError:s=k}){let i=n.trim();if(!i)return!1;try{return await e(`/api/v1/public/clips/${encodeURIComponent(t)}/comments`,{method:"POST",body:a?{body:i,parent_comment_id:a}:{body:i}}),r(),!0}catch(c){return s(c.message),!1}}function Ms(e){return(e||"?").trim().slice(0,1).toUpperCase()||"?"}function Ps(e){let t=Tt(e.author_avatar_url);return t?o`<img class="comment-avatar" src=${t} alt="" />`:o`<div class="comment-avatar">${Ms(e.author_name)}</div>`}function oa({shareId:e}){let{user:t}=H(N),[n,a]=_(null),[r,s]=_(""),[i,c]=_(null),[d,u]=_(""),[p,b]=_(null);function l(){y(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`).then(g=>a(g.comments||[])).catch(()=>a([]))}S(()=>{let g=!0;return a(null),y(`/api/v1/public/clips/${encodeURIComponent(e)}/comments`).then(R=>g&&a(R.comments||[])).catch(()=>g&&a([])),()=>{g=!1}},[e]);async function h(g,R){return Ts({shareId:e,body:g,parentCommentId:R,onReload:l,onError:k})}async function f(g){g.preventDefault(),await h(r)&&s("")}async function w(g,R){g.preventDefault(),await h(d,R)&&(u(""),c(null))}async function x(){let g=p;b(null);try{await y(`/api/v1/public/clips/${encodeURIComponent(e)}/comments/${encodeURIComponent(g)}`,{method:"DELETE"}),l()}catch(R){k(R.message)}}let C=Cs(n||[]);return o`<section class="comments">
    <div class="comments-header"><h2>Comments</h2><span class="muted">${C.count}</span></div>
    ${t?o`<form class="comment-form" onSubmit=${f}>
    ...
    ${n==null?"":C.count===0?o`<p class="comment-signin">No comments yet.</p>`:o`<div class="comment-list">
          ${C.roots.map(g=>ia(g,{depth:0,repliesByParent:C.repliesByParent,user:t,replyOpenId:i,setReplyOpenId:c,replyDraft:d,setReplyDraft:u,submitReply:w,onDelete:b}))}
        </div>`}
  ...
  </article>`}var Es=["private","public","unlisted"];function Rs(e,t){return e==="clip"?!0:!!t?.viewer_can_edit}function Us(e,t,n){return e==="public"?t.shareId:n?.public_share_id||null}function Ds(e,t,n){return e==="clip"?t.clipId:n?.viewer_clip_id||null}function Ls(e){let t=e?.height!=null?e.height:"",n=Math.round(e?.fps||0)||"";return`${t}p${n}`}function Is(e,t=8){let n=new URLSearchParams;return e&&n.set("share_id",e),n.set("limit",String(t)),`/api/v1/public/recommendations?${n}`}function As(e,t,n=8){return(e||[]).filter(a=>a.share_id!==t).slice(0,n)}function Ut({route:e}){let{user:t}=H(N),[n,a]=_(null),[r,s]=_(null),[i,c]=_([]),[d,u]=_(!1),[p,b]=_(""),[l,h]=_(!1),[f,w]=_(""),[x,C]=_(!1),[g,R]=_(!1),[j,Z]=_(!1),J=e.name==="clip"?`clip:${e.clipId}`:`public:${e.shareId}`,se=Us(e.name,e,n),V=e.name==="public"||!!n;if(S(()=>{let v=!0;a(null),s(null),u(!1),h(!1),Z(!1),C(!1);let E=e.name==="clip"?`/api/v1/clips/${encodeURIComponent(e.clipId)}`:`/api/v1/public/clips/${encodeURIComponent(e.shareId)}`;return y(E).then(A=>{v&&(a(A),e.name==="public"&&y(`/api/v1/public/clips/${encodeURIComponent(e.shareId)}/view`,{method:"POST",body:{}}).then(U=>v&&a(D=>D&&{...D,view_count:U.view_count})).catch(()=>{}))}).catch(A=>v&&s(A)),()=>{v=!1}},[J]),S(()=>{let v=!0;return V?(c([]),y(Is(se,8)).then(E=>v&&c(E.clips||[])).catch(()=>{}),()=>{v=!1}):(c([]),()=>{v=!1})},[J,se,V]),r)return o`<main class="page"><${W} name="alert" title="Couldn't load this clip" body=${r.message} /></main>`;if(!n)return o`<main class="page watch"><div><div class="skeleton-thumb"></div></div><aside class="upnext"></aside></main>`;let te=Rs(e.name,n),I=se,Y=Ds(e.name,e,n),ke=e.name==="clip"?Qe({id:n.id}):Ce({share_id:e.shareId}),ne=e.name==="clip"?An({id:n.id}):et({share_id:e.shareId}),be=e.name==="clip"?t?.display_name||t?.username||"You":n.author_name||"Unknown creator",ve=n.public_url??n.share_url??null,pe=Re(ve,window.location.origin,I),re=e.name==="clip";function me(){b(n.title),u(!0)}async function X(v){v?.preventDefault?.();let E=p.trim();if(!E||E===n.title){u(!1);return}try{await y(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"PATCH",body:{title:E}}),a(A=>({...A,title:E})),u(!1),k("Title saved.")}catch(A){k(A.message)}}function oe(){w(n.description||""),h(!0)}async function ie(){let v=f.trim();try{await y(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"PATCH",body:{description:v||null}}),a(E=>({...E,description:v||null})),h(!1),k("Description saved.")}catch(E){k(E.message)}}async function $e(v,{force:E=!1}={}){let A=n.visibility;if(!(A===v&&!E)){a(U=>({...U,visibility:v}));try{let U=await y(`/api/v1/clips/${encodeURIComponent(Y)}/visibility`,{method:"POST",body:{visibility:v}});a(D=>({...D,visibility:U.visibility,public_url:U.public_url,public_share_id:U.public_share_id})),k(`Visibility set to ${v}.`,{actionLabel:"Undo",onAction:()=>$e(A,{force:!0})})}catch(U){a(D=>({...D,visibility:A})),k(U.message)}}}async function ge(){if(pe)try{await navigator.clipboard.writeText(pe),k("Link copied.")}catch{k("Couldn't copy the link.")}}async function we(){R(!1);try{await y(`/api/v1/clips/${encodeURIComponent(Y)}`,{method:"DELETE"}),k("Clip deleted."),G("/library")}catch(v){k(v.message)}}let $=[n.game_name&&o`<a class="chip chip-on" href=${`/game/${encodeURIComponent(n.game_name)}`}>${n.game_name}</a>`,ye(n.view_count),`Recorded ${K(n.recorded_at)}`,`by ${be}`].filter(Boolean),T=As(i,I,8);return o`<main class="page watch">
    <div>
      <${ra} src=${ke} poster=${ne} durationMs=${n.duration_ms} markers=${n.markers} />
      ...
      <div class="watch-desc">
        ${l?o`<textarea class="input" rows="5" value=${f} autofocus
              onInput=${v=>w(v.target.value)} onBlur=${ie}
              onKeyDown=${v=>{v.key==="Enter"&&(v.ctrlKey||v.metaKey)&&ie(),v.key==="Escape"&&h(!1)}}></textarea>`:n.description?o`<p>${n.description}
              ${te&&o`<button type="button" class="edit-pencil" aria-label="Edit description" onClick=${oe}
                >${M("edit",{size:12})}</button>`}</p>`:te?o`<button type="button" class="watch-desc-add" onClick=${oe}>+ Add a description</button>`:""}
      </div>
  ...
  </main>`}Q();var Dt=[{top:"4%",left:"4%",width:"34%",rotate:-7},{top:"0%",left:"44%",width:"30%",rotate:5},{top:"34%",left:"68%",width:"28%",rotate:-4},{top:"50%",left:"8%",width:"30%",rotate:6},{top:"62%",left:"42%",width:"26%",rotate:-5},{top:"26%",left:"-4%",width:"22%",rotate:9}];function Ns(e){return Array.isArray(e)?e.slice(0,Dt.length).map((t,n)=>({clip:t,...Dt[n]})):[]}function Fs(e){let t=e?.clips;if(!Array.isArray(t)||t.length===0)return null;let n=t.length,a=e.has_more?"+":"";return`${n}${a} clip${n===1?"":"s"} on this instance`}function zs({top:e,left:t,width:n,rotate:a}){return`top:${e};left:${t};width:${n};transform:rotate(${a}deg);`}function la(e){let t=String(e||"").trim();return t||null}function Bs(){let[e,t]=_(null);S(()=>{let r=!0;return y(`/api/v1/public/clips?page_size=${Dt.length}`).then(s=>r&&t(s)).catch(()=>r&&t(null)),()=>{r=!1}},[]);let n=Ns(e?.clips),a=Fs(e);return o`<aside class="login-montage" aria-hidden="true">
  ...
  </${Me}>`}function ua({route:e}){let t=!!e.invite,[n,a]=_(()=>t?"preflight":e.token?"form":"missing-token"),[r,s]=_(""),[i,c]=_(t?null:e.token),[d,u]=_(""),[p,b]=_(!1),l=t;S(()=>{if(!t)return;if(!e.token){a("missing-token");return}let x=!0;return a("preflight"),y("/api/v1/invites/claim",{method:"POST",body:{invite_token:e.token}}).then(C=>{x&&(c(C.reset_token),a("form"))}).catch(C=>{x&&(s(C instanceof he?C.message:"This invite link is invalid, used, or expired."),a("invalid"))}),()=>{x=!1}},[t,e.token]);async function h(x){if(x.preventDefault(),p)return;b(!0),u("");let C=new FormData(x.currentTarget),g={reset_token:i,new_password:String(C.get("new_password")||"")};l&&(g.username=String(C.get("username")||""),g.display_name=la(C.get("display_name")),g.email=la(C.get("email")));try{await y("/api/v1/auth/reset-password",{method:"POST",body:g}),k(l?"Account created. Sign in with your new password.":"Password set. Sign in with your new password."),G("/login")}catch(R){u(R instanceof he?R.message:"Request failed"),b(!1)}}if(t&&n!=="form"){let x=n==="missing-token"||n==="invalid",C=n==="missing-token"?"This invite link is missing a token.":n==="invalid"?r:"Opening invite\u2026";return o`<${Me} titleId="invite-title">
    ...
    ${n==="missing-token"?o`<p class="form-error" role="alert">This reset link is missing a token.</p>`:o`
        ...
        <form class="login-form" onSubmit=${h}>
          ${l&&o`
            <label class="login-field">
              <span>Username</span>
              <input class="input" name="username" autocomplete="username" required />
  ...
  </${Me}>`}Q();function Ue({label:e,value:t,sub:n,meter:a,tone:r}){let s=r?` stat-${r}`:"";return o`<div class="stat-card">
  ...
  </div>`}Q();function lt(e){let t=String(e||"").trim();return t||null}function qs(e){let t=Number(String(e||"").trim());if(!Number.isFinite(t)||t<0)throw new Error("Storage quota must be a non-negative number");return Math.round(t*1024*1024*1024)}function Gs(e,t){return!(e.is_disabled||t?.id===e.id||e.role==="owner"||e.role==="admin"&&t?.role!=="owner")}function pa(e){return e?[["user","User"],["admin","Admin"]]:[["user","User"]]}function Ks({isOwner:e,onCreated:t}){let[n,a]=_(!1);async function r(s){if(s.preventDefault(),n)return;a(!0);let i=s.currentTarget,c=new FormData(i);try{await y("/api/v1/users",{method:"POST",body:{username:String(c.get("username")||""),display_name:lt(c.get("display_name")),email:lt(c.get("email")),password:lt(c.get("password")),role:String(c.get("role")||"user")}}),k("User created."),i.reset(),t()}catch(d){k(d.message)}finally{a(!1)}}return o`<form class="panel section" onSubmit=${r}>
    <h2>Create user</h2>
  ...
  </form>`}function js({resetLink:e}){if(!e)return null;let t=e.kind==="invite"?"Invite":"Reset",n=e.username?` for ${e.username}`:"",a=async()=>{try{await navigator.clipboard.writeText(e.reset_url),k("Copied to clipboard.")}catch{k("Copy failed. Select and copy the URL manually.")}};return o`<div class="notice admin-reset-link">
    <div>
  ...
  </tr>`}function ma({users:e,settings:t,currentUser:n,resetLink:a,setResetLink:r,reload:s}){let[i,c]=_(null),d=n?.role==="owner",u=!!t?.smtp_enabled,p=()=>c(null);async function b(){let{type:h,user:f,value:w}=i;p();try{if(h==="quota"){let x=w.trim()?qs(w):null;await y(`/api/v1/users/${encodeURIComponent(f.id)}`,{method:"PATCH",body:{storage_quota_bytes:x}}),k("Storage quota updated.")}else if(h==="disable")await y(`/api/v1/users/${encodeURIComponent(f.id)}`,{method:"DELETE",body:{reauth_password:w}}),k("User disabled.");else if(h==="reset"){let x=await y(`/api/v1/users/${encodeURIComponent(f.id)}/reset-password`,{method:"POST",body:{reauth_password:w}});r({...x,kind:"reset"}),k("Reset link created.")}s()}catch(x){k(x.message)}}let l={quota:{title:"Set storage quota",description:"Enter a per-user storage limit in GiB. Leave it blank to remove the per-user limit.",confirmLabel:"Save quota",danger:!1,field:o`<label class="field"><span>Quota GiB</span>
        <input class="input" type="number" min="0" step="0.1" placeholder="No per-user limit"
          value=${i?.value||""} onInput=${h=>c(f=>({...f,value:h.target.value}))} /></label>`},disable:{title:"Disable user?",description:"This immediately revokes the user's sessions and device tokens.",confirmLabel:"Disable",danger:!0,field:o`<label class="field"><span>Your password</span>
        <input class="input" type="password" required value=${i?.value||""}
          onInput=${h=>c(f=>({...f,value:h.target.value}))} /></label>`},reset:{title:"Create reset link?",description:"This creates a temporary password reset link for the selected user.",confirmLabel:"Create link",danger:!1,field:o`<label class="field"><span>Your password</span>
        <input class="input" type="password" required value=${i?.value||""}
          onInput=${h=>c(f=>({...f,value:h.target.value}))} /></label>`}}[i?.type];return o`<div class="admin-users-layout">
    ...
    <div class="panel admin-users-table">
      ...
      <div class="table-wrap">
        <table class="lib-table">
          ...
          <tbody>
            ${e.map(h=>o`<${Js} key=${h.id} user=${h} currentUser=${n}
  ...
  </div>`}function Lt({title:e,items:t,renderItem:n,emptyLabel:a}){return o`<div class="panel">
    <div class="section-header">
      <h2>${e}</h2>
    ...
    <${Lt} title="Failed uploads" items=${e} emptyLabel="No failed uploads."
      renderItem=${a=>o`<${Qs} key=${a.id} upload=${a} />`} />
    <${Lt} title="Dead jobs" items=${t} emptyLabel="No dead jobs."
      renderItem=${a=>o`<${ha} key=${a.id} job=${a} />`} />
    <${Lt} title="Recent job errors" items=${n} emptyLabel="No recent job errors."
      renderItem=${a=>o`<${ha} key=${a.id} job=${a} />`} />
  </div>`}var ba=[["overview","server","Overview"],["users","users","Users"],["settings","sliders","Settings"],["jobs","alert","Jobs"]];function er(e){return e?.role==="admin"||e?.role==="owner"}async function tr(){let[e,t,n,a,r,s]=await Promise.all([y("/api/v1/admin/overview"),y("/api/v1/admin/settings"),y("/api/v1/users"),y("/api/v1/admin/uploads/failed?limit=50"),y("/api/v1/admin/jobs/dead?limit=50"),y("/api/v1/admin/jobs/recent-errors?limit=50")]);return{overview:e,settings:t,users:n,failedUploads:a,deadJobs:r,recentErrors:s}}function va({route:e}){let{user:t}=H(N),n=er(t),a=!!(t&&!n),r=ba.some(([f])=>f===e.tab)?e.tab:"overview",[s,i]=_(null),[c,d]=_(null),[u,p]=_(null),[b,l]=_(0),h=()=>l(f=>f+1);return S(()=>{a&&(k("Admin access required."),G("/library"))},[a]),S(()=>{if(!n)return;let f=!0;return d(null),tr().then(w=>f&&i(w)).catch(w=>f&&d(w)),()=>{f=!1}},[n,b]),n?o`<main class="page">
    <h1>Admin</h1>
    <p class="page-subtitle">Accounts, instance summary, and processing diagnostics.</p>
    <nav class="ad-tabs" aria-label="Admin views">
      ${ba.map(([f,w,x])=>o`<a key=${f} class=${`ad-tab ${f===r?"ad-tab-on":""}`}
        href=${`/admin?tab=${f}`} aria-current=${f===r?"page":void 0}>${M(w,{size:14})} ${x}</a>`)}
    </nav>
    ${c?o`<${W} name="alert" title="Couldn't load admin data" body=${c.message} />`:s?r==="users"?o`<${ma} users=${s.users} settings=${s.settings} currentUser=${t}
          resetLink=${u} setResetLink=${p} reload=${h} />`:r==="settings"?o`<${fa} settings=${s.settings} isOwner=${t?.role==="owner"} reload=${h} />`:r==="jobs"?o`<${_a} failedUploads=${s.failedUploads} deadJobs=${s.deadJobs} recentErrors=${s.recentErrors} />`:o`<${da} overview=${s.overview} deadJobs=${s.deadJobs} failedUploads=${s.failedUploads} />`:o`<p class="empty-state">Loading admin data…</p>`}
  </main>`:null}Q();function $a(e){let t=String(e||"").trim();return t||null}async function nr(e){let t=new Headers;t.set("Accept","application/json"),t.set("Content-Type",e.type||"application/octet-stream");let n=wt();n&&t.set("X-CSRF-Token",n);let a=await fetch("/api/v1/me/avatar",{method:"PUT",credentials:"same-origin",headers:t,body:e}),r=await a.json().catch(()=>({}));if(!a.ok)throw new Error(r.error||a.statusText||"Avatar upload failed");return r}function ga(e){N.set({...N.get(),user:e})}function ar({user:e}){let[t,n]=_(!1);async function a(r){if(r.preventDefault(),t)return;n(!0);let s=new FormData(r.currentTarget);try{let i=await y("/api/v1/me/profile",{method:"PATCH",body:{display_name:$a(s.get("display_name")),bio:$a(s.get("bio"))}});ga(i),k("Profile saved.")}catch(i){k(i.message)}finally{n(!1)}}return o`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function sr({user:e}){let[t,n]=_(!1);async function a(r){if(r.preventDefault(),t)return;let s=r.currentTarget.elements.avatar?.files?.[0];if(!s){k("Choose an avatar image first.");return}n(!0);try{let i=await nr(s);ga(i),k("Avatar uploaded.")}catch(i){k(i.message)}finally{n(!1)}}return o`<form class="profile-form" onSubmit=${a}>
  ...
  </form>`}function ya(){let{user:e}=H(N);return e?o`<main class="page">
    <h1>Profile</h1>
    ...
    ${c.length===0?o`<${W} name="film" title="No public clips yet" />`:o`<div class="card-grid">
          ${c.map(d=>o`<${Te} key=${d.share_id}
            clip=${{...d,thumbnail_url:de(d),media_url:Ce(d)}}
            href=${`/c/${encodeURIComponent(d.share_id)}`} showAuthor=${!1} />`)}
        </div>`}
  </main>`}Q();var Sa="Clipline is a self-hosted clip library for saved gameplay moments.";function ut(e,t){return o`<div><dt>${e}</dt><dd>${t}</dd></div>`}function xa(){let[e,t]=_(Sa);return S(()=>{let n=!0;return y("/api/v1/about").then(a=>n&&t(a.about_text||Sa)).catch(()=>{}),()=>{n=!1}},[]),o`<main class="page">
    <h1>About</h1>
  ...
  </main>`}var lr={publicLibrary:nt,publicGame:nt,games:Vn,library:Wn,clip:Ut,public:Ut,login:ca,resetPassword:ua,admin:va,profile:ya,account:ka,publicUser:wa,about:xa},Ca=Mn({pathname:window.location.pathname,search:window.location.search});function cr(){let e=En();Ca=e.name;let{ready:t,user:n}=H(N),a=t&&Cn(e.name,n);if(S(()=>{a&&G("/login")},[a]),!t||a)return o`<div class="boot">Loading…</div>`;let r=lr[e.name]||nt,s=e.name==="login"||e.name==="resetPassword";return o`<div class="ui" onClick=${Rn}>
    ${!s&&o`<${Dn} active=${xt(e)} route=${e} />`}
    <${r} route=${e} />
    ${!s&&o`<${Ln} active=${Tn(e)} />`}
    <${In} />
  </div>`}window.addEventListener("clipline:unauthorized",()=>{ue(null),N.set({user:null,csrfToken:null,ready:!0}),St(Ca)||G("/login")});(async()=>{try{let t=await y("/api/v1/auth/me");ue(t.csrf_token),N.set({user:t.user,csrfToken:t.csrf_token,ready:!0})}catch{ue(null),N.set({user:null,csrfToken:null,ready:!0})}let e=document.querySelector("#app");e.textContent="",rn(o`<${cr} />`,e)})();
