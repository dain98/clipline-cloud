...
git tag -a v1.2.19 -m "Clipline Cloud v1.2.19"
...
Published image tags for `v1.2.19`:

```text
ghcr.io/dain98/clipline-cloud:1.2.19
...
```sh
BUILD_IMAGE=0 \
CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.2.19 \
