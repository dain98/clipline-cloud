...
This is the friendly, step-by-step guide to deploying Clipline Cloud v1.3.1 with Docker Compose. For the
...
CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.3.1 docker compose up -d
...
```sh
BUILD_IMAGE=0 CLIPLINE_IMAGE=ghcr.io/dain98/clipline-cloud:1.3.1 deploy/compose/smoke.sh
```
